...
var mockUseRoute = vitest_1.vi.fn(function () { return ({ name: 'budget', path: '/presupuesto' }); });
var mockCoreApiGet = vitest_1.vi.hoisted(function () { return vitest_1.vi.fn(); });
var mockIncomeStore = vitest_1.vi.hoisted(function () { return ({
    entries: { value: [] },
    totalAnnual: { value: 0 },
    loading: { value: false },
    error: { value: null },
    loadAll: vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, undefined];
    }); }); }),
}); });
var mockExpenseStore = vitest_1.vi.hoisted(function () { return ({
    entries: { value: [] },
    totalAnnual: { value: 0 },
    loading: { value: false },
    error: { value: null },
...
var mockAccountingApi = vitest_1.vi.hoisted(function () { return ({
    getMonthlySummary: vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    getBudgetSuggestions: vitest_1.vi.fn(function () { return __awaiter(void 0, void 0, void 0, function () {
...
vitest_1.vi.mock('vue-router', function () { return ({
    useRoute: function () { return mockUseRoute(); },
}); });
...
vitest_1.vi.mock('@/domains/data-input', function () { return ({
    ...
    useAnnualIncomeStore: function () { return mockIncomeStore; },
    useAnnualExpenseStore: function () { return mockExpenseStore; },
}); });
function makeMonthlySummary(executed) {
    if (executed === void 0) { executed = '0.00'; }
    return {
        fiscal_year: currentYear,
...
function configureCoreApi(overrides) {
    var _this = this;
    mockCoreApiGet.mockImplementation(function (url) { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            if (url === '/api/budget/annual-income/monthly-summary/') {
                return [2 /*return*/, { data: makeMonthlySummary(overrides === null || overrides === void 0 ? void 0 : overrides.incomeSummaryExecuted) }];
            }
            if (url === '/api/budget/annual-expense/monthly-summary/') {
                return [2 /*return*/, { data: makeMonthlySummary(overrides === null || overrides === void 0 ? void 0 : overrides.expenseSummaryExecuted) }];
            }
            if (url === '/api/budget/annual-income-checkins/') {
                return [2 /*return*/, { data: (_a = overrides === null || overrides === void 0 ? void 0 : overrides.incomeCheckins) !== null && _a !== void 0 ? _a : [] }];
            }
            if (url === '/api/budget/annual-expense-checkins/') {
                return [2 /*return*/, { data: (_b = overrides === null || overrides === void 0 ? void 0 : overrides.expenseCheckins) !== null && _b !== void 0 ? _b : [] }];
            }
...
function openMonthlyStep(wrapper, label) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    button = wrapper.findAll('button').find(function (candidate) { return candidate.text().includes(label); });
                    return [4 /*yield*/, (button === null || button === void 0 ? void 0 : button.trigger('click'))];
                case 1:
                    _a.sent();
...
(0, vitest_1.describe)('BudgetDashboardView', function () {
    ...
    (0, vitest_1.it)('uses ledger coverage for income rows and disables legacy check-in editing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper, input;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('keeps legacy expense fallback editable when there is no ledger coverage', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper, input;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('surfaces pendiente clasificar when categorized ledger is ambiguous across multiple lines', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
