...
vitest_1.vi.mock('@/domains/net-worth', function () {
  return {
    useNetWorthStore: function () {
      return mockNetWorthStore;
    },
  };
});
...
(0, vitest_1.describe)('GuidePhaseDetailView (fase 2)', function () {
  ...
  (0, vitest_1.it)(
    'renders phase 2 summary, operational score and savings distribution info',
    function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(wrapper.text()).toContain(
                'Colchon mensual tras cargas temporales',
              );
  ...
  (0, vitest_1.it)(
    'omits warning and monthly capacity detail when recurrent income is missing',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(wrapper.text()).not.toContain(
                'Capacidad de asignacion recurrente mensual',
              );
...
(0, vitest_1.describe)('GuidePhaseDetailView (fase 3)', function () {
  (0, vitest_1.beforeEach)(function () {
    ...
    mockNetWorthStore.liabilities = [];
    mockNetWorthStore.summary = __assign(__assign({}, mockNetWorthStore.summary), {
      total_assets: '100000',
      total_liabilities: '0',
      net_worth: '100000',
  ...
  (0, vitest_1.it)(
    'renders phase 3 emergency-fund diagnostics and loads expense context',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var wrapper;
        return __generator(this, function (_a) {
