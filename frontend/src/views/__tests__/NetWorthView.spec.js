...
var mockCoreNetWorthApi = vitest_1.vi.hoisted(function () {
  return {
    getAssetTimeline: vitest_1.vi.fn(function () {
    ...
    getLiabilityTimeline: vitest_1.vi.fn(function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2 /*return*/, { data: { rows: [], base_currency: 'EUR' } }];
        });
...
var mockCoreAccountingApi = vitest_1.vi.hoisted(function () {
  return {
...
vitest_1.vi.mock('@/domains/net-worth', function () {
  return {
    ...
    useNetWorthViewState: function () {
      return mockUseNetWorthViewState();
    },
    useNetWorthViewExtensions: function () {
      return mockUseNetWorthViewExtensions();
    },
  };
});
vitest_1.vi.mock('@/domains/ui', function () {
  return {
  ...
  return __assign(
    {
      ...
      prettyError: vitest_1.vi.fn(function () {
        return 'Error bonito';
      }),
      showAssetModal: (0, vue_1.ref)(false),
      showLiabilityModal: (0, vue_1.ref)(false),
      showBreakdown: (0, vue_1.ref)(false),
      showEditModal: (0, vue_1.ref)(false),
      editKind: (0, vue_1.ref)(null),
      canShowReal: vitest_1.vi.fn(function () {
        return true;
      }),
      submitAsset: vitest_1.vi.fn(),
      submitLiability: vitest_1.vi.fn(),
      openEdit: vitest_1.vi.fn(),
      closeEdit: vitest_1.vi.fn(),
      confirmDeleteSnapshot: vitest_1.vi.fn(),
      editTitle: 'Editar activo',
      editCategories: [],
      editInitial: null,
      submitEdit: vitest_1.vi.fn(),
      formatMoney: vitest_1.vi.fn(function (v) {
        return v;
      }),
      unitLabel: vitest_1.vi.fn(function () {
        return 'EUR';
      }),
      modeLabel: vitest_1.vi.fn(function () {
        return 'Nominal';
      }),
      realBaseLabel: (0, vue_1.ref)(''),
      summaryAssets: (0, vue_1.ref)('1000'),
      summaryLiabilities: (0, vue_1.ref)('250'),
      summaryNetWorth: (0, vue_1.ref)('750'),
      byCategoryKeys: (0, vue_1.ref)(['cash']),
      byCategoryLabels: (0, vue_1.ref)(['Liquidez']),
      byCategoryAssets: (0, vue_1.ref)([1000]),
      byCategoryLiabilities: (0, vue_1.ref)([250]),
      byCategoryUnit: (0, vue_1.ref)('EUR'),
      summaryAssetBackedLiabilities: (0, vue_1.ref)('150'),
      summaryUnbackedLiabilities: (0, vue_1.ref)('100'),
    },
    overrides,
  );
}
(0, vitest_1.describe)('NetWorthView', function () {
  ...
  (0, vitest_1.it)(
    'filters current net worth metrics by ownership from the header selector',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              state = makeState({
                store: __assign(__assign({}, makeState().store), {
                  ownerships: [
                    {
                      id: 7,
                      kind: 'shared',
              ...
              return [
                4 /*yield*/,
                wrapper.get('[data-test="ownership-filter-option-3"]').trigger('click'),
              ];
            case 1:
              _a.sent();
  ...
  (0, vitest_1.it)(
    'uses the current summary totals in the general timeline highlight instead of the projected month-end row',
    function () {
      var state = makeState({
        summaryAssets: (0, vue_1.ref)('1000'),
        summaryLiabilities: (0, vue_1.ref)('250'),
  ...
  (0, vitest_1.it)('wires header actions and snapshot deletion callback', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var state, wrapper;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              wrapper.get('button[aria-label="Guardar snapshot"]').trigger('click'),
            ];
          case 2:
            _a.sent();
            return [
              4 /*yield*/,
              wrapper.get('button[aria-label="Eliminar snapshot"]').trigger('click'),
            ];
          case 3:
            _a.sent();
  ...
  (0, vitest_1.it)(
    'requests timeline when selecting an asset category from composition',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                wrapper.get('[data-test="donut-select-asset"]').trigger('click'),
              ];
            case 1:
              _a.sent();
              (0, vitest_1.expect)(state.store.fetchTimeline).toHaveBeenCalledWith('cash', 'asset');
              (0, vitest_1.expect)(
                wrapper.find('select.ui-nw-position-select-input').exists(),
              ).toBe(true);
  ...
  (0, vitest_1.it)('opens the asset modal from composition actions', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var state, wrapper;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  (0, vitest_1.it)(
    'returns to the general timeline when clicking the active composition category again',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              _a.sent();
              (0, vitest_1.expect)(state.store.fetchTimeline).toHaveBeenNthCalledWith(
                1,
                'cash',
                'asset',
              );
  ...
  (0, vitest_1.it)(
    'requests liability timeline when selecting a liability category from composition',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                wrapper.get('[data-test="donut-select-liability"]').trigger('click'),
              ];
            case 1:
              _a.sent();
              (0, vitest_1.expect)(state.store.fetchTimeline).toHaveBeenCalledWith(
                'mortgage',
                'liability',
              );
              return [2 /*return*/];
  ...
  (0, vitest_1.it)(
    'fetches per-position timeline when selecting an asset from the integrated selector',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              state.store.fetchPositionTimeline = vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                wrapper.get('select.ui-nw-position-select-input').setValue('11'),
              ];
            case 2:
              _a.sent();
              (0, vitest_1.expect)(state.store.fetchPositionTimeline).toHaveBeenCalledWith(
                'asset',
                11,
              );
              (0, vitest_1.expect)(state.store.fetchPositionActivity).toHaveBeenCalledWith(
                'asset',
                11,
                'cash',
              );
              (0, vitest_1.expect)(mockCoreAccountingApi.getTransactions).toHaveBeenCalledWith({
                year: 2026,
              });
              return [2 /*return*/];
          }
  ...
  (0, vitest_1.it)(
    'shows accounting activity for positions tracked through accounting',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
  ...
  (0, vitest_1.it)(
    'shows the setup gap when an accounting-tracked position has no linked account',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
  ...
  (0, vitest_1.it)(
    'shows needs_review state and keeps fallback when accounting integration is unsafe',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
        return __generator(this, function (_a) {
  ...
  (0, vitest_1.it)(
    'removes the redundant selected summary and exposes edit/delete actions in the category workspace',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(
                wrapper.get('button[aria-label="Nuevo activo"]').text(),
              ).toContain('+');
  ...
  (0, vitest_1.it)(
    'renders euro amounts with the symbol in visible net worth sections',
    function () {
      var state = makeState({
        store: __assign(__assign({}, makeState().store), {
          snapshots: [
  ...
  (0, vitest_1.it)('opens the expanded timeline modal and updates the visible range', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              wrapper.get('button.ui-nw-timeline-range-button').trigger('click'),
            ];
          case 1:
            _a.sent();
            return [
              4 /*yield*/,
              wrapper.get('button.ui-nw-timeline-expand-button').trigger('click'),
            ];
          case 2:
            _a.sent();
