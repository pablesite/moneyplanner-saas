...
var incomeCategoryLabels = new Map(
  data_input_1.incomeCategories.map(function (row) {
    return [row.value, row.label];
  }),
);
var incomeSubcategoryLabels = new Map(
  data_input_1.incomeSubcategories.map(function (row) {
    return [row.value, row.label];
  }),
);
var expenseCategoryLabels = new Map(
  data_input_1.expenseCategories.map(function (row) {
    return [row.value, row.label];
  }),
);
var expenseSubcategoryLabels = new Map(
  data_input_1.expenseSubcategories.map(function (row) {
    return [row.value, row.label];
  }),
);
...
var monthlyCloseFlowSteps = (0, vue_1.computed)(function () {
  return [
...
var monthlyCloseStepIds = (0, vue_1.computed)(function () {
  return monthlyCloseFlowSteps.value.map(function (s) {
    return s.id;
  });
});
var activeMonthlyCloseStepIndex = (0, vue_1.computed)(function () {
  return monthlyCloseStepIds.value.findIndex(function (id) {
    return id === activeMonthlyCloseStep.value;
  });
});
...
var selectedFiscalYearLabel = (0, vue_1.computed)(function () {
  return String(fiscalYear.value);
});
var isLoading = (0, vue_1.computed)(function () {
  return incomeStore.loading.value || expenseStore.loading.value;
});
var firstError = (0, vue_1.computed)(function () {
  return incomeStore.error.value || expenseStore.error.value;
});
var incomeEntries = (0, vue_1.computed)(function () {
  return incomeStore.entries.value;
});
var expenseEntries = (0, vue_1.computed)(function () {
...
function parseSharedOwnerShares(ownerLabel) {
  ...
  return match[1]
    ...
    .map(function (part) {
      ...
      if (!(m === null || m === void 0 ? void 0 : m[1]) || !m[2]) return null;
      var name = m[1].trim();
...
function ownerNamesFromLabel(ownerLabel) {
  ...
  if (shared.length > 0)
    return shared.map(function (row) {
      return row.name;
    });
  return [text];
}
function allocationFractionForOwnerLabel(ownerLabel, selectedOwner) {
  ...
  var matchedShare = shared
    .filter(function (row) {
      return row.name.localeCompare(selectedOwner, 'es', { sensitivity: 'base' }) === 0;
    })
...
var ownershipOptions = (0, vue_1.computed)(function () {
  ...
  for (var _i = 0, _c = incomeEntries.value; _i < _c.length; _i++) {
    var entry = _c[_i];
    for (
      var _d = 0, _e = ownerNamesFromLabel((_a = entry.owner) !== null && _a !== void 0 ? _a : '');
      _d < _e.length;
      _d++
    ) {
      var name_1 = _e[_d];
  ...
  for (var _f = 0, _g = expenseEntries.value; _f < _g.length; _f++) {
    var entry = _g[_f];
    for (
      var _h = 0, _j = ownerNamesFromLabel((_b = entry.owner) !== null && _b !== void 0 ? _b : '');
      _h < _j.length;
      _h++
    ) {
      var name_2 = _j[_h];
...
var ownerAdjustedIncomeEntries = (0, vue_1.computed)(function () {
  return incomeEntries.value
    .map(function (entry) {
      var _a;
      var fraction = allocationFractionForOwnerLabel(
        (_a = entry.owner) !== null && _a !== void 0 ? _a : '',
        ownershipFilter.value,
      );
      return __assign(__assign({}, entry), { amountAnnual: entry.amountAnnual * fraction });
    })
    .filter(function (entry) {
      return entry.amountAnnual > 0;
    });
});
...
function sumPlanned(entries) {
  return entries.reduce(function (sum, entry) {
    return sum + (Number.isFinite(entry.amountAnnual) ? entry.amountAnnual : 0);
  }, 0);
}
...
var plannedIncomeTotal = (0, vue_1.computed)(function () {
  return sumPlanned(filteredIncomeEntries.value);
});
var plannedExpenseTotal = (0, vue_1.computed)(function () {
  return sumPlanned(filteredExpenseEntries.value);
});
var plannedBalanceTotal = (0, vue_1.computed)(function () {
  return plannedIncomeTotal.value - plannedExpenseTotal.value;
});
...
var expenseSummaryByMonth = (0, vue_1.computed)(function () {
  ...
  for (
    var _i = 0,
      _c =
        (_b = (_a = expenseMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.months) !==
          null && _b !== void 0
          ? _b
          : [];
    _i < _c.length;
...
var incomeSummaryByMonth = (0, vue_1.computed)(function () {
  ...
  for (
    var _i = 0,
      _c =
        (_b = (_a = incomeMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.months) !==
          null && _b !== void 0
          ? _b
          : [];
    _i < _c.length;
...
var accountingSummaryByMonth = (0, vue_1.computed)(function () {
  ...
  for (
    var _i = 0,
      _c =
        (_b =
          (_a = accountingMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.months) !==
          null && _b !== void 0
          ? _b
          : [];
    _i < _c.length;
  ...
  for (var _i = 0, _d = accountingPostedEntries.value; _i < _d.length; _i++) {
    ...
    if (flowFamily === 'income' && entry.annual_income_entry_id != null) {
      incomeLegacyByEntryId.set(
        ...
        ((_b = incomeLegacyByEntryId.get(entry.annual_income_entry_id)) !== null && _b !== void 0
          ? _b
          : 0) + amount,
      );
      continue;
    ...
    if (flowFamily === 'expense' && entry.annual_expense_entry_id != null) {
      expenseLegacyByEntryId.set(
        ...
        ((_c = expenseLegacyByEntryId.get(entry.annual_expense_entry_id)) !== null && _c !== void 0
          ? _c
          : 0) + amount,
      );
      continue;
...
var selectedExpenseSummaryMonth = (0, vue_1.computed)(function () {
  var _a;
  return (_a = expenseSummaryByMonth.value.get(selectedExecutionMonth.value)) !== null &&
    _a !== void 0
    ? _a
    : null;
});
var selectedExpenseMonthPlanned = (0, vue_1.computed)(function () {
  var _a;
  return toNumberOrZero(
    (_a = selectedExpenseSummaryMonth.value) === null || _a === void 0 ? void 0 : _a.planned,
  );
});
var selectedExpenseMonthDeviation = (0, vue_1.computed)(function () {
  return selectedExpenseMonthExecuted.value - selectedExpenseMonthPlanned.value;
});
var monthlyIncomeExecutionEntries = (0, vue_1.computed)(function () {
  return incomeEntries.value
    .filter(function (entry) {
      return entry.fiscalYear === fiscalYear.value && entry.incomeType !== 'one_off';
    })
    .map(function (entry) {
      var _a, _b, _c, _d;
      var checkin =
        (_a = incomeCheckinsByEntryId.value[entry.id]) !== null && _a !== void 0 ? _a : null;
      var planned = monthlyPlannedAmountForIncomeEntry(entry, selectedExecutionMonth.value);
      var taxonomyKey = budgetTaxonomyKey(entry.category, entry.subcategory);
      var categorizedLedgerExecuted =
        (_b = accountingExecutionBuckets.value.incomeCategorizedByTaxonomy.get(taxonomyKey)) !==
          null && _b !== void 0
          ? _b
          : null;
      var legacyLedgerExecuted =
        (_c = accountingExecutionBuckets.value.incomeLegacyByEntryId.get(entry.id)) !== null &&
        _c !== void 0
          ? _c
          : null;
      var taxonomyLineCount =
        (_d = incomeTaxonomyLineCounts.value.get(taxonomyKey)) !== null && _d !== void 0 ? _d : 0;
      var fallbackExecuted =
        checkin && checkin.status !== 'skipped' ? toNumberOrZero(checkin.executed_amount) : 0;
      var uniqueCategorizedLedgerExecuted =
      ...
      if (uniqueCategorizedLedgerExecuted > 0 || legacyLedgerExecuted != null) {
        ...
        executed =
          uniqueCategorizedLedgerExecuted +
          (legacyLedgerExecuted !== null && legacyLedgerExecuted !== void 0
    ...
    .sort(function (a, b) {
      return b.planned - a.planned || a.entry.name.localeCompare(b.entry.name, 'es');
    });
});
var selectedIncomeMonthPlanned = (0, vue_1.computed)(function () {
  return monthlyIncomeExecutionEntries.value.reduce(function (sum, row) {
    return sum + row.planned;
  }, 0);
});
var selectedIncomeMonthExecuted = (0, vue_1.computed)(function () {
  return monthlyIncomeExecutionEntries.value.reduce(function (sum, row) {
    var _a;
    return sum + ((_a = row.executed) !== null && _a !== void 0 ? _a : 0);
  }, 0);
});
var selectedIncomeMonthDeviation = (0, vue_1.computed)(function () {
  return selectedIncomeMonthExecuted.value - selectedIncomeMonthPlanned.value;
});
var selectedIncomeMonthCompletionRatio = (0, vue_1.computed)(function () {
  var total = monthlyIncomeExecutionEntries.value.length;
  if (!total) return 1;
  var checked = monthlyIncomeExecutionEntries.value.filter(function (row) {
    return row.executionSource !== 'none';
  }).length;
...
var incomeEvolutionMonths = (0, vue_1.computed)(function () {
  var rows = monthLabels.map(function (label, index) {
    ...
    var executed = toNumberOrZero(
      summary === null || summary === void 0 ? void 0 : summary.executed,
    );
    return {
      month: month,
      label: label,
      ...
      executed: executed,
      hasExecuted:
        ((_a = summary === null || summary === void 0 ? void 0 : summary.checkins_confirmed) !==
          null && _a !== void 0
          ? _a
          : 0) > 0 || executed > 0,
    };
  });
  var maxMonthAmount = Math.max.apply(
    Math,
    __spreadArray(
      [1],
      rows.map(function (row) {
        return Math.max(row.planned, row.executed);
      }),
      false,
    ),
  );
...
var selectedLiquidityMonthPlanned = (0, vue_1.computed)(function () {
  var _a;
  return toNumberOrZero(
    (_a = liquidityMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.planned_total,
  );
});
var selectedLiquidityMonthExecuted = (0, vue_1.computed)(function () {
  var _a;
  return toNumberOrZero(
    (_a = liquidityMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.executed_total,
  );
});
var selectedLiquidityMonthDeviation = (0, vue_1.computed)(function () {
  return selectedLiquidityMonthExecuted.value - selectedLiquidityMonthPlanned.value;
});
var selectedLiquidityStartBase = (0, vue_1.computed)(function () {
  return selectedLiquidityMonthPlanned.value;
});
...
var selectedMonthlyCloseResidual = (0, vue_1.computed)(function () {
  return selectedLiquidityMonthExecuted.value - selectedMonthlyCloseExpected.value;
});
var selectedMonthlyCloseCompletionRatio = (0, vue_1.computed)(function () {
  ...
  var ratios = [
    monthlyLiquidityExecutionRows.value.length
      ? (_b =
          (_a = liquidityMonthlySummary.value) === null || _a === void 0
            ? void 0
            : _a.completion_ratio) !== null && _b !== void 0
        ? _b
        : 0
      : 1,
...
var monthlyLiquidityExecutionRows = (0, vue_1.computed)(function () {
  var _a, _b;
  return (
    (_b = (_a = liquidityMonthlySummary.value) === null || _a === void 0 ? void 0 : _a.rows) !==
      null && _b !== void 0
      ? _b
      : []
  ).map(function (row) {
...
var monthlyExpenseExecutionEntries = (0, vue_1.computed)(function () {
  ...
  return expenseEntries.value
    ...
    .map(function (entry) {
      var _a, _b, _c, _d;
      var checkin =
        (_a = expenseCheckinsByEntryId.value[entry.id]) !== null && _a !== void 0 ? _a : null;
      var planned = monthlyPlannedAmountForExpenseEntry(entry, month);
      var taxonomyKey = budgetTaxonomyKey(entry.category, entry.subcategory);
      var categorizedLedgerExecuted =
        (_b = accountingExecutionBuckets.value.expenseCategorizedByTaxonomy.get(taxonomyKey)) !==
          null && _b !== void 0
          ? _b
          : null;
      var legacyLedgerExecuted =
        (_c = accountingExecutionBuckets.value.expenseLegacyByEntryId.get(entry.id)) !== null &&
        _c !== void 0
          ? _c
          : null;
      var taxonomyLineCount =
        (_d = expenseTaxonomyLineCounts.value.get(taxonomyKey)) !== null && _d !== void 0 ? _d : 0;
      var fallbackExecuted =
        checkin && checkin.status !== 'skipped' ? toNumberOrZero(checkin.executed_amount) : 0;
      var uniqueCategorizedLedgerExecuted =
        categorizedLedgerExecuted != null && taxonomyLineCount === 1
...
var selectedExpenseMonthExecuted = (0, vue_1.computed)(function () {
  return monthlyExpenseExecutionEntries.value.reduce(function (sum, row) {
    var _a;
    return sum + ((_a = row.executed) !== null && _a !== void 0 ? _a : 0);
  }, 0);
});
  ...
  for (var _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
    ...
    if (!group) {
      group = {
        ...
        categoryLabel:
          (_a = categoryLabels.get(categoryKey)) !== null && _a !== void 0 ? _a : categoryKey,
        lineCount: 0,
        plannedTotal: 0,
        executedTotal: 0,
        checkedCount: 0,
    ...
    if (!subrow) {
      subrow = {
        ...
        subcategoryLabel:
          (_b = subcategoryLabels.get(subcategoryKey)) !== null && _b !== void 0
            ? _b
            : subcategoryKey,
        lineCount: 0,
        plannedTotal: 0,
  ...
  return Array.from(groups.values())
    .map(function (group) {
      var rowsSorted = Array.from(group.rows.values())
        .map(function (subrow) {
          return __assign(__assign({}, subrow), {
...
var monthlyIncomeResultBreakdown = (0, vue_1.computed)(function () {
  return buildMonthlyResultBreakdown(
...
var selectedExecutionMonthLabel = (0, vue_1.computed)(function () {
  var _a;
  return (_a = monthLabels[selectedExecutionMonth.value - 1]) !== null && _a !== void 0
    ? _a
    : String(selectedExecutionMonth.value);
});
...
var selectedMonthlyExecutedVolume = (0, vue_1.computed)(function () {
  return selectedIncomeMonthExecuted.value + selectedExpenseMonthExecuted.value;
});
var selectedMonthlyResidualAbs = (0, vue_1.computed)(function () {
  return Math.abs(selectedMonthlyCloseResidual.value);
});
...
var resultReconciliationFlowRows = (0, vue_1.computed)(function () {
  return [
    {
      id: 'start',
    ...
    },
    {
      ...
      meta:
        selectedMonthlyExecutedVolume.value > 0
          ? ''.concat(
              formatPercent(
                selectedIncomeMonthExecuted.value / selectedMonthlyExecutedVolume.value,
                0,
              ),
              ' del volumen',
            )
    ...
    },
    {
      ...
      meta:
        selectedMonthlyExecutedVolume.value > 0
          ? ''.concat(
              formatPercent(
                selectedExpenseMonthExecuted.value / selectedMonthlyExecutedVolume.value,
                0,
              ),
              ' del volumen',
            )
    ...
    },
    {
      ...
      meta:
        selectedMonthlyResidualVolumeRatio.value == null
          ...
          : ''.concat(
              formatPercent(selectedMonthlyResidualVolumeRatio.value, 1),
              ' del volumen ejecutado',
            ),
    },
    {
      id: 'real-close',
...
var executionStatusLabel = (0, vue_1.computed)(function () {
  ...
  var monthsWithLedger = Array.from(accountingSummaryByMonth.value.values()).filter(function (row) {
    return toNumberOrZero(row.income_total) > 0 || toNumberOrZero(row.expense_total) > 0;
  }).length;
...
var executionStatusDetail = (0, vue_1.computed)(function () {
  ...
  if (monthsWithLedger > 0) {
    return 'Ledger categorizado en '.concat(
      monthsWithLedger,
      '/12 meses. BudgetDashboardView usa taxonomia compartida como fuente primaria y fallback legacy solo cuando falta clasificacion nueva.',
    );
  }
  if (!expenseMonthlySummary.value) {
    return 'Cargando agregados mensuales para ledger y check-ins legacy.';
  }
  return 'Sin cobertura ledger todavia. Check-ins legacy disponibles en '.concat(
    expenseMonthlySummary.value.months_with_checkins,
    '/12 meses para gastos.',
  );
});
var monthlyIncomeCoverageSummary = (0, vue_1.computed)(function () {
  var total = monthlyIncomeExecutionEntries.value.length;
  var viaLedger = monthlyIncomeExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'categorized_ledger';
  }).length;
  var viaFallback = monthlyIncomeExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'legacy_fallback';
  }).length;
...
var monthlyExpenseCoverageSummary = (0, vue_1.computed)(function () {
  ...
  var viaLedger = monthlyExpenseExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'categorized_ledger';
  }).length;
  var viaFallback = monthlyExpenseExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'legacy_fallback';
  }).length;
  var pending = total - viaLedger - viaFallback;
  return {
...
var monthlyIncomePendingClassification = (0, vue_1.computed)(function () {
  var ambiguousRows = monthlyIncomeExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'pending_classification';
  }).length;
...
var monthlyExpensePendingClassification = (0, vue_1.computed)(function () {
  var ambiguousRows = monthlyExpenseExecutionEntries.value.filter(function (row) {
    return row.executionSource === 'pending_classification';
  }).length;
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          accountingMonthlySummary.value =
            (_b = summaryResponse.data) !== null && _b !== void 0 ? _b : null;
          accountingPostedEntries.value = (
            (_c = transactionsResponse.data) !== null && _c !== void 0 ? _c : []
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            accounting_1.coreAccountingApi.getBudgetSuggestions(fiscalYear.value, 2),
          ];
        case 2:
          response = _b.sent();
...
function formatCompactMoney(value) {
  ...
  if (abs >= 1000000) return ''.concat(formatMoney(value / 1000000, 1), ' M');
  if (abs >= 1000) return ''.concat(formatMoney(value / 1000, 1), ' k');
...
function aggregateBudgetRows(entries, categoryLabels, subcategoryLabels) {
  ...
  for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
    ...
    bucket.set(key, {
      ...
      categoryLabel:
        (_b = categoryLabels.get(entry.category)) !== null && _b !== void 0 ? _b : entry.category,
      subcategoryKey: entry.subcategory,
      subcategoryLabel:
        (_c = subcategoryLabels.get(entry.subcategory)) !== null && _c !== void 0
          ? _c
          : entry.subcategory,
  ...
  var sectionTotal = rows.reduce(function (sum, row) {
    return sum + row.plannedAnnual;
  }, 0);
  ...
  return Array.from(byCategory.values())
    .map(function (group) {
      return __assign(__assign({}, group), {
        rows: group.rows.sort(function (a, b) {
...
var sections = (0, vue_1.computed)(function () {
  return [
    {
      id: 'income',
      title: 'Ingresos',
      ...
      subcategoryCount: incomeGroups.value.reduce(function (sum, group) {
    ...
    },
    {
      ...
      subcategoryCount: expenseGroups.value.reduce(function (sum, group) {
        return sum + group.rows.length;
      }, 0),
...
var budgetSuggestionBySubcategory = (0, vue_1.computed)(function () {
  ...
  for (
    var _i = 0,
      _e =
        (_b =
          (_a = budgetSuggestions.value) === null || _a === void 0
            ? void 0
            : _a.income.subcategories) !== null && _b !== void 0
          ? _b
          : [];
    _i < _e.length;
    _i++
  ...
  for (
    var _f = 0,
      _g =
        (_d =
          (_c = budgetSuggestions.value) === null || _c === void 0
            ? void 0
            : _c.expense.subcategories) !== null && _d !== void 0
          ? _d
          : [];
    _f < _g.length;
    _f++
...
var hasAnyPlannedData = (0, vue_1.computed)(function () {
  return plannedIncomeTotal.value > 0 || plannedExpenseTotal.value > 0;
});
var activeViewSummary = (0, vue_1.computed)(function () {
  return 'Ingresos: '
    .concat(viewModeLabel(incomeViewMode.value), ' \u00B7 Gastos: ')
    .concat(viewModeLabel(expenseViewMode.value));
});
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            Promise.all([incomeStore.loadAll(year), expenseStore.loadAll(year)]),
          ];
        case 1:
          _a.sent();
          return [2 /*return*/];
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.get('/api/budget/annual-income-checkins/', {
        ...
        case 1:
          ...
          nextMap = {};
          for (
            _i = 0, _a = (_b = response.data) !== null && _b !== void 0 ? _b : [];
            _i < _a.length;
            _i++
          ) {
            row = _a[_i];
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.get('/api/budget/annual-income/monthly-summary/', {
              params: { year: year },
            }),
          ];
        case 1:
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.get('/api/budget/annual-expense/monthly-summary/', {
              params: { year: year },
            }),
          ];
        case 1:
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.get('/api/budget/annual-expense-checkins/', {
              params: { year: fiscalYear.value, month: selectedExecutionMonth.value },
            }),
          ];
        case 1:
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            Promise.all([loadExpenseExecutionSummary(), loadExpenseCheckinsForSelectedMonth()]),
          ];
        case 2:
          _a.sent();
          return [3 /*break*/, 4];
...
function ensureExpenseAdjustAmountPrefilled(row) {
  var _a;
  var current = String(
    (_a = expenseAdjustAmounts.value[row.entry.id]) !== null && _a !== void 0 ? _a : '',
  ).trim();
  if (current) return;
...
function incomeCheckinRowSummary(row) {
  var _a;
  var subcategory =
    (_a = incomeSubcategoryLabels.get(row.entry.subcategory)) !== null && _a !== void 0
      ? _a
...
function ensureIncomeAdjustAmountPrefilled(row) {
  var _a;
  var current = String(
    (_a = incomeAdjustAmounts.value[row.entry.id]) !== null && _a !== void 0 ? _a : '',
  ).trim();
  if (current) return;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.delete('/api/budget/annual-income-checkins/'.concat(existing.id, '/')),
          ];
        case 2:
          _a.sent();
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.patch(
              '/api/budget/annual-income-checkins/'.concat(existing.id, '/'),
              payload,
            ),
          ];
        case 2:
          ...
          return [3 /*break*/, 5];
        case 3:
          return [4 /*yield*/, api_1.coreApi.post('/api/budget/annual-income-checkins/', payload)];
        case 4:
          _b.sent();
          _b.label = 5;
        case 5:
...
function onIncomeAdjustAmountBlur(row) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!incomeCheckinsByEntryId.value[row.entry.id]) return [2 /*return*/];
          return [4 /*yield*/, saveIncomeCheckinFromInput(row)];
        case 1:
          _a.sent();
          return [2 /*return*/];
...
function resetIncomeCheckinDraftValue(row, mode) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          incomeAdjustAmounts.value[row.entry.id] =
            mode === 'zero' ? '0.00' : row.planned.toFixed(2);
...
function expenseCheckinRowSummary(row) {
  ...
  var subcategory =
    (_a = expenseSubcategoryLabels.get(row.entry.subcategory)) !== null && _a !== void 0
      ? _a
      : row.entry.subcategory;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.delete('/api/budget/annual-expense-checkins/'.concat(existing.id, '/')),
          ];
        case 2:
          _a.sent();
...
function onExpenseAdjustAmountBlur(row) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!expenseCheckinsByEntryId.value[row.entry.id]) return [2 /*return*/];
          return [4 /*yield*/, saveExpenseCheckinFromInput(row)];
        case 1:
          _a.sent();
          return [2 /*return*/];
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.patch(
              '/api/budget/annual-expense-checkins/'.concat(existing.id, '/'),
              payload,
            ),
          ];
        case 2:
          ...
          return [3 /*break*/, 5];
        case 3:
          return [4 /*yield*/, api_1.coreApi.post('/api/budget/annual-expense-checkins/', payload)];
        case 4:
          _b.sent();
          _b.label = 5;
        case 5:
...
function liquidityCheckinRowSummary(row) {
  return ''
    .concat(shortLiquiditySubcategoryLabel(row.asset_subcategory), ' \u00B7 ')
    .concat(row.asset_name);
}
...
function ensureLiquidityAdjustAmountPrefilled(row) {
  var _a;
  var current = String(
    (_a = liquidityAdjustAmounts.value[row.asset_id]) !== null && _a !== void 0 ? _a : '',
  ).trim();
  if (current) return;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.get('/api/net-worth/liquidity/monthly-summary/', {
              params: { year: fiscalYear.value, month: selectedExecutionMonth.value },
            }),
          ];
        case 1:
          response = _b.sent();
          liquidityMonthlySummary.value =
            (_a = response.data) !== null && _a !== void 0 ? _a : null;
          return [3 /*break*/, 3];
        case 2:
          e_12 = _b.sent();
...
function clearLiquidityCheckin(row) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!row.checkin) return [2 /*return*/];
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.delete('/api/net-worth/liquidity-checkins/'.concat(row.checkin.id, '/')),
          ];
        case 2:
          _a.sent();
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.patch(
              '/api/net-worth/liquidity-checkins/'.concat(row.checkin.id, '/'),
              payload,
            ),
          ];
        case 2:
          ...
          return [3 /*break*/, 5];
        case 3:
          return [4 /*yield*/, api_1.coreApi.post('/api/net-worth/liquidity-checkins/', payload)];
        case 4:
          _b.sent();
          _b.label = 5;
        case 5:
...
/** @type {__VLS_StyleScopedClasses['ui-budget-suggestions-head']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-suggestions-col']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-suggestions-col']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-suggestions-col']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-chip']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-chip']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-flow']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-chip']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-arrow']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-headline']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-nav-btn']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-nav-btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-year-picker']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-owner-picker']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-owner-picker']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-year-picker']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-owner-picker']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-title']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-value']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-value']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-value']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-mini-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-mini-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-main']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-main']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-danger']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-danger']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-good']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-good']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-summary']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-rows']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-execution-note']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-state']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-confirm']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-adjust']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-summary']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-kpis']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-actions']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-adjust']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-quick-actions']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-filter-btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-total']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-total']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-title']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-title']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-detail-toggle']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-head']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-head']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-group-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-group-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row-metric']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-group-head']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-kpis']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row-metrics']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-hero-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-head']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-group-header']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-header-side']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section-controls']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-detail-toggle']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-toolbar']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-suggestions-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-filter-segment']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-residual-kpis']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-bars']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-month-rail']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row-metrics']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-row-metric']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'container ui-pro-page relative' }));
/** @type {__VLS_StyleScopedClasses['container']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-page']} */ /** @type {__VLS_StyleScopedClasses['relative']} */ var __VLS_0 =
  BudgetHeroSection_vue_1.default;
// @ts-ignore
...
if (!__VLS_ctx.isMonthlyCloseView && __VLS_ctx.firstError) {
  ...
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.firstError;
}
if (!__VLS_ctx.isMonthlyCloseView && __VLS_ctx.expenseExecutionError) {
  ...
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.expenseExecutionError;
}
if (!__VLS_ctx.isMonthlyCloseView && __VLS_ctx.liquidityExecutionError) {
  ...
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.liquidityExecutionError;
}
if (__VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'expense') {
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'ui-budget-checkin-subtitle ui-budget-checkin-subtitle-note' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle-note']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle']} */ if (
    ...
    __VLS_asFunctionalElement1(
      ...
      __assign(
        __assign({ value: __VLS_ctx.selectedExecutionMonth }, { class: 'select ui-data-field' }),
        { disabled: __VLS_ctx.expenseExecutionLoading },
      ),
    );
    /** @type {__VLS_StyleScopedClasses['select']} */ /** @type {__VLS_StyleScopedClasses['ui-data-field']} */ for (
      var _i = 0, _4 = __VLS_vFor(__VLS_ctx.monthLabels);
      _i < _4.length;
      _i++
    ) {
      var _5 = _4[_i],
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-list']} */ if (
    __VLS_ctx.expenseExecutionLoading
  ) {
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-groups-box']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-execution-note' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-note']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-execution-note-main' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-note-main']} */ __VLS_asFunctionalElement1(
    ...
    __VLS_asFunctionalElement1(
      ...
      __VLS_intrinsics.small,
    )(__assign({ class: 'ui-budget-execution-note-detail' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-note-detail']} */ __VLS_ctx.monthlyExpenseCoverageDetail;
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-budget-execution-badge' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-badge']} */ __VLS_ctx.monthlyExpenseCoverageLabel;
    if (__VLS_ctx.monthlyExpensePendingClassification.amount > 0) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-state-block ui-state-error' }));
      /** @type {__VLS_StyleScopedClasses['ui-state-block']} */ /** @type {__VLS_StyleScopedClasses['ui-state-error']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.strong,
        __VLS_intrinsics.strong,
      )({});
      __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
    ...
    for (
      var _6 = 0, _7 = __VLS_vFor(__VLS_ctx.groupedMonthlyExpenseExecutionEntries);
      _6 < _7.length;
      _6++
    ) {
      var group = _7[_6][0];
      __VLS_asFunctionalElement1(
        ...
        __assign(
          __assign(
            { key: 'expense-checkin-group-'.concat(group.categoryKey) },
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-title']} */ group.categoryLabel;
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.span,
        __VLS_intrinsics.span,
      )(__assign({ class: 'ui-budget-checkin-group-meta' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-meta']} */ group.rows.length;
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-pos']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-neg']} */ group.deviation >
      0
        ? '+'
        : '';
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-rows']} */ var _loop_1 =
        function (row) {
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.article,
            __VLS_intrinsics.article,
            ...
            __assign(
              { key: 'expense-checkin-'.concat(row.entry.id) },
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-main']} */ if (
            row.executionSource !== 'none'
          ) {
            __VLS_asFunctionalElement1(
              __VLS_intrinsics.div,
              __VLS_intrinsics.div,
            ...
            /** @type {__VLS_StyleScopedClasses['ui-budget-execution-chip']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-execution-chip-ledger']} */ __VLS_ctx.executionSourceLabel(
              row.executionOrigin,
            );
          }
          __VLS_asFunctionalElement1(
            ...
            __assign(
              ...
              { title: __VLS_ctx.expenseCheckinRowSummary(row) },
            ),
          );
          /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-title']} */ __VLS_ctx.expenseCheckinRowSummary(
            row,
          );
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.span,
          ...
          if (
            ...
            if (
              ...
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.span,
                __VLS_intrinsics.span,
              )(__assign({ class: 'ui-budget-checkin-row-lock-note' }));
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-quick-actions']} */ __VLS_asFunctionalElement1(
            ...
            __assign(
                ...
                __assign(
                  {
                    onClick: function () {
                      ...
                      if (
                        !(
                          __VLS_ctx.isMonthlyCloseView &&
                          __VLS_ctx.activeMonthlyCloseStep === 'expense'
                        )
                      )
                        return;
                      if (!!__VLS_ctx.expenseExecutionLoading) return;
                      if (!!!__VLS_ctx.groupedMonthlyExpenseExecutionEntries.length) return;
              ...
              {
                disabled:
                  __VLS_ctx.isLockedExecutionRow(row) ||
                  __VLS_ctx.expenseExecutionBusyEntryId === row.entry.id,
          ...
          /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-mini-btn']} */ __VLS_asFunctionalElement1(
            ...
            __assign(
              ...
              { disabled: __VLS_ctx.isLockedExecutionRow(row), placeholder: 'Importe ejecutado' },
            ),
          );
          ...
          /** @type {__VLS_StyleScopedClasses['input']} */ /** @type {__VLS_StyleScopedClasses['ui-data-field']} */ __VLS_asFunctionalElement1(
            ...
            __assign(
              ...
              { title: 'Confirmar check-in del mes' },
            ),
          );
            ...
            __assign(
              {
                onChange: function () {
                  ...
                  if (
                    !(
                      __VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'expense'
                    )
                  )
                    return;
                  if (!!__VLS_ctx.expenseExecutionLoading) return;
...
if (__VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'income') {
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'ui-budget-checkin-subtitle ui-budget-checkin-subtitle-note' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-subtitle-note']} */ __VLS_asFunctionalElement1(
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-good']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-kpi-danger']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )({});
  __VLS_asFunctionalElement1(__VLS_intrinsics.strong, __VLS_intrinsics.strong)({});
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-list']} */ if (
    __VLS_ctx.incomeExecutionLoading
  ) {
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'subtle text-red-400' }));
    /** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['text-red-400']} */ __VLS_ctx.incomeExecutionError;
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-note-detail']} */ __VLS_ctx.monthlyIncomeCoverageDetail;
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-budget-execution-badge' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-execution-badge']} */ __VLS_ctx.monthlyIncomeCoverageLabel;
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-meta']} */ __VLS_ctx
      .monthlyIncomeExecutionEntries.length;
    __VLS_ctx.formatPercent(__VLS_ctx.selectedIncomeMonthCompletionRatio, 0);
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-pos']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-neg']} */ __VLS_ctx.selectedIncomeMonthDeviation >
    0
      ? '+'
      : '';
    __VLS_ctx.formatMoney(__VLS_ctx.selectedIncomeMonthDeviation);
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-rows']} */ var _loop_2 = function (
      row,
    ) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.article,
        ...
        __assign(
          { key: 'income-checkin-'.concat(row.entry.id) },
          { class: 'ui-budget-checkin-row' },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row']} */ __VLS_asFunctionalElement1(
      ...
      __VLS_asFunctionalElement1(
        ...
        __assign(
          { class: 'ui-budget-checkin-row-title' },
          { title: __VLS_ctx.incomeCheckinRowSummary(row) },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-title']} */ __VLS_ctx.incomeCheckinRowSummary(
        row,
      );
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.span,
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-quick-actions']} */ __VLS_asFunctionalElement1(
        ...
        __assign(
            ...
            __assign(
              {
                onClick: function () {
                  ...
                  var $event = _a[0];
                  if (
                    !(__VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'income')
                  )
                    return;
                  if (!!__VLS_ctx.incomeExecutionLoading) return;
                  if (!!__VLS_ctx.incomeExecutionError) return;
                  if (!!!__VLS_ctx.monthlyIncomeExecutionEntries.length) return;
          ...
          ),
          {
            disabled:
              __VLS_ctx.isLockedExecutionRow(row) ||
              __VLS_ctx.incomeExecutionBusyEntryId === row.entry.id,
          },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-mini-btn']} */ __VLS_asFunctionalElement1(
                ...
                __assign(
                  {
                    onFocus: function () {
                      ...
                      if (
                        !(
                          __VLS_ctx.isMonthlyCloseView &&
                          __VLS_ctx.activeMonthlyCloseStep === 'income'
                        )
                      )
                        return;
                      if (!!__VLS_ctx.incomeExecutionLoading) return;
      ...
      /** @type {__VLS_StyleScopedClasses['input']} */ /** @type {__VLS_StyleScopedClasses['ui-data-field']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.label,
        __VLS_intrinsics.label,
      )(__assign({ class: 'ui-budget-checkin-confirm' }, { title: 'Confirmar check-in del mes' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-confirm']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.input,
      )(
        __assign(
    ...
    for (
      var _10 = 0, _11 = __VLS_vFor(__VLS_ctx.monthlyIncomeExecutionEntries);
      _10 < _11.length;
      _10++
    ) {
      var row = _11[_10][0];
...
if (__VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'result') {
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-title']} */ __VLS_asFunctionalElement1(
    ...
    __assign(__assign({ type: 'button' }, { class: 'btn ui-monthly-close-step-nav-btn' }), {
      disabled: true,
    }),
  );
  /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['ui-monthly-close-step-nav-btn']} */ __VLS_asFunctionalElement1(
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-grid' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-grid']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.section,
    __VLS_intrinsics.section,
  )(__assign({ class: 'ui-budget-result-card' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-card-head' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-head']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.h3,
    __VLS_intrinsics.h3,
  )(__assign({ class: 'ui-budget-result-card-title' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-title']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-card-meta' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-meta']} */ __VLS_ctx.formatMoney(
    __VLS_ctx.selectedMonthlyExecutedVolume,
  );
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-recon-flow' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow']} */ for (
    var _12 = 0, _13 = __VLS_vFor(__VLS_ctx.resultReconciliationFlowRows);
    _12 < _13.length;
    _12++
  ) {
    var row = _13[_12][0];
    __VLS_asFunctionalElement1(
      ...
      __assign(__assign({ key: row.id }, { class: 'ui-budget-recon-flow-row' }), {
        class: {
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row-result']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row-positive']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row-warning']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row-negative']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-recon-flow-row-main' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-row-main']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-recon-flow-label' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-label']} */ row.label;
    if (row.meta) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-recon-flow-meta' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-meta']} */ row.meta;
    }
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.strong,
      __VLS_intrinsics.strong,
    )(__assign({ class: 'ui-budget-recon-flow-value' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-recon-flow-value']} */ __VLS_ctx.formatSignedMoney(
      row.amount,
    );
    // @ts-ignore
    [
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-title']} */ __VLS_asFunctionalElement1(
    ...
    __assign(
      ...
      { class: 'ui-budget-result-badge-'.concat(__VLS_ctx.selectedMonthlyResidualSeverity) },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-badge']} */ __VLS_ctx.selectedMonthlyResidualSeverityLabel;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-residual-kpis' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-residual-kpis']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.article,
    __VLS_intrinsics.article,
  )(__assign({ class: 'ui-budget-result-mini-kpi' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-mini-kpi']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )({});
  __VLS_asFunctionalElement1(__VLS_intrinsics.strong, __VLS_intrinsics.strong)({});
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-composition' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition']} */ for (
    var _14 = 0, _15 = __VLS_vFor(__VLS_ctx.resultReconciliationCompositionRows);
    _14 < _15.length;
    _14++
  ) {
    var row = _15[_14][0];
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ key: row.id }, { class: 'ui-budget-result-composition-row' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-row']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-result-composition-main' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-main']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )({});
    row.label;
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-result-composition-bar' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-bar']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
    )(
      __assign(
        __assign(
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-fill']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-fill-positive']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-fill-warning']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-fill-negative']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-result-composition-share' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-composition-share']} */ __VLS_ctx.formatPercent(
      row.shareOfVolume,
      1,
    );
    // @ts-ignore
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-result-grid ui-budget-result-grid-detail' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-result-grid-detail']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.section,
    __VLS_intrinsics.section,
  )(__assign({ class: 'ui-budget-result-card' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card']} */ __VLS_asFunctionalElement1(
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-meta']} */ __VLS_ctx
    .monthlyIncomeExecutionEntries.length;
  if (!__VLS_ctx.monthlyIncomeResultBreakdown.length) {
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-result-breakdown-list' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-list']} */ for (
      var _16 = 0, _17 = __VLS_vFor(__VLS_ctx.monthlyIncomeResultBreakdown);
      _16 < _17.length;
      _16++
    ) {
      var group = _17[_16][0];
      __VLS_asFunctionalElement1(
        ...
        __assign(
          { key: 'result-income-'.concat(group.key) },
          { class: 'ui-budget-result-breakdown-group' },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-group']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-result-breakdown-group-head' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-group-head']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )({});
      __VLS_asFunctionalElement1(__VLS_intrinsics.strong, __VLS_intrinsics.strong)({});
      ...
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-result-breakdown-submeta' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-submeta']} */ group.lineCount;
      __VLS_ctx.formatPercent(group.completionRatio, 0);
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-result-breakdown-kpis' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-kpis']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.span,
        __VLS_intrinsics.span,
      )({});
      __VLS_ctx.formatMoney(group.executedTotal);
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-pos']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-group-dev-neg']} */ __VLS_ctx.formatSignedMoney(
        group.deviation,
      );
      __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
      ...
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-result-breakdown-rows' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-rows']} */ for (
        var _18 = 0, _19 = __VLS_vFor(group.rows.slice(0, 5));
        _18 < _19.length;
        _18++
      ) {
        var row = _19[_18][0];
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ key: row.key }, { class: 'ui-budget-result-breakdown-row' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-row']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
        )(__assign({ class: 'ui-budget-result-breakdown-name' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-name']} */ row.subcategoryLabel;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
      ...
      if (group.rows.length > 5) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-result-breakdown-more' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-more']} */ group.rows
          .length - 5;
      }
      // @ts-ignore
      [];
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-result-card-meta']} */ __VLS_ctx
    .monthlyExpenseExecutionEntries.length;
  if (!__VLS_ctx.monthlyExpenseResultBreakdown.length) {
    ...
    /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-list']} */ for (
      var _20 = 0, _21 = __VLS_vFor(__VLS_ctx.monthlyExpenseResultBreakdown);
      _20 < _21.length;
      _20++
    ) {
      var group = _21[_20][0];
      __VLS_asFunctionalElement1(
        ...
        __assign(
          { key: 'result-expense-'.concat(group.key) },
          { class: 'ui-budget-result-breakdown-group' },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-group']} */ __VLS_asFunctionalElement1(
      ...
      /** @type {__VLS_StyleScopedClasses['ui-budget-result-breakdown-rows']} */ for (
        var _22 = 0, _23 = __VLS_vFor(group.rows.slice(0, 5));
        _22 < _23.length;
        _22++
      ) {
        var row = _23[_22][0];
...
if (!__VLS_ctx.isMonthlyCloseView && !__VLS_ctx.hasAnyPlannedData && !__VLS_ctx.isLoading) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.section,
    __VLS_intrinsics.section,
  )(__assign({ class: 'card ui-pro-panel ui-budget-empty mt-3' }));
  /** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-empty']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.h2,
    __VLS_intrinsics.h2,
  )(__assign({ class: 'mt-0' }));
  /** @type {__VLS_StyleScopedClasses['mt-0']} */ __VLS_ctx.fiscalYear;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'subtle mb-0' }));
  /** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['mb-0']} */ var __VLS_10 =
    void 0;
  /** @ts-ignore @type {typeof __VLS_components.RouterLink | typeof __VLS_components.RouterLink} */
  RouterLink;
  // @ts-ignore
  var __VLS_11 = __VLS_asFunctionalComponent1(
    __VLS_10,
    new __VLS_10(__assign({ class: 'ui-budget-empty-link' }, { to: '/introduccion-datos' })),
  );
  var __VLS_12 = __VLS_11.apply(
    void 0,
    __spreadArray(
      [__assign({ class: 'ui-budget-empty-link' }, { to: '/introduccion-datos' })],
      __VLS_functionalComponentArgsRest(__VLS_11),
      false,
    ),
  );
  /** @type {__VLS_StyleScopedClasses['ui-budget-empty-link']} */ var __VLS_15 =
...
var _loop_3 = function (section) {
  __VLS_asFunctionalElement1(
    ...
    __assign(__assign({ key: section.id }, { class: 'card ui-pro-panel ui-budget-section mt-3' }), {
      class: section.toneClass,
    }),
  );
  __VLS_asFunctionalDirective(__VLS_directives.vShow, {})(
    null,
    __assign(__assign({}, __VLS_directiveBindingRestFields), {
      value: !__VLS_ctx.isMonthlyCloseView,
    }),
    null,
    null,
  );
  /** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-section']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-section-header' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-header']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )({});
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.h2,
    __VLS_intrinsics.h2,
  )(__assign({ class: 'ui-budget-section-title' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-title']} */ section.title;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'ui-budget-section-subtitle' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-subtitle']} */ section.subtitle;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-section-header-side' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-header-side']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-section-controls' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-controls']} */ if (section.groups.length) {
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.button,
      __VLS_intrinsics.button,
    )(
      __assign(
        ...
        { 'aria-expanded': __VLS_ctx.isSectionExpanded(section.id) },
      ),
    );
    /** @type {__VLS_StyleScopedClasses['ui-budget-detail-toggle']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-budget-detail-toggle-icon' }, { 'aria-hidden': 'true' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-detail-toggle-icon']} */ __VLS_ctx.isSectionExpanded(
      section.id,
    )
      ? '−'
      : '+';
    ...
    __VLS_ctx.isSectionExpanded(section.id)
      ? 'Ocultar detalle'
      : 'Ver detalle ('
          .concat(section.categoryCount, ' categorias \u00B7 ')
          .concat(section.subcategoryCount, ' subcategorias)');
  }
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
    ...
    __assign(
      ...
      { role: 'tablist', 'aria-label': 'Filtro de '.concat(section.title) },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['ui-budget-filter-segment']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.button,
    __VLS_intrinsics.button,
  )(
    __assign(
        ...
        __assign(
          {
            onClick: function () {
              ...
              var $event = _a[0];
              section.id === 'income'
                ? (__VLS_ctx.incomeViewMode = 'all')
                : (__VLS_ctx.expenseViewMode = 'all');
              // @ts-ignore
              [
                incomeViewMode,
                expenseViewMode,
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-filter-btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-filter-btn-active']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.button,
    __VLS_intrinsics.button,
  )(
    __assign(
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-filter-btn']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-filter-btn-active']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-section-total' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-section-total']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.strong,
    __VLS_intrinsics.strong,
  )({});
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-evolution-card' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-card']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-evolution-head' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-head']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )({});
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )(__assign({ class: 'ui-budget-pill' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-pill']} */ section.id === 'income'
    ? 'Cierre mensual activo'
  ...
  /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-bars']} */ for (
    var _26 = 0,
      _27 = __VLS_vFor(
        section.id === 'income'
          ? __VLS_ctx.incomeEvolutionMonths
          : __VLS_ctx.monthLabels.map(function (label) {
              return { label: label };
            }),
      );
    _26 < _27.length;
    ...
    __VLS_asFunctionalElement1(
      ...
      __assign(
        { key: ''.concat(section.id, '-').concat(point.label) },
        { class: 'ui-budget-month-col' },
      ),
    );
    /** @type {__VLS_StyleScopedClasses['ui-budget-month-col']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-month-rail' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-month-rail']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
    )(
      __assign(
        __assign(
        ...
        ),
        {
          title:
            section.id === 'income' && 'planned' in point
              ? 'Previsto '
                  .concat(point.label, ': ')
                  .concat(__VLS_ctx.formatMoney(Number(point.planned)), ' EUR')
              : undefined,
        },
      ),
    );
    /** @type {__VLS_StyleScopedClasses['ui-budget-month-plan']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
    )(
      __assign(
        __assign(
        ...
        ),
        {
          title:
            section.id === 'income' && 'executed' in point
              ? 'Ejecutado '
                  .concat(point.label, ': ')
                  .concat(__VLS_ctx.formatMoney(Number(point.executed)), ' EUR')
              : undefined,
        },
      ),
    );
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-budget-month-label' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-month-label']} */ point.label;
    // @ts-ignore
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-budget-evolution-legend' }));
  /** @type {__VLS_StyleScopedClasses['ui-budget-evolution-legend']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )({});
  __VLS_asFunctionalElement1(__VLS_intrinsics.i)(
    __assign({ class: 'ui-budget-legend-dot ui-budget-legend-plan' }),
  );
  /** @type {__VLS_StyleScopedClasses['ui-budget-legend-dot']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-legend-plan']} */ if (
    section.id === 'income'
  ) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.i)(
      __assign({ class: 'ui-budget-legend-dot ui-budget-legend-exec-solid' }),
    );
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.i)(
      __assign({ class: 'ui-budget-legend-dot ui-budget-legend-exec' }),
    );
    /** @type {__VLS_StyleScopedClasses['ui-budget-legend-dot']} */
  ...
  __VLS_asFunctionalElement1(__VLS_intrinsics.strong, __VLS_intrinsics.strong)({});
  __VLS_ctx.formatCompactMoney(
    section.id === 'income' ? __VLS_ctx.incomeEvolutionBaseMonthly : section.totalAnnual / 12,
  );
  if (section.groups.length && __VLS_ctx.isSectionExpanded(section.id)) {
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-groups' }));
    /** @type {__VLS_StyleScopedClasses['ui-budget-groups']} */ for (
      var _28 = 0, _29 = __VLS_vFor(section.groups);
      _28 < _29.length;
      _28++
    ) {
      var group = _29[_28][0];
      __VLS_asFunctionalElement1(
        ...
        __assign(
          { key: ''.concat(section.id, '-').concat(group.categoryKey) },
          { class: 'ui-budget-group' },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-budget-group']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.header,
        __VLS_intrinsics.header,
      )(__assign({ class: 'ui-budget-group-header' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-group-header']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-group-title-wrap' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-group-title-wrap']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-group-kicker' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-group-kicker']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.h3,
        __VLS_intrinsics.h3,
      )({});
      group.categoryLabel;
      ...
      if (__VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) {
        __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            { 'aria-label': 'Ejecucion YTD categoria '.concat(group.categoryLabel) },
          ),
        );
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-inline-progress-labels' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-labels']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
        )({});
        ...
        __VLS_ctx.formatPercent(
          (_b =
            (_a = __VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) ===
              null || _a === void 0
              ? void 0
              : _a.completionRatio) !== null && _b !== void 0
            ? _b
            : null,
          0,
        );
        __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            {
              class: 'ui-budget-inline-progress-preview-pill-'.concat(
                (_c = __VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) ===
                  null || _c === void 0
                  ? void 0
                  : _c.tone,
              ),
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-preview-pill']} */ __VLS_ctx.formatPercent(
          (_e =
            (_d = __VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) ===
              null || _d === void 0
              ? void 0
              : _d.ratio) !== null && _e !== void 0
            ? _e
            : null,
          0,
        );
        __VLS_asFunctionalElement1(
          ...
          __assign({ class: 'ui-budget-inline-progress-track ui-budget-inline-progress-track-lg' }),
        );
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track-lg']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
        )(
          __assign(
            __assign(
              ...
              {
                class: 'ui-budget-inline-progress-fill-'.concat(
                  (_f = __VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) ===
                    null || _f === void 0
                    ? void 0
                    : _f.tone,
                ),
            ...
            ),
            {
              style: {
                width: ''.concat(
                  (_h =
                    (_g = __VLS_ctx.budgetCategoryActualExecution(
                      section.id,
                      group.categoryKey,
                    )) === null || _g === void 0
                      ? void 0
                      : _g.widthPct) !== null && _h !== void 0
                    ? _h
                    : 8,
                  '%',
                ),
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-fill']} */ if (
          (_j = __VLS_ctx.budgetCategoryActualExecution(section.id, group.categoryKey)) === null ||
          _j === void 0
            ? void 0
            : _j.overflow
        ) {
        ...
        __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            {
              class: 'ui-budget-inline-progress-preview-pill-'.concat(
                __VLS_ctx.executionPreview(section.id, 'group:'.concat(group.categoryKey)).tone,
              ),
            },
          ),
        );
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-preview-pill']} */ __VLS_ctx.formatPercent(
          __VLS_ctx.executionPreview(section.id, 'group:'.concat(group.categoryKey)).ratio,
          0,
        );
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track-lg']} */ __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            ),
            {
              style: {
                width: ''.concat(
                  __VLS_ctx.executionPreview(section.id, 'group:'.concat(group.categoryKey))
                    .widthPct,
                  '%',
                ),
              },
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-fill']} */ if (
          __VLS_ctx.executionPreview(section.id, 'group:'.concat(group.categoryKey)).overflow
        ) {
          __VLS_asFunctionalElement1(__VLS_intrinsics.span)(
            __assign(
              { class: 'ui-budget-inline-progress-overflow-marker' },
      ...
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-budget-group-amount' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-group-amount']} */ __VLS_ctx.formatMoney(
        group.plannedAnnual,
      );
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.ul,
        __VLS_intrinsics.ul,
      )(__assign({ class: 'ui-budget-rows' }));
      /** @type {__VLS_StyleScopedClasses['ui-budget-rows']} */ for (
        var _30 = 0, _31 = __VLS_vFor(group.rows);
        _30 < _31.length;
        _30++
      ) {
        var row = _31[_30][0];
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.li,
          __VLS_intrinsics.li,
        )(__assign({ key: row.key }, { class: 'ui-budget-row' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-main' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-main']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-kicker' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-kicker']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-title' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-title']} */ row.subcategoryLabel;
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-meta' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-meta']} */ row.itemsCount;
        row.itemsCount === 1 ? '' : 's';
        ...
        if (__VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) {
          __VLS_asFunctionalElement1(
            ...
            __assign(
              ...
              { 'aria-label': 'Ejecucion YTD subcategoria '.concat(row.subcategoryLabel) },
            ),
          );
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress']} */ /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-row']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'ui-budget-inline-progress-track' }));
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
          )(
            __assign(
              __assign(
                ...
                {
                  class: 'ui-budget-inline-progress-fill-'.concat(
                    (_k = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) ===
                      null || _k === void 0
                      ? void 0
                      : _k.tone,
                  ),
              ...
              ),
              {
                style: {
                  width: ''.concat(
                    (_m =
                      (_l = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) ===
                        null || _l === void 0
                        ? void 0
                        : _l.widthPct) !== null && _m !== void 0
                      ? _m
                      : 8,
                    '%',
                  ),
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-fill']} */ if (
            (_o = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
            _o === void 0
              ? void 0
              : _o.overflow
          ) {
          ...
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'ui-budget-inline-progress-caption' }));
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-caption']} */ __VLS_ctx.selectedExecutionMonthLabel;
          __VLS_ctx.formatPercent(
            (_q =
              (_p = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
              _p === void 0
                ? void 0
                : _p.completionRatio) !== null && _q !== void 0
              ? _q
              : null,
            0,
          );
          __VLS_asFunctionalElement1(
            ...
            __assign({
              class: 'ui-budget-inline-progress-caption-tone-'.concat(
                (_r = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _r === void 0
                  ? void 0
                  : _r.tone,
              ),
          ...
          __VLS_ctx.formatPercent(
            (_t =
              (_s = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
              _s === void 0
                ? void 0
                : _s.ratio) !== null && _t !== void 0
              ? _t
              : null,
            0,
          );
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-track']} */ __VLS_asFunctionalElement1(
            ...
            __assign(
              __assign(
                ...
                {
                  class: 'ui-budget-inline-progress-fill-'.concat(
                    __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).tone,
                  ),
                },
              ),
              {
                style: {
                  width: ''.concat(
                    __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).widthPct,
                    '%',
                  ),
                },
              },
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-fill']} */ if (
            __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).overflow
          ) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.span)(
              __assign(
                { class: 'ui-budget-inline-progress-overflow-marker' },
          ...
          /** @type {__VLS_StyleScopedClasses['ui-budget-inline-progress-caption']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.span,
            __VLS_intrinsics.span,
          )(
            __assign({
          ...
          __VLS_ctx.formatPercent(
            __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).ratio,
            0,
          );
        }
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-metrics' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-metrics']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-budget-row-metric' }));
        /** @type {__VLS_StyleScopedClasses['ui-budget-row-metric']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
        )({});
        ...
        __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)
          ? ''.concat(
              __VLS_ctx.formatMoney(
                (_v =
                  (_u = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _u === void 0
                    ? void 0
                    : _u.planned) !== null && _v !== void 0
                  ? _v
                  : 0,
              ),
              ' EUR',
        ...
        __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            {
              class: 'ui-budget-pending-text-'.concat(
                (_x =
                  (_w = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _w === void 0
                    ? void 0
                    : _w.tone) !== null && _x !== void 0
                  ? _x
                  : __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).tone,
              ),
            },
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-pending-text']} */ __VLS_ctx.budgetSubcategoryActualExecution(
          section.id,
          row.key,
        )
          ? ''.concat(
              __VLS_ctx.formatMoney(
                (_z =
                  (_y = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _y === void 0
                    ? void 0
                    : _y.executed) !== null && _z !== void 0
                  ? _z
                  : 0,
              ),
              ' EUR',
        ...
        __VLS_asFunctionalElement1(
          ...
          __assign(
            { class: 'ui-budget-pending-text' },
            {
              class: 'ui-budget-pending-text-'.concat(
                (_1 =
                  (_0 = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _0 === void 0
                    ? void 0
                    : _0.tone) !== null && _1 !== void 0
                  ? _1
                  : __VLS_ctx.executionPreview(section.id, 'row:'.concat(row.key)).tone,
              ),
            },
        ...
        /** @type {__VLS_StyleScopedClasses['ui-budget-pending-text']} */ __VLS_ctx.budgetSubcategoryActualExecution(
          ...
          ? ''.concat(
              __VLS_ctx.formatSignedMoney(
                (_3 =
                  (_2 = __VLS_ctx.budgetSubcategoryActualExecution(section.id, row.key)) === null ||
                  _2 === void 0
                    ? void 0
                    : _2.deviation) !== null && _3 !== void 0
                  ? _3
                  : 0,
              ),
              ' EUR',
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-budget-detail-collapsed-note' }));
    ...
    /** @type {__VLS_StyleScopedClasses['subtle']} */ section.emptyMessage;
