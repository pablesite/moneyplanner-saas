...
var _9 = (0, net_worth_1.useNetWorthViewState)(),
  store = _9.store,
  assetCategories = _9.assetCategories,
  assetSubcategories = _9.assetSubcategories,
  liabilityCategories = _9.liabilityCategories,
  prettyError = _9.prettyError,
  showAssetModal = _9.showAssetModal,
  showLiabilityModal = _9.showLiabilityModal,
  showEditModal = _9.showEditModal,
  editItem = _9.editItem,
  editKind = _9.editKind,
  openEdit = _9.openEdit,
  closeEdit = _9.closeEdit,
  editTitle = _9.editTitle,
  editCategories = _9.editCategories,
  editInitial = _9.editInitial,
  submitEdit = _9.submitEdit;
var _10 = (0, net_worth_1.useNetWorthViewExtensions)(store),
  itemFormProps = _10.itemFormProps,
  itemListProps = _10.itemListProps;
var _11 = (0, data_input_1.useAnnualIncomeStore)('core'),
  annualIncomeEntries = _11.entries,
  annualIncomeLoading = _11.loading,
  annualIncomeApiError = _11.error,
  loadAnnualIncome = _11.loadAll,
  addIncomeEntry = _11.addEntry,
  updateIncomeEntry = _11.updateEntry,
  deleteIncomeEntry = _11.deleteEntry;
var _12 = (0, data_input_1.useAnnualExpenseStore)('core'),
  annualExpenseEntries = _12.entries,
  annualExpenseLoading = _12.loading,
  annualExpenseApiError = _12.error,
  loadAnnualExpense = _12.loadAll,
  addExpenseEntry = _12.addEntry,
  updateExpenseEntry = _12.updateEntry,
  deleteExpenseEntry = _12.deleteEntry,
  listBySourceLiability = _12.listBySourceLiability;
...
var annualSubcategoryOptions = (0, vue_1.computed)(function () {
  return data_input_1.incomeSubcategories.filter(function (row) {
    return row.category === annualIncomeForm.category;
  });
});
...
var annualEventGroupOptions = (0, vue_1.computed)(function () {
  ...
  return Array.from(groups).sort(function (a, b) {
...
var showExpenseCashflowRoleField = (0, vue_1.computed)(function () {
  return annualExpenseForm.timeProfile !== 'term_recurrent';
});
function normalizeExpenseCashflowRoleForCurrentTimeProfile() {
  ...
  var suggested = defaultExpenseCashflowRole(
...
function formatOwnershipPercent(raw) {
  ...
  if (!Number.isFinite(value)) return ''.concat(raw, '%');
...
function sharedOwnershipLabel(splits) {
  ...
  var details = splits.map(function (split) {
    return ''.concat(split.member.name, ' ').concat(formatOwnershipPercent(split.percent));
  });
...
var ownerOptions = (0, vue_1.computed)(function () {
  ...
  var options = new Map();
  for (
    var _i = 0, _c = (_a = store.ownerships) !== null && _a !== void 0 ? _a : [];
    _i < _c.length;
    _i++
  ) {
    var ownership = _c[_i];
...
var sharedOwnershipAllocationsByLabel = (0, vue_1.computed)(function () {
  ...
  var map = new Map();
  for (
    var _i = 0, _d = (_a = store.ownerships) !== null && _a !== void 0 ? _a : [];
    _i < _d.length;
    _i++
  ) {
    var ownership = _d[_i];
    ...
    var shares = ((_c = ownership.splits) !== null && _c !== void 0 ? _c : [])
      .map(function (split) {
        var _a, _b, _c, _d;
        var share = Number(
          String((_a = split.percent) !== null && _a !== void 0 ? _a : '').replace(',', '.'),
        );
        var name =
          (_d =
            (_c = (_b = split.member) === null || _b === void 0 ? void 0 : _b.name) === null ||
            _c === void 0
              ? void 0
...
var annualOwnerFilterOptions = (0, vue_1.computed)(function () {
  return ownerOptions.value
    .filter(function (option) {
      return option.key.startsWith('individual:');
    })
    .sort(function (a, b) {
      return a.label.localeCompare(b.label);
    });
...
var showOwnerField = (0, vue_1.computed)(function () {
  return ownerOptions.value.length > 1;
});
...
function parseSharedOwnerShares(ownerLabel) {
  ...
  return match[1]
    ...
    .map(function (part) {
      ...
      if (!(parsed === null || parsed === void 0 ? void 0 : parsed[1]) || !parsed[2]) return null;
...
function allocatedFractionForAnnualOwner(ownerLabel, selectedOwner) {
  ...
  var sharedFromOwnerships =
    (_a = sharedEntries.find(function (_a) {
      var label = _a[0];
      return normalizeOwnerKey(label) === normalizedText;
    })) === null || _a === void 0
      ? void 0
      : _a[1];
  var fallbackBareShared =
    normalizeOwnerKey(text) === 'compartido' && sharedEntries.length === 1
      ? (_b = sharedEntries[0]) === null || _b === void 0
        ? void 0
        : _b[1]
      : null;
  var shared =
    (_c =
      sharedFromOwnerships !== null && sharedFromOwnerships !== void 0
        ? sharedFromOwnerships
        : fallbackBareShared) !== null && _c !== void 0
      ? _c
      : parseSharedOwnerShares(text);
  if (!shared.length) return 0;
  var totalShare = shared.reduce(function (sum, row) {
    return sum + row.share;
  }, 0);
  var matchedShare = shared
    .filter(function (row) {
      return normalizeOwnerKey(row.name) === normalizeOwnerKey(selectedOwner);
    })
...
function filterAnnualEntriesByOwner(list, selectedOwner) {
  ...
  if (selectedOwner === 'unassigned') {
    return list.filter(function (entry) {
      var _a;
      return !String((_a = entry.owner) !== null && _a !== void 0 ? _a : '').trim();
    });
  }
  return list
    .map(function (entry) {
      ...
      return fraction > 0
        ? __assign(__assign({}, entry), { amountAnnual: entry.amountAnnual * fraction })
        : null;
    })
    .filter(function (entry) {
      return entry != null && entry.amountAnnual > 0;
    });
}
...
function effectiveAnnualAmountForSelectedYear(entry, selectedYear) {
  ...
  var months = Math.min(
    12,
    Math.max(1, Number((_a = entry.termEndMonth) !== null && _a !== void 0 ? _a : 12)),
  );
...
var annualIncomeEntriesByVisibility = (0, vue_1.computed)(function () {
  return annualIncomeEntries.value
    .filter(function (entry) {
      return isVisibleByFilterMode(entry.isActive);
    })
    .map(function (entry) {
...
var annualOwnerFilterValue = (0, vue_1.computed)(function () {
  ...
  var member = globalOwnershipFilterOptions.value.find(function (option) {
    return option.id === globalOwnershipFilter.value;
  });
  return (_a = member === null || member === void 0 ? void 0 : member.label) !== null &&
    _a !== void 0
    ? _a
    : 'all';
});
var filteredAnnualIncomeEntries = (0, vue_1.computed)(function () {
  return filterAnnualEntriesByOwner(
    annualIncomeEntriesByVisibility.value,
    annualOwnerFilterValue.value,
  );
});
var filteredAnnualExpenseEntries = (0, vue_1.computed)(function () {
  return filterAnnualEntriesByOwner(
    annualExpenseEntriesByVisibility.value,
    annualOwnerFilterValue.value,
  );
});
var filteredAnnualIncomeTotal = (0, vue_1.computed)(function () {
  return filteredAnnualIncomeEntries.value.reduce(function (sum, entry) {
    return sum + entry.amountAnnual;
  }, 0);
});
var filteredAnnualExpenseTotal = (0, vue_1.computed)(function () {
  return filteredAnnualExpenseEntries.value.reduce(function (sum, entry) {
    return sum + entry.amountAnnual;
  }, 0);
});
var annualBalanceTotal = (0, vue_1.computed)(function () {
  return filteredAnnualIncomeTotal.value - filteredAnnualExpenseTotal.value;
});
var activeAssets = (0, vue_1.computed)(function () {
  return store.assets.filter(function (item) {
    return item.is_active !== false;
  });
});
var activeLiabilities = (0, vue_1.computed)(function () {
  return store.liabilities.filter(function (item) {
    return item.is_active !== false;
  });
});
var archivedAssets = (0, vue_1.computed)(function () {
  return store.assets.filter(function (item) {
    return item.is_active === false;
  });
});
...
var visibleAssetsByOwner = (0, vue_1.computed)(function () {
  return visibleAssets.value.filter(function (item) {
    return allocatedFractionForNetWorthOwner(item.ownership_ref, assetOwnershipFilter.value) > 0;
  });
});
...
var annualIncomeCount = (0, vue_1.computed)(function () {
  return filteredAnnualIncomeEntries.value.length;
});
var annualExpenseCount = (0, vue_1.computed)(function () {
  return filteredAnnualExpenseEntries.value.length;
});
var assetsCount = (0, vue_1.computed)(function () {
  return visibleAssetsByOwner.value.length;
});
var liabilitiesCount = (0, vue_1.computed)(function () {
  return visibleLiabilitiesByOwner.value.length;
});
var hasIncomeData = (0, vue_1.computed)(function () {
  return annualIncomeCount.value > 0;
});
var hasExpenseData = (0, vue_1.computed)(function () {
  return annualExpenseCount.value > 0;
});
var hasAssetData = (0, vue_1.computed)(function () {
  return assetsCount.value > 0;
});
var hasLiabilityData = (0, vue_1.computed)(function () {
  return liabilitiesCount.value > 0;
});
var hasCompleteDataInput = (0, vue_1.computed)(function () {
  return (
...
var dataInputSummary = (0, vue_1.computed)(function () {
  ...
  return 'Estado actual: '
    ...
    .concat(
      liabilitiesPart,
      '. Completa los cuatro bloques para un diagnostico patrimonial fiable.',
    );
});
(0, vue_1.watch)(
  function () {
    return annualIncomeForm.category;
  },
  function () {
    var options = annualSubcategoryOptions.value;
    if (!options.length) return;
    var isCurrentValid = options.some(function (row) {
      return row.value === annualIncomeForm.subcategory;
    });
    if (!isCurrentValid) {
...
(0, vue_1.watch)(
  function () {
    return annualExpenseForm.category;
  },
  function () {
    var options = annualExpenseSubcategoryOptions.value;
    if (!options.length) return;
    var isCurrentValid = options.some(function (row) {
      return row.value === annualExpenseForm.subcategory;
    });
    if (!isCurrentValid) {
  ...
  function (options) {
    ...
    if (options.length === 1) {
      annualIncomeForm.owner =
        (_a = singleOwner === null || singleOwner === void 0 ? void 0 : singleOwner.value) !==
          null && _a !== void 0
          ? _a
          : '';
      annualExpenseForm.owner =
        (_b = singleOwner === null || singleOwner === void 0 ? void 0 : singleOwner.value) !==
          null && _b !== void 0
          ? _b
          : '';
      return;
    ...
    if (
      ...
      !options.some(function (option) {
        return option.value === annualIncomeForm.owner;
      })
    ) {
      annualIncomeForm.owner = '';
    }
    if (
      annualExpenseForm.owner &&
      !options.some(function (option) {
        return option.value === annualExpenseForm.owner;
      })
    ) {
      annualExpenseForm.owner = '';
    }
...
var ownershipById = (0, vue_1.computed)(function () {
  ...
  var map = new Map();
  for (
    var _i = 0, _b = (_a = store.ownerships) !== null && _a !== void 0 ? _a : [];
    _i < _b.length;
    _i++
  ) {
    var ownership = _b[_i];
...
var assetsTotalBase = (0, vue_1.computed)(function () {
  ...
  return assetOwnershipFilter.value === 'all'
    ? parseNumeric(
        (_b = (_a = store.summary) === null || _a === void 0 ? void 0 : _a.total_assets) !== null &&
          _b !== void 0
          ? _b
          : '0',
      )
...
var liabilitiesTotalBase = (0, vue_1.computed)(function () {
  ...
  return liabilityOwnershipFilter.value === 'all'
    ? parseNumeric(
        (_b = (_a = store.summary) === null || _a === void 0 ? void 0 : _a.total_liabilities) !==
          null && _b !== void 0
          ? _b
          : '0',
      )
...
var netAssetsBase = (0, vue_1.computed)(function () {
  return assetsTotalBase.value - liabilitiesTotalBase.value;
});
var netAssetsCurrency = (0, vue_1.computed)(function () {
  var _a, _b, _c;
  return (_c =
    (_a = store.baseCurrency) !== null && _a !== void 0
      ? _a
      : (_b = store.summary) === null || _b === void 0
        ? void 0
        : _b.base_currency) !== null && _c !== void 0
    ? _c
    : 'EUR';
});
var incomeCategoryOrder = new Map(
  data_input_1.incomeCategories.map(function (category, index) {
    return [category.value, index];
  }),
);
var expenseCategoryOrder = new Map(
  data_input_1.expenseCategories.map(function (category, index) {
    return [category.value, index];
  }),
);
function incomeCategoryLabel(key) {
  var _a, _b;
  return (_b =
    (_a = data_input_1.incomeCategories.find(function (category) {
...
function incomeSubcategoryLabel(key) {
  var _a, _b;
  return (_b =
    (_a = data_input_1.incomeSubcategories.find(function (subcategory) {
      return subcategory.value === key;
    })) === null || _a === void 0
      ? void 0
      : _a.label) !== null && _b !== void 0
    ? _b
...
function expenseCategoryLabel(key) {
  var _a, _b;
  return (_b =
    (_a = data_input_1.expenseCategories.find(function (category) {
      return category.value === key;
    })) === null || _a === void 0
      ? void 0
      : _a.label) !== null && _b !== void 0
...
function expenseSubcategoryLabel(key) {
  ...
  return (_b =
    (_a = data_input_1.expenseSubcategories.find(function (subcategory) {
      return subcategory.value === key;
    })) === null || _a === void 0
      ? void 0
      : _a.label) !== null && _b !== void 0
...
function formatTermEndLabel(termEndYear, termEndMonth) {
  ...
  if (termEndMonth == null) return 'Fin '.concat(termEndYear);
...
function sumByCurrency(entries) {
  ...
  for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
    ...
    totals[currency] =
      ((_a = totals[currency]) !== null && _a !== void 0 ? _a : 0) + entry.amountAnnual;
  }
  return totals;
}
...
function incomeCategoryPercent(entries) {
  ...
  var categoryTotal = entries.reduce(function (sum, entry) {
    return sum + entry.amountAnnual;
  }, 0);
...
var annualIncomeGroups = (0, vue_1.computed)(function () {
  ...
  return Array.from(categoryMap.entries())
    .sort(function (_a, _b) {
      ...
      var b = _b[0];
      var aOrder =
        (_c = incomeCategoryOrder.get(a)) !== null && _c !== void 0 ? _c : Number.MAX_SAFE_INTEGER;
      var bOrder =
        (_d = incomeCategoryOrder.get(b)) !== null && _d !== void 0 ? _d : Number.MAX_SAFE_INTEGER;
    ...
    .map(function (_a) {
      var category = _a[0],
        entries = _a[1];
      var sortedEntries = entries.slice().sort(function (x, y) {
...
var annualExpenseGroups = (0, vue_1.computed)(function () {
  ...
  return Array.from(categoryMap.entries())
    .sort(function (_a, _b) {
      ...
      var b = _b[0];
      var aOrder =
        (_c = expenseCategoryOrder.get(a)) !== null && _c !== void 0 ? _c : Number.MAX_SAFE_INTEGER;
      var bOrder =
        (_d = expenseCategoryOrder.get(b)) !== null && _d !== void 0 ? _d : Number.MAX_SAFE_INTEGER;
      if (aOrder !== bOrder) return aOrder - bOrder;
...
function openIncomeModal(entry) {
  ...
  if (entry) {
    ...
    annualIncomeForm.amountInputPeriod =
      (_a = entry.amountInputPeriod) !== null && _a !== void 0 ? _a : 'annual';
...
var editingSystemGeneratedLiabilityExpense = (0, vue_1.computed)(function () {
  ...
  var entry = annualExpenseEntries.value.find(function (row) {
    return row.id === editingExpenseId.value;
  });
  return Boolean(
    (entry === null || entry === void 0 ? void 0 : entry.isSystemGenerated) &&
    (entry === null || entry === void 0 ? void 0 : entry.sourceLiabilityId) != null,
  );
});
...
function summarizeGeneratedLiabilityExpenseChanges(beforeEntries, afterEntries) {
  ...
  var toYearTotals = function (rows) {
    ...
    for (var _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
      ...
      totals.set(
        row.fiscalYear,
        ((_a = totals.get(row.fiscalYear)) !== null && _a !== void 0 ? _a : 0) +
          Number((_b = row.amountAnnual) !== null && _b !== void 0 ? _b : 0),
      );
    }
    return totals;
  };
  ...
  var years = Array.from(
    new Set(__spreadArray(__spreadArray([], beforeTotals.keys(), true), afterTotals.keys(), true)),
  ).sort(function (a, b) {
    return a - b;
  });
  var changedYears = [];
  ...
  var addedYears = years.filter(function (year) {
    var _a, _b;
    return (
      ((_a = beforeTotals.get(year)) !== null && _a !== void 0 ? _a : 0) <= 0 &&
      ((_b = afterTotals.get(year)) !== null && _b !== void 0 ? _b : 0) > 0
    );
  });
  var removedYears = years.filter(function (year) {
    var _a, _b;
    return (
      ((_a = beforeTotals.get(year)) !== null && _a !== void 0 ? _a : 0) > 0 &&
      ((_b = afterTotals.get(year)) !== null && _b !== void 0 ? _b : 0) <= 0
...
function openGeneratedExpenseReviewEntryFromVisibleYear() {
  ...
  if (!review) return;
  var entry = annualExpenseEntries.value.find(function (row) {
    return row.sourceLiabilityId === review.liabilityId && row.isSystemGenerated;
  });
  if (!entry) return;
...
function openGeneratedExpenseBulkEdit() {
  var _a;
  var review = generatedLiabilityExpenseReview.value;
  if (!(review === null || review === void 0 ? void 0 : review.entries.length)) return;
  var first = review.entries[0];
  annualExpenseError.value = null;
  hydratingAnnualExpenseForm.value = true;
  editingExpenseId.value = first.id;
  bulkEditingGeneratedLiabilityId.value = review.liabilityId;
  bulkEditingGeneratedExpenseIds.value = review.entries.map(function (entry) {
    return entry.id;
  });
  ...
  annualExpenseForm.amountInputPeriod =
    (_a = first.amountInputPeriod) !== null && _a !== void 0 ? _a : 'annual';
  annualExpenseForm.amountAnnual = amountInputValueFromAnnual(
    first.amountAnnual,
    annualExpenseForm.amountInputPeriod,
  );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!createdLiability) return [2 /*return*/];
        ...
        case 3:
          ...
          systemGeneratedEntries = generatedEntries
            .filter(function (entry) {
              return entry.isSystemGenerated && entry.sourceLiabilityId === createdLiability.id;
            })
            .sort(function (a, b) {
              return a.fiscalYear - b.fiscalYear;
            });
          if (!systemGeneratedEntries.length) return [2 /*return*/];
          generatedLiabilityExpenseReviewChangeMessage.value = null;
        ...
        case 4:
          ...
          annualExpenseError.value =
            'Pasivo creado, pero no se pudo cargar el gasto generado: '.concat(
              (0, errors_1.toApiErrorMessage)(e_1),
            );
          return [3 /*break*/, 5];
        case 5:
          return [2 /*return*/];
      ...
      switch (_c.label) {
        ...
        case 4:
          ...
          systemGeneratedEntries = refreshedEntries
            .filter(function (entry) {
              return entry.isSystemGenerated && entry.sourceLiabilityId === id;
            })
            .sort(function (a, b) {
              return a.fiscalYear - b.fiscalYear;
            });
          ...
          liabilityName =
            (_b =
              (_a = store.liabilities.find(function (item) {
                return item.id === id;
              })) === null || _a === void 0
                ? void 0
              ...
              ? _b
              : 'Pasivo';
          generatedLiabilityExpenseReviewChangeMessage.value =
            summarizeGeneratedLiabilityExpenseChanges(
              beforeEntries.filter(function (entry) {
                return entry.isSystemGenerated && entry.sourceLiabilityId === id;
              }),
              systemGeneratedEntries,
            );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!current || !editKind.value) return [2 /*return*/];
        ...
        case 2:
          ...
          return [2 /*return*/];
        case 3:
          return [4 /*yield*/, updateLiabilityAndShowExpenseReview(current.id, payload)];
        case 4:
          _a.sent();
          closeEdit();
          return [2 /*return*/];
...
function estimateRemuneratedLiquidityInterest(payload) {
  ...
  if (category === 'cash' && subcategory === 'short_term_deposit') {
    ...
    var depositTermMonths = Number(
      (_c = payload.deposit_term_months) !== null && _c !== void 0 ? _c : 0,
    );
    if (
...
function findLikelyCreatedAsset(payload, previousAssetIds) {
  ...
  var targetSubcategory = String(
    (_c = payload.subcategory) !== null && _c !== void 0 ? _c : '',
  ).trim();
  var targetCurrency = String((_d = payload.currency) !== null && _d !== void 0 ? _d : '')
    .trim()
    .toUpperCase();
  var targetStartDate = String(
    (_e = payload.start_date) !== null && _e !== void 0 ? _e : '',
  ).trim();
  var targetAmount = normalizeAmountForMatch(payload.amount);
  var candidates = store.assets
    .filter(function (asset) {
      return !previousAssetIds.has(asset.id);
    })
    .filter(function (asset) {
      var _a;
      return String((_a = asset.name) !== null && _a !== void 0 ? _a : '').trim() === targetName;
    })
    .filter(function (asset) {
      var _a;
      return (
        String((_a = asset.category) !== null && _a !== void 0 ? _a : '').trim() === targetCategory
      );
    })
    .filter(function (asset) {
      var _a;
      return (
        String((_a = asset.subcategory) !== null && _a !== void 0 ? _a : '').trim() ===
        targetSubcategory
      );
    })
    .filter(function (asset) {
      var _a;
      return (
        String((_a = asset.currency) !== null && _a !== void 0 ? _a : '')
          .trim()
    ...
    .filter(function (asset) {
      var _a;
      return (
        String((_a = asset.start_date) !== null && _a !== void 0 ? _a : '').trim() ===
        targetStartDate
      );
    })
    .filter(function (asset) {
      return normalizeAmountForMatch(asset.amount) === targetAmount;
    })
    .sort(function (a, b) {
      return b.id - a.id;
    });
...
function submitAsset(payload) {
  return __awaiter(this, void 0, void 0, function () {
    var previousAssetIds,
      createdAsset,
      createdOrMatchedAsset,
      estimatedAnnualInterestGross,
      currency,
      assetName,
      estimatedAnnualInterestNet,
      estimatedWithholdingAmount,
      ownerLabel,
      result;
    var _a, _b;
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          previousAssetIds = new Set(
            store.assets.map(function (asset) {
              return asset.id;
            }),
          );
        ...
        case 1:
          ...
          createdOrMatchedAsset =
            createdAsset !== null && createdAsset !== void 0
              ? createdAsset
              : findLikelyCreatedAsset(payload, previousAssetIds);
          if (!createdOrMatchedAsset) return [2 /*return*/];
          showAssetModal.value = false;
          return [4 /*yield*/, loadAnnualExpense(fiscalYear.value)];
        case 2:
          _c.sent();
          if (!isRemuneratedLiquidityAsset(payload)) return [2 /*return*/];
          estimatedAnnualInterestGross = estimateRemuneratedLiquidityInterest(payload);
          currency =
            String((_a = payload.currency) !== null && _a !== void 0 ? _a : '')
              .trim()
              .toUpperCase() || 'EUR';
          assetName =
            String((_b = createdOrMatchedAsset.name) !== null && _b !== void 0 ? _b : '').trim() ||
            'Activo remunerado';
          ...
          if (!(estimatedAnnualInterestNet > 0)) return [2 /*return*/];
          estimatedWithholdingAmount = roundToCents(
            ...
            addIncomeEntry(
              {
                ...
                currency: currency,
                notes: 'Generado automaticamente desde activo de liquidez remunerado ('
                  .concat(assetName, '). Interes bruto estimado: ')
                  .concat(estimatedAnnualInterestGross.toFixed(2), ' ')
                  .concat(currency, '. Retencion estimada (19%): ')
                  .concat(estimatedWithholdingAmount.toFixed(2), ' ')
                  .concat(currency, '. Interes neto estimado: ')
                  .concat(estimatedAnnualInterestNet.toFixed(2), ' ')
                  .concat(currency, '.'),
              },
              fiscalYear.value,
            ),
        ...
        case 3:
          result = _c.sent();
          if (!result.ok) {
            annualIncomeError.value =
              'Activo creado, pero no se pudo generar el ingreso anual estimado: '.concat(
                result.error,
              );
          }
          return [2 /*return*/];
...
function deleteAssetAndReloadExpenses(id) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, store.deleteAsset(id)];
        case 1:
          _a.sent();
          return [4 /*yield*/, loadAnnualExpense(fiscalYear.value)];
        case 2:
...
function deleteLiabilityAndReloadExpenses(id) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, store.deleteLiability(id)];
        case 1:
          _b.sent();
          return [4 /*yield*/, loadAnnualExpense(fiscalYear.value)];
        case 2:
          _b.sent();
          if (
            ((_a = generatedLiabilityExpenseReview.value) === null || _a === void 0
              ? void 0
              : _a.liabilityId) === id
          ) {
            closeGeneratedLiabilityExpenseModal();
...
(0, vue_1.watch)(
  function () {
    return annualIncomeForm.isRecurrent;
  },
...
(0, vue_1.watch)(
  function () {
    return annualExpenseForm.isRecurrent;
  },
  function (isRecurrent) {
...
(0, vue_1.watch)(
  function () {
    return annualIncomeForm.timeProfile;
  },
...
(0, vue_1.watch)(
  function () {
    return annualExpenseForm.timeProfile;
  },
  function (timeProfile) {
...
(0, vue_1.watch)(
  [
    ...
    function () {
      return annualExpenseForm.subcategory;
    },
  ],
  function () {
      ...
      switch (_b.label) {
        case 0:
          ...
          draft = {
            ...
            targetMonth:
              annualIncomeForm.timeProfile === 'one_off' &&
              String(annualIncomeForm.targetMonth).trim()
        ...
        case 1:
          ...
          return [3 /*break*/, 4];
        case 2:
          return [4 /*yield*/, updateIncomeEntry(editingIncomeId.value, draft, fiscalYear.value)];
        case 3:
          _a = _b.sent();
          _b.label = 4;
        case 4:
...
function removeAnnualIncome(id) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, deleteIncomeEntry(id, fiscalYear.value)];
        case 1:
          _a.sent();
          return [2 /*return*/];
      }
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          draft = {
            ...
            targetMonth:
              ...
              String(annualExpenseForm.targetMonth).trim()
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            api_1.coreApi.patch('/api/budget/annual-expense/'.concat(id, '/'), {
              name: draft.name,
        ...
        case 6:
          ...
          if (
            !(
              ((_c = generatedLiabilityExpenseReview.value) === null || _c === void 0
                ? void 0
                : _c.liabilityId) === bulkEditingGeneratedLiabilityId.value
            )
          )
            return [3 /*break*/, 8];
          return [
            4 /*yield*/,
            listBySourceLiability(generatedLiabilityExpenseReview.value.liabilityId),
          ];
        case 7:
        ...
        case 11:
          ...
          return [3 /*break*/, 14];
        case 12:
          return [4 /*yield*/, updateExpenseEntry(editingExpenseId.value, draft, fiscalYear.value)];
        case 13:
          _b = _d.sent();
          _d.label = 14;
        case 14:
...
function removeAnnualExpense(id) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, deleteExpenseEntry(id, fiscalYear.value)];
        case 1:
          _a.sent();
          return [2 /*return*/];
      }
...
function ensurePortableDataAppVersion() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (portableDataAppVersion.value) return [2 /*return*/, portableDataAppVersion.value];
      ...
      switch (_s.label) {
        ...
        case 3:
          ...
          payload = {
            ...
            data: {
              annual_income: ((_c = incomeRes.data) !== null && _c !== void 0 ? _c : []).map(
                portableBundle_1.toPortableAnnualIncomeRecord,
              ),
              annual_expense: ((_d = expenseRes.data) !== null && _d !== void 0 ? _d : []).map(
                portableBundle_1.toPortableAnnualExpenseRecord,
              ),
              assets: ((_e = assetsRes.data) !== null && _e !== void 0 ? _e : []).map(
                function (row) {
                  return (0, portableBundle_1.toPortableAssetRecord)(row);
                },
              ),
              liabilities: ((_f = liabilitiesRes.data) !== null && _f !== void 0 ? _f : []).map(
                function (row) {
                  return (0, portableBundle_1.toPortableLiabilityRecord)(row);
                },
              ),
            ...
            premium: {
              ...
              ownerships: ((_j = ownershipsRes.data) !== null && _j !== void 0 ? _j : []).map(
                function (row) {
                  return (0, portableBundle_1.toPortableOwnershipRecord)(row);
                },
              ),
          ...
          dataTransferStatus.value = 'Exportacion completada: '
            .concat(payload.data.annual_income.length, ' ingresos, ')
            .concat(payload.data.annual_expense.length, ' gastos, ')
            .concat(payload.data.assets.length, ' activos, ')
            .concat(payload.data.liabilities.length, ' pasivos, ')
            .concat(
              (_m =
                (_l = payload.data.snapshots) === null || _l === void 0 ? void 0 : _l.length) !==
                null && _m !== void 0
                ? _m
                : 0,
              ' snapshots, ',
            ...
            .concat(
              (_p =
                (_o = payload.premium) === null || _o === void 0
                  ? void 0
                  : _o.family_members.length) !== null && _p !== void 0
                ? _p
                : 0,
              ' miembros y ',
            )
            .concat(
              (_r =
                (_q = payload.premium) === null || _q === void 0
                  ? void 0
                  : _q.ownerships.length) !== null && _r !== void 0
                ? _r
                : 0,
              ' titularidades.',
            );
        ...
        case 4:
          e_3 = _s.sent();
          dataTransferError.value = 'No se pudo exportar: '.concat(
            (0, errors_1.toApiErrorMessage)(e_3),
          );
          return [3 /*break*/, 6];
        case 5:
...
function buildImportCompletionStatus(params) {
  var importMode = params.importMode,
    response = params.response;
  var counts = response.counts;
  return importMode === 'replace'
    ? 'Reemplazo completado: '
        .concat(counts.annual_income, ' ingresos, ')
        .concat(counts.annual_expense, ' gastos, ')
        .concat(counts.assets, ' activos, ')
        .concat(counts.liabilities, ' pasivos, ')
        .concat(counts.snapshots, ' snapshots, ')
        .concat(counts.family_members, ' miembros, ')
        .concat(counts.ownerships, ' titularidades y ')
        .concat(counts.ownership_links, ' enlaces de titularidad.')
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          input = event.target;
          file =
            (_a = input === null || input === void 0 ? void 0 : input.files) === null ||
            _a === void 0
              ? void 0
              : _a[0];
        ...
        case 3:
          ...
          proceed = window.confirm(
            (0, portableBundle_1.buildImportPreviewMessage)(bundle, importMode, appVersion),
          );
          if (!proceed) return [2 /*return*/];
          setDataImportBusyState(importMode);
          return [
            4 /*yield*/,
            api_1.coreApi.post('/api/core/portable-data/import/', {
              mode: importMode,
              bundle: bundle,
            }),
          ];
        ...
        case 6:
          e_4 = _b.sent();
          dataTransferError.value = 'No se pudo importar: '.concat(
            (0, errors_1.toApiErrorMessage)(e_4),
          );
          return [3 /*break*/, 8];
        case 7:
          dataTransferBusy.value = false;
...
/** @type {__VLS_StyleScopedClasses['container']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-page']} */ __VLS_asFunctionalElement1(
  ...
  __VLS_intrinsics.section,
)(__assign({ class: 'card ui-pro-panel grid gap-2.5' }));
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-2.5']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.p,
  __VLS_intrinsics.p,
...
/** @type {__VLS_StyleScopedClasses['ui-pro-kicker']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.h1,
  __VLS_intrinsics.h1,
)(__assign({ class: 'h1 m-0' }));
/** @type {__VLS_StyleScopedClasses['h1']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_ctx.dataInputCheckTitle;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.p,
  __VLS_intrinsics.p,
)(__assign({ class: 'subtle m-0' }));
/** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_ctx.dataInputSummary;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.p,
  __VLS_intrinsics.p,
)(__assign({ class: 'subtle m-0' }));
/** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'actions m-0' }));
/** @type {__VLS_StyleScopedClasses['actions']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.button,
  __VLS_intrinsics.button,
)(
  __assign(__assign({ onClick: __VLS_ctx.exportDataBundle }, { class: 'btn btn-ghost' }), {
    type: 'button',
    disabled: __VLS_ctx.dataTransferUiBusy,
  }),
);
/** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ __VLS_asFunctionalElement1(
  ...
  __assign(
    ...
    { type: 'button', disabled: __VLS_ctx.dataTransferUiBusy },
  ),
);
...
/** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ __VLS_asFunctionalElement1(
  ...
  __assign(
    __assign(
      { onChange: __VLS_ctx.importDataFromFile },
      { ref: 'importFileInputRef', type: 'file', accept: 'application/json,.json' },
    ),
    { class: 'sr-only' },
  ),
);
/** @type {__VLS_StyleScopedClasses['sr-only']} */ if (__VLS_ctx.dataTransferStatus) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'subtle m-0' }));
  /** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_ctx.dataTransferStatus;
}
if (__VLS_ctx.dataTransferError) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'alert m-0' }));
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['m-0']} */ __VLS_ctx.dataTransferError;
}
var __VLS_0;
...
if (__VLS_ctx.dataTransferToastMessage) {
  __VLS_asFunctionalElement1(
    ...
    __assign(
      __assign(
        {
          class:
            'fixed right-4 top-4 z-[80] max-w-[min(92vw,560px)] rounded-xl px-4 py-3 text-sm shadow-2xl backdrop-blur',
        },
        {
          class:
            __VLS_ctx.dataTransferToastKind === 'error'
  ...
  /** @type {__VLS_StyleScopedClasses['fixed']} */ /** @type {__VLS_StyleScopedClasses['right-4']} */ /** @type {__VLS_StyleScopedClasses['top-4']} */ /** @type {__VLS_StyleScopedClasses['z-[80]']} */ /** @type {__VLS_StyleScopedClasses['max-w-[min(92vw,560px)]']} */ /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ /** @type {__VLS_StyleScopedClasses['px-4']} */ /** @type {__VLS_StyleScopedClasses['py-3']} */ /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['shadow-2xl']} */ /** @type {__VLS_StyleScopedClasses['backdrop-blur']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'flex items-start gap-2.5' }));
  /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['items-start']} */ /** @type {__VLS_StyleScopedClasses['gap-2.5']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
  )(
    __assign(
      { class: 'mt-0.5 inline-block h-2.5 w-2.5 rounded-full' },
      { class: __VLS_ctx.dataTransferToastKind === 'error' ? 'bg-rose-300' : 'bg-emerald-300' },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['mt-0.5']} */ /** @type {__VLS_StyleScopedClasses['inline-block']} */ /** @type {__VLS_StyleScopedClasses['h-2.5']} */ /** @type {__VLS_StyleScopedClasses['w-2.5']} */ /** @type {__VLS_StyleScopedClasses['rounded-full']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )({});
...
if (__VLS_ctx.dataTransferBusy) {
  __VLS_asFunctionalElement1(
    ...
    __assign(
      {
        class:
          'fixed inset-0 z-[70] flex items-center justify-center bg-black/45 px-4 backdrop-blur-[2px]',
      },
      { role: 'status', 'aria-live': 'polite', 'aria-busy': 'true' },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['fixed']} */ /** @type {__VLS_StyleScopedClasses['inset-0']} */ /** @type {__VLS_StyleScopedClasses['z-[70]']} */ /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['items-center']} */ /** @type {__VLS_StyleScopedClasses['justify-center']} */ /** @type {__VLS_StyleScopedClasses['bg-black/45']} */ /** @type {__VLS_StyleScopedClasses['px-4']} */ /** @type {__VLS_StyleScopedClasses['backdrop-blur-[2px]']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(
    __assign({
      class: 'w-full max-w-md rounded-2xl border border-white/15 bg-[#111827f2] p-4 shadow-2xl',
    }),
  );
  /** @type {__VLS_StyleScopedClasses['w-full']} */ /** @type {__VLS_StyleScopedClasses['max-w-md']} */ /** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ /** @type {__VLS_StyleScopedClasses['border']} */ /** @type {__VLS_StyleScopedClasses['border-white/15']} */ /** @type {__VLS_StyleScopedClasses['bg-[#111827f2]']} */ /** @type {__VLS_StyleScopedClasses['p-4']} */ /** @type {__VLS_StyleScopedClasses['shadow-2xl']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'flex items-center gap-3' }));
  /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['items-center']} */ /** @type {__VLS_StyleScopedClasses['gap-3']} */ __VLS_asFunctionalElement1(
    ...
    __assign(
      {
        class:
          'inline-block h-5 w-5 animate-spin rounded-full border-2 border-white/30 border-t-teal-300',
      },
      { 'aria-hidden': 'true' },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['inline-block']} */ /** @type {__VLS_StyleScopedClasses['h-5']} */ /** @type {__VLS_StyleScopedClasses['w-5']} */ /** @type {__VLS_StyleScopedClasses['animate-spin']} */ /** @type {__VLS_StyleScopedClasses['rounded-full']} */ /** @type {__VLS_StyleScopedClasses['border-2']} */ /** @type {__VLS_StyleScopedClasses['border-white/30']} */ /** @type {__VLS_StyleScopedClasses['border-t-teal-300']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )({});
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'm-0 text-sm font-medium text-white' }));
  /** @type {__VLS_StyleScopedClasses['m-0']} */ /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['font-medium']} */ /** @type {__VLS_StyleScopedClasses['text-white']} */ (
    _a = __VLS_ctx.dataTransferBusyLabel
  ) !== null && _a !== void 0
    ? _a
    : 'Procesando datos...';
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'm-0 text-xs text-white/65' }));
...
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'grid-2' }));
/** @type {__VLS_StyleScopedClasses['grid-2']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.section,
  __VLS_intrinsics.section,
)(__assign({ class: 'section ui-flow-air md:col-span-2' }));
/** @type {__VLS_StyleScopedClasses['section']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air']} */ /** @type {__VLS_StyleScopedClasses['md:col-span-2']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header ui-flow-air-header' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-header']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header-left ui-flow-air-left' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header-left']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-left']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.h2,
  __VLS_intrinsics.h2,
)(__assign({ class: 'ui-flow-air-title' }));
/** @type {__VLS_StyleScopedClasses['ui-flow-air-title']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-flow-air-meta' }));
/** @type {__VLS_StyleScopedClasses['ui-flow-air-meta']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
  __VLS_intrinsics.span,
)(__assign({ class: 'ui-flow-air-subtitle' }));
/** @type {__VLS_StyleScopedClasses['ui-flow-air-subtitle']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.select,
  __VLS_intrinsics.select,
)(
  __assign(
    __assign(
      { id: 'fiscal-year-income-expense', value: __VLS_ctx.fiscalYear },
      { class: 'select nw-select-sm ui-flow-air-year-select' },
    ),
    { 'aria-label': 'Ejercicio' },
  ),
);
/** @type {__VLS_StyleScopedClasses['select']} */ /** @type {__VLS_StyleScopedClasses['nw-select-sm']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-year-select']} */ for (
  var _i = 0, _13 = __VLS_vFor(__VLS_ctx.fiscalYearOptions);
  _i < _13.length;
  _i++
) {
  var year = _13[_i][0];
...
__VLS_asFunctionalElement1(
  ...
  __assign(
    __assign(
      { id: 'visibility-filter-mode', value: __VLS_ctx.visibilityFilterMode },
      { class: 'select nw-select-sm ui-flow-air-year-select' },
    ),
    { 'aria-label': 'Filtro de visibilidad' },
  ),
);
/** @type {__VLS_StyleScopedClasses['select']} */ /** @type {__VLS_StyleScopedClasses['nw-select-sm']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-year-select']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.option,
  __VLS_intrinsics.option,
)({
  value: 'active',
...
__VLS_asFunctionalElement1(
  ...
  __assign(
    __assign(
      { id: 'ownership-filter-mode', value: __VLS_ctx.globalOwnershipFilter },
      { class: 'select nw-select-sm ui-flow-air-year-select' },
    ),
...
for (
  var _14 = 0, _15 = __VLS_vFor(__VLS_ctx.globalOwnershipFilterOptions);
  _14 < _15.length;
  _14++
) {
...
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header-right ui-flow-air-right' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header-right']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-right']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-total-inline ui-flow-air-total' }));
/** @type {__VLS_StyleScopedClasses['nw-list-total-inline']} */ /** @type {__VLS_StyleScopedClasses['ui-flow-air-total']} */ __VLS_ctx.formatMoneyAmount(
  __VLS_ctx.annualBalanceTotal,
  'EUR',
);
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
...
/** @type {__VLS_StyleScopedClasses['nw-list-total-details']} */ __VLS_ctx.fiscalYear;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.article,
  __VLS_intrinsics.article,
)(__assign({ class: 'card ui-pro-panel' }));
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
...
/** @type {__VLS_StyleScopedClasses['card-header-title']} */ /** @type {__VLS_StyleScopedClasses['mt-0']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
...
/** @type {__VLS_StyleScopedClasses['nw-list-total-inline']} */ __VLS_ctx.formatMoneyAmount(
  __VLS_ctx.filteredAnnualIncomeTotal,
  'EUR',
);
__VLS_asFunctionalElement1(
  __VLS_intrinsics.button,
  ...
  __assign(
    __assign(
      {
        onClick: function () {
          return __VLS_ctx.openIncomeModal();
        },
      },
      { class: 'btn btn-primary btn-sm nw-list-add-icon-only' },
    ),
    { type: 'button', 'aria-label': 'Anadir ingreso', disabled: __VLS_ctx.annualIncomeLoading },
  ),
);
...
/** @type {__VLS_StyleScopedClasses['btn-icon']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
...
/** @type {__VLS_StyleScopedClasses['nw-list-total-details']} */ if (__VLS_ctx.annualIncomeError) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'alert mt-3' }));
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.annualIncomeError;
} else if (__VLS_ctx.annualIncomeApiError) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'alert mt-3' }));
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.annualIncomeApiError;
}
if (!__VLS_ctx.annualIncomeEntries.length && !__VLS_ctx.annualIncomeLoading) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'subtle mt-3' }));
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'mt-3 grid gap-4' }));
  /** @type {__VLS_StyleScopedClasses['mt-3']} */ /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-4']} */ var _loop_1 =
    function (group) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.section,
        __VLS_intrinsics.section,
      )(
        __assign(__assign({ key: group.category }, { class: 'nw-cat-block' }), {
          class: __VLS_ctx.incomeCategoryClass(group.category),
        }),
      );
      /** @type {__VLS_StyleScopedClasses['nw-cat-block']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'nw-cat-header' }));
      /** @type {__VLS_StyleScopedClasses['nw-cat-header']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'nw-cat-left' }));
      /** @type {__VLS_StyleScopedClasses['nw-cat-left']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )({});
      group.label;
      ...
      /** @type {__VLS_StyleScopedClasses['badge']} */ group.entries.length;
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'nw-cat-right' }));
      /** @type {__VLS_StyleScopedClasses['nw-cat-right']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'nw-cat-total' }));
      /** @type {__VLS_StyleScopedClasses['nw-cat-total']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'nw-cat-total-primary' }));
      /** @type {__VLS_StyleScopedClasses['nw-cat-total-primary']} */ __VLS_ctx.formatTotalsLine(
        group.totals,
      );
      if (__VLS_ctx.incomeCategoryPercent(group.entries)) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
        )(__assign({ class: 'nw-cat-percent' }));
        /** @type {__VLS_StyleScopedClasses['nw-cat-percent']} */ __VLS_ctx.incomeCategoryPercent(
          group.entries,
        );
      }
      __VLS_asFunctionalElement1(
        ...
        __assign(
          __assign(
            {
              onClick: function () {
                ...
                if (
                  !!(
                    !__VLS_ctx.filteredAnnualIncomeEntries.length && !__VLS_ctx.annualIncomeLoading
                  )
                )
                  return;
                ...
                [
                  ...
                  annualIncomeApiError,
                  annualIncomeEntries,
                  filteredAnnualIncomeEntries,
                  annualIncomeGroups,
                  incomeCategoryClass,
                  formatTotalsLine,
                  incomeCategoryPercent,
                  incomeCategoryPercent,
          ...
          {
            type: 'button',
            'aria-label': __VLS_ctx.isIncomeGroupExpanded(group.category)
              ? 'Ocultar desglose'
              : 'Mostrar desglose',
            title: __VLS_ctx.isIncomeGroupExpanded(group.category)
              ? 'Ocultar desglose'
              : 'Mostrar desglose',
          },
        ),
      ...
      /** @type {__VLS_StyleScopedClasses['icon-btn']} */ /** @type {__VLS_StyleScopedClasses['nw-cat-toggle']} */ if (
        __VLS_ctx.isIncomeGroupExpanded(group.category)
      ) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
      ...
      if (__VLS_ctx.isIncomeGroupExpanded(group.category)) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'subcat-list' }));
        /** @type {__VLS_StyleScopedClasses['subcat-list']} */ for (
          var _22 = 0, _23 = __VLS_vFor(group.subgroups);
          _22 < _23.length;
          _22++
        ) {
          ...
          __VLS_asFunctionalElement1(
            ...
            __assign(
              { key: ''.concat(group.category, ':').concat(subgroup.subcategory) },
              { class: 'nw-subcat-block' },
            ),
          );
          /** @type {__VLS_StyleScopedClasses['nw-subcat-block']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'nw-subcat-header' }));
          /** @type {__VLS_StyleScopedClasses['nw-subcat-header']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'nw-subcat-title' }));
          /** @type {__VLS_StyleScopedClasses['nw-subcat-title']} */ subgroup.label;
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'nw-subcat-total' }));
          /** @type {__VLS_StyleScopedClasses['nw-subcat-total']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'nw-subcat-total-primary' }));
          /** @type {__VLS_StyleScopedClasses['nw-subcat-total-primary']} */ __VLS_ctx.formatTotalsLine(
            subgroup.totals,
          );
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'nw-subcat-actions-spacer' }, { 'aria-hidden': 'true' }));
          /** @type {__VLS_StyleScopedClasses['nw-subcat-actions-spacer']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.ul,
            __VLS_intrinsics.ul,
          )(__assign({ class: 'list list-plain nw-subcat-items' }));
          /** @type {__VLS_StyleScopedClasses['list']} */ /** @type {__VLS_StyleScopedClasses['list-plain']} */ /** @type {__VLS_StyleScopedClasses['nw-subcat-items']} */ var _loop_3 =
            function (entry) {
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.li,
                __VLS_intrinsics.li,
              ...
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-row income-item-row' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-row']} */ /** @type {__VLS_StyleScopedClasses['income-item-row']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-main' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-main']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-name income-item-name' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-name']} */ /** @type {__VLS_StyleScopedClasses['income-item-name']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.span,
                __VLS_intrinsics.span,
              )(
                __assign(
                  __assign(
                    ...
                    { class: __VLS_ctx.timeProfileDotClass(entry.timeProfile) },
                  ),
                  { 'aria-hidden': 'true' },
                ),
              );
              /** @type {__VLS_StyleScopedClasses['income-rec-dot']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.span,
                __VLS_intrinsics.span,
              )(__assign({ class: 'item-name-text' }));
              /** @type {__VLS_StyleScopedClasses['item-name-text']} */ entry.name;
              if (entry.owner) {
                __VLS_asFunctionalElement1(
                  __VLS_intrinsics.span,
                  __VLS_intrinsics.span,
                )(__assign({ class: 'badge' }));
                /** @type {__VLS_StyleScopedClasses['badge']} */ entry.owner;
              }
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-submeta' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-submeta']} */ __VLS_ctx.timeProfileLabel(
                entry.timeProfile,
              );
              if (entry.eventGroup) {
              ...
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-amount' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-amount']} */ __VLS_ctx.formatMoneyAmount(
                entry.amountAnnual,
                entry.currency,
              );
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.div,
                __VLS_intrinsics.div,
              )(__assign({ class: 'nw-item-actions' }));
              /** @type {__VLS_StyleScopedClasses['nw-item-actions']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.button,
                __VLS_intrinsics.button,
              )(
                __assign(
                  __assign(
                    {
                      onClick: function () {
                        return __VLS_ctx.openIncomeModal(entry);
                      },
                    },
                    { class: 'icon-btn' },
                  ),
                  { title: 'Editar', disabled: __VLS_ctx.annualIncomeLoading },
                ),
              );
              /** @type {__VLS_StyleScopedClasses['icon-btn']} */ __VLS_asFunctionalElement1(
                ...
                __assign(
                  __assign(
                    {
                      onClick: function () {
                        ...
                        if (
                          !!(
                            !__VLS_ctx.annualIncomeEntries.length && !__VLS_ctx.annualIncomeLoading
                          )
                        )
                          return;
                        if (
                          !!(
                            !__VLS_ctx.filteredAnnualIncomeEntries.length &&
                            !__VLS_ctx.annualIncomeLoading
                          )
                        )
                          return;
                        if (!__VLS_ctx.isIncomeGroupExpanded(group.category)) return;
                  ...
                  { title: 'Eliminar', disabled: __VLS_ctx.annualIncomeLoading },
                ),
              );
...
if (__VLS_ctx.annualIncomeLoading) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-status-line mt-2' }));
...
/** @type {__VLS_StyleScopedClasses['nw-list-total-inline']} */ __VLS_ctx.formatMoneyAmount(
  __VLS_ctx.filteredAnnualExpenseTotal,
  'EUR',
);
__VLS_asFunctionalElement1(
  __VLS_intrinsics.button,
  ...
  __assign(
    __assign(
      {
        onClick: function () {
          return __VLS_ctx.openExpenseModal();
        },
      },
      { class: 'btn btn-primary btn-sm nw-list-add-icon-only' },
    ),
    { type: 'button', 'aria-label': 'Anadir salida', disabled: __VLS_ctx.annualExpenseLoading },
  ),
);
/** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-primary']} */ /** @type {__VLS_StyleScopedClasses['btn-sm']} */ /** @type {__VLS_StyleScopedClasses['nw-list-add-icon-only']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
...
/** @type {__VLS_StyleScopedClasses['nw-list-total-details']} */ if (__VLS_ctx.annualExpenseError) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'alert mt-3' }));
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.annualExpenseError;
} else if (__VLS_ctx.annualExpenseApiError) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'alert mt-3' }));
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.annualExpenseApiError;
}
if (!__VLS_ctx.annualExpenseEntries.length && !__VLS_ctx.annualExpenseLoading) {
  ...
  /** @type {__VLS_StyleScopedClasses['mt-3']} */ /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-4']} */ var _loop_2 =
    function (group) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.section,
        __VLS_intrinsics.section,
        ...
        __assign(__assign({ key: group.category }, { class: 'nw-cat-block' }), {
          class: __VLS_ctx.expenseCategoryClass(group.category),
        }),
      );
      /** @type {__VLS_StyleScopedClasses['nw-cat-block']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
      ...
      if (__VLS_ctx.expenseCategoryPercent(group.entries)) {
        ...
        /** @type {__VLS_StyleScopedClasses['nw-cat-percent']} */ __VLS_ctx.expenseCategoryPercent(
          group.entries,
        );
      }
      __VLS_asFunctionalElement1(
        ...
        __assign(
          __assign(
            {
              onClick: function () {
                ...
                if (
                  !!(
                    !__VLS_ctx.filteredAnnualExpenseEntries.length &&
                    !__VLS_ctx.annualExpenseLoading
                  )
                )
                  return;
          ...
          {
            type: 'button',
            'aria-label': __VLS_ctx.isExpenseGroupExpanded(group.category)
              ? 'Ocultar desglose'
              : 'Mostrar desglose',
            title: __VLS_ctx.isExpenseGroupExpanded(group.category)
              ? 'Ocultar desglose'
              : 'Mostrar desglose',
          },
        ),
      ...
      /** @type {__VLS_StyleScopedClasses['icon-btn']} */ /** @type {__VLS_StyleScopedClasses['nw-cat-toggle']} */ if (
        __VLS_ctx.isExpenseGroupExpanded(group.category)
      ) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
      ...
      if (__VLS_ctx.isExpenseGroupExpanded(group.category)) {
        ...
        /** @type {__VLS_StyleScopedClasses['subcat-list']} */ for (
          var _26 = 0, _27 = __VLS_vFor(group.subgroups);
          _26 < _27.length;
          _26++
        ) {
          ...
          /** @type {__VLS_StyleScopedClasses['list']} */ /** @type {__VLS_StyleScopedClasses['list-plain']} */ /** @type {__VLS_StyleScopedClasses['nw-subcat-items']} */ var _loop_4 =
            function (entry) {
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.li,
                __VLS_intrinsics.li,
              ...
              if (
                !__VLS_ctx.shouldHideExpenseCashflowRoleLabel({
                  timeProfile: entry.timeProfile,
                  cashflowRole: entry.cashflowRole,
                })
              ) {
              ...
              /** @type {__VLS_StyleScopedClasses['nw-item-actions']} */ __VLS_asFunctionalElement1(
                ...
                __assign(
                  __assign(
                    {
                      onClick: function () {
                        return __VLS_ctx.openExpenseModal(entry);
                      },
                    },
                    { class: 'icon-btn' },
                  ),
                  { title: 'Editar', disabled: __VLS_ctx.annualExpenseLoading },
                ),
              );
              /** @type {__VLS_StyleScopedClasses['icon-btn']} */ __VLS_asFunctionalElement1(
                __VLS_intrinsics.button,
                ...
                __assign(
                  __assign(
                    {
                      onClick: function () {
                        ...
                        if (
                          !!(
                            !__VLS_ctx.annualExpenseEntries.length &&
                            !__VLS_ctx.annualExpenseLoading
                          )
                        )
                          return;
                        if (
                          ...
                          return;
                        if (!__VLS_ctx.isExpenseGroupExpanded(group.category)) return;
                  ...
                  { title: 'Eliminar', disabled: __VLS_ctx.annualExpenseLoading },
                ),
              );
              /** @type {__VLS_StyleScopedClasses['icon-btn']} */ // @ts-ignore
              [annualExpenseLoading];
...
if (__VLS_ctx.store.error) {
  ...
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.prettyError();
}
__VLS_asFunctionalElement1(
  __VLS_intrinsics.section,
  __VLS_intrinsics.section,
)(__assign({ class: 'section ui-balance-air' }));
/** @type {__VLS_StyleScopedClasses['section']} */ /** @type {__VLS_StyleScopedClasses['ui-balance-air']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header ui-balance-air-header' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header']} */ /** @type {__VLS_StyleScopedClasses['ui-balance-air-header']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header-left ui-balance-air-left' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header-left']} */ /** @type {__VLS_StyleScopedClasses['ui-balance-air-left']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.h2,
  __VLS_intrinsics.h2,
)(__assign({ class: 'ui-balance-air-title' }));
/** @type {__VLS_StyleScopedClasses['ui-balance-air-title']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
  __VLS_intrinsics.span,
)(__assign({ class: 'ui-balance-air-subtitle' }));
/** @type {__VLS_StyleScopedClasses['ui-balance-air-subtitle']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-header-right ui-balance-air-right' }));
/** @type {__VLS_StyleScopedClasses['nw-list-header-right']} */ /** @type {__VLS_StyleScopedClasses['ui-balance-air-right']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-total-inline ui-balance-air-total' }));
/** @type {__VLS_StyleScopedClasses['nw-list-total-inline']} */ /** @type {__VLS_StyleScopedClasses['ui-balance-air-total']} */ __VLS_ctx.formatMoneyAmount(
  __VLS_ctx.netAssetsBase,
  __VLS_ctx.netAssetsCurrency,
);
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'nw-list-total-details' }));
/** @type {__VLS_StyleScopedClasses['nw-list-total-details']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'grid-2' }));
/** @type {__VLS_StyleScopedClasses['grid-2']} */ var __VLS_6;
...
var __VLS_7 = __VLS_asFunctionalComponent1(
  ...
  new __VLS_6(
    __assign(
      __assign(
        {
          ownershipFilterValue: __VLS_ctx.assetOwnershipFilter,
          title: 'Activos',
          items: __VLS_ctx.visibleAssets,
          showArchived: __VLS_ctx.visibilityFilterMode !== 'active',
          showOwnershipFilter: false,
          categories: __VLS_ctx.assetCategories,
          subcategories: __VLS_ctx.assetSubcategories,
          baseCurrency:
            (_d =
              (_b = __VLS_ctx.store.baseCurrency) !== null && _b !== void 0
                ? _b
                : (_c = __VLS_ctx.store.summary) === null || _c === void 0
                  ? void 0
                  : _c.base_currency) !== null && _d !== void 0
              ? _d
              : 'EUR',
          categoryTotalsBase:
            (_f =
              (_e = __VLS_ctx.store.summary) === null || _e === void 0
                ? void 0
                : _e.assets_by_category) !== null && _f !== void 0
              ? _f
              : {},
          subcategoryTotalsBase:
            (_h =
              (_g = __VLS_ctx.store.summary) === null || _g === void 0
                ? void 0
                : _g.assets_by_subcategory) !== null && _h !== void 0
              ? _h
              : {},
          totalBase:
            (_k =
              (_j = __VLS_ctx.store.summary) === null || _j === void 0
                ? void 0
                : _j.total_assets) !== null && _k !== void 0
              ? _k
              : '0',
        },
        __VLS_ctx.itemListProps,
      ),
      {
        onUpdate: __VLS_ctx.updateAssetAndReloadExpenses,
        onArchive: __VLS_ctx.store.archiveAsset,
        onDelete: __VLS_ctx.deleteAssetAndReloadExpenses,
        onAdd: function () {
          return (__VLS_ctx.showAssetModal = true);
        },
        onEdit: function (it) {
        ...
        __assign(
          {
            ...
            baseCurrency:
              (_o =
                (_l = __VLS_ctx.store.baseCurrency) !== null && _l !== void 0
                  ? _l
                  : (_m = __VLS_ctx.store.summary) === null || _m === void 0
                    ? void 0
                    : _m.base_currency) !== null && _o !== void 0
                ? _o
                : 'EUR',
            categoryTotalsBase:
              (_q =
                (_p = __VLS_ctx.store.summary) === null || _p === void 0
                  ? void 0
                  : _p.assets_by_category) !== null && _q !== void 0
                ? _q
                : {},
            subcategoryTotalsBase:
              (_s =
                (_r = __VLS_ctx.store.summary) === null || _r === void 0
                  ? void 0
                  : _r.assets_by_subcategory) !== null && _s !== void 0
                ? _s
                : {},
            totalBase:
              (_u =
                (_t = __VLS_ctx.store.summary) === null || _t === void 0
                  ? void 0
                  : _t.total_assets) !== null && _u !== void 0
                ? _u
                : '0',
          },
          __VLS_ctx.itemListProps,
...
net_worth_1.ItemList;
// @ts-ignore
var __VLS_12 = __VLS_asFunctionalComponent1(
  __VLS_11,
  new __VLS_11(
    __assign(
      __assign(
        {
          ownershipFilterValue: __VLS_ctx.liabilityOwnershipFilter,
          title: 'Pasivos',
          items: __VLS_ctx.visibleLiabilities,
          showArchived: __VLS_ctx.visibilityFilterMode !== 'active',
          showOwnershipFilter: false,
          categories: __VLS_ctx.liabilityCategories,
          baseCurrency:
            (_x =
              (_v = __VLS_ctx.store.baseCurrency) !== null && _v !== void 0
                ? _v
                : (_w = __VLS_ctx.store.summary) === null || _w === void 0
                  ? void 0
                  : _w.base_currency) !== null && _x !== void 0
              ? _x
              : 'EUR',
          categoryTotalsBase:
            (_z =
              (_y = __VLS_ctx.store.summary) === null || _y === void 0
                ? void 0
                : _y.liabilities_by_category) !== null && _z !== void 0
              ? _z
              : {},
          totalBase:
            (_1 =
              (_0 = __VLS_ctx.store.summary) === null || _0 === void 0
                ? void 0
                : _0.total_liabilities) !== null && _1 !== void 0
              ? _1
              : '0',
        },
        __VLS_ctx.itemListProps,
      ...
      {
        assets: __VLS_ctx.activeAssets,
        onUpdate: __VLS_ctx.updateLiabilityAndShowExpenseReview,
        onArchive: __VLS_ctx.store.archiveLiability,
        onDelete: __VLS_ctx.deleteLiabilityAndReloadExpenses,
        onAdd: function () {
          return (__VLS_ctx.showLiabilityModal = true);
        },
        onEdit: function (it) {
        ...
        __assign(
          {
            ...
            baseCurrency:
              (_4 =
                (_2 = __VLS_ctx.store.baseCurrency) !== null && _2 !== void 0
                  ? _2
                  : (_3 = __VLS_ctx.store.summary) === null || _3 === void 0
                    ? void 0
                    : _3.base_currency) !== null && _4 !== void 0
                ? _4
                : 'EUR',
            categoryTotalsBase:
              (_6 =
                (_5 = __VLS_ctx.store.summary) === null || _5 === void 0
                  ? void 0
                  : _5.liabilities_by_category) !== null && _6 !== void 0
                ? _6
                : {},
            totalBase:
              (_8 =
                (_7 = __VLS_ctx.store.summary) === null || _7 === void 0
                  ? void 0
                  : _7.total_liabilities) !== null && _8 !== void 0
                ? _8
                : '0',
          },
          __VLS_ctx.itemListProps,
...
var __VLS_17 = __VLS_asFunctionalComponent1(
  __VLS_16,
  new __VLS_16(
    __assign({ onClose: {} }, { open: __VLS_ctx.showAssetModal, title: 'Nuevo activo' }),
  ),
);
  ...
  ({ close: {} },
  {
    onClose: function () {
      ...
      [
        ...
        itemListProps,
        itemListProps,
        updateAssetAndReloadExpenses,
        deleteAssetAndReloadExpenses,
        showAssetModal,
        showAssetModal,
        showAssetModal,
        openEdit,
        ...
        liabilityCategories,
        activeAssets,
        updateLiabilityAndShowExpenseReview,
        deleteLiabilityAndReloadExpenses,
        showLiabilityModal,
      ];
    },
  });
  ...
  new __VLS_24(
    __assign(
      __assign(
        ...
        __VLS_ctx.itemFormProps,
      ),
      {
        allowNegative: true,
        onSubmit: __VLS_ctx.submitAsset,
        onCancel: function () {
          return (__VLS_ctx.showAssetModal = false);
        },
      },
    ),
  ),
...
ui_1.BaseModal;
// @ts-ignore
var __VLS_30 = __VLS_asFunctionalComponent1(
  __VLS_29,
  new __VLS_29(
    __assign({ onClose: {} }, { open: __VLS_ctx.showLiabilityModal, title: 'Nuevo pasivo' }),
  ),
);
var __VLS_31 = __VLS_30.apply(
  void 0,
  __spreadArray(
    [__assign({ onClose: {} }, { open: __VLS_ctx.showLiabilityModal, title: 'Nuevo pasivo' })],
...
net_worth_1.ItemForm;
// @ts-ignore
var __VLS_38 = __VLS_asFunctionalComponent1(
  __VLS_37,
  new __VLS_37(
    __assign(
      __assign(
        { title: 'Nuevo pasivo', categories: __VLS_ctx.liabilityCategories },
        __VLS_ctx.itemFormProps,
      ),
      {
        assets: __VLS_ctx.activeAssets,
        showFinancedAsset: true,
        onSubmit: __VLS_ctx.submitLiabilityWithExpenseReview,
        onCancel: function () {
          return (__VLS_ctx.showLiabilityModal = false);
        },
      },
    ),
  ),
);
var __VLS_39 = __VLS_38.apply(
  void 0,
  __spreadArray(
    [
      __assign(
...
[
  ...
  showLiabilityModal,
  itemFormProps,
  submitLiabilityWithExpenseReview,
];
var __VLS_32;
var __VLS_33;
var __VLS_42;
...
ui_1.BaseModal;
// @ts-ignore
var __VLS_43 = __VLS_asFunctionalComponent1(
  __VLS_42,
  new __VLS_42(
    __assign(
      { onClose: {} },
      {
        open: __VLS_ctx.showGeneratedLiabilityExpenseModal,
        title: __VLS_ctx.generatedLiabilityExpenseReviewTitle,
      },
    ),
  ),
);
var __VLS_44 = __VLS_43.apply(
  void 0,
  __spreadArray(
    [
      __assign(
...
var __VLS_47;
var __VLS_48 = ({ close: {} }, { onClose: __VLS_ctx.closeGeneratedLiabilityExpenseModal });
var __VLS_49 = __VLS_45.slots.default;
if (__VLS_ctx.generatedLiabilityExpenseReview) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'grid gap-3' }));
  /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-3']} */ if (
    ...
    __VLS_asFunctionalElement1(
      ...
      __assign({
        class:
          'rounded-xl border border-amber-300/20 bg-amber-400/10 px-3 py-2 text-sm text-white/90',
      }),
    );
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ /** @type {__VLS_StyleScopedClasses['border']} */ /** @type {__VLS_StyleScopedClasses['border-amber-300/20']} */ /** @type {__VLS_StyleScopedClasses['bg-amber-400/10']} */ /** @type {__VLS_StyleScopedClasses['px-3']} */ /** @type {__VLS_StyleScopedClasses['py-2']} */ /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['text-white/90']} */ __VLS_ctx.generatedLiabilityExpenseReviewChangeMessage;
  }
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  ...
  /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ /** @type {__VLS_StyleScopedClasses['border']} */ /** @type {__VLS_StyleScopedClasses['border-teal-300/20']} */ /** @type {__VLS_StyleScopedClasses['bg-teal-400/10']} */ /** @type {__VLS_StyleScopedClasses['px-3']} */ /** @type {__VLS_StyleScopedClasses['py-2']} */ /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['text-white/90']} */ __VLS_ctx
    .generatedLiabilityExpenseReview.entries.length;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'grid gap-2' }));
  /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-2']} */ for (
    var _20 = 0, _21 = __VLS_vFor(__VLS_ctx.generatedLiabilityExpenseReview.entries);
    _20 < _21.length;
    _20++
  ) {
    var entry = _21[_20][0];
    ...
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ /** @type {__VLS_StyleScopedClasses['border']} */ /** @type {__VLS_StyleScopedClasses['border-white/10']} */ /** @type {__VLS_StyleScopedClasses['bg-white/[0.03]']} */ /** @type {__VLS_StyleScopedClasses['px-3']} */ /** @type {__VLS_StyleScopedClasses['py-2.5']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'flex flex-wrap items-center justify-between gap-2' }));
    /** @type {__VLS_StyleScopedClasses['flex']} */ /** @type {__VLS_StyleScopedClasses['flex-wrap']} */ /** @type {__VLS_StyleScopedClasses['items-center']} */ /** @type {__VLS_StyleScopedClasses['justify-between']} */ /** @type {__VLS_StyleScopedClasses['gap-2']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'text-sm font-medium' }));
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['font-medium']} */ entry.fiscalYear;
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'text-sm text-white/90' }));
    /** @type {__VLS_StyleScopedClasses['text-sm']} */ /** @type {__VLS_StyleScopedClasses['text-white/90']} */ __VLS_ctx.formatMoneyAmount(
      entry.amountAnnual,
      entry.currency,
    );
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'mt-1 text-xs text-white/70' }));
    /** @type {__VLS_StyleScopedClasses['mt-1']} */ /** @type {__VLS_StyleScopedClasses['text-xs']} */ /** @type {__VLS_StyleScopedClasses['text-white/70']} */ __VLS_ctx.expenseCategoryLabel(
      entry.category,
    );
    ...
    if (entry.notes) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'mt-1 text-xs text-white/55' }));
      /** @type {__VLS_StyleScopedClasses['mt-1']} */ /** @type {__VLS_StyleScopedClasses['text-xs']} */ /** @type {__VLS_StyleScopedClasses['text-white/55']} */ entry.notes;
    }
    // @ts-ignore
    [
      formatMoneyAmount,
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'actions justify-end' }));
  /** @type {__VLS_StyleScopedClasses['actions']} */ /** @type {__VLS_StyleScopedClasses['justify-end']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.button,
    __VLS_intrinsics.button,
  )(
    __assign(__assign({ onClick: __VLS_ctx.openGeneratedExpenseBulkEdit }, { class: 'btn' }), {
      type: 'button',
      disabled: !__VLS_ctx.generatedLiabilityExpenseReview.entries.length,
    }),
  );
  /** @type {__VLS_StyleScopedClasses['btn']} */ __VLS_asFunctionalElement1(
    ...
    __assign(
      __assign(
        { onClick: __VLS_ctx.closeGeneratedLiabilityExpenseModal },
        { class: 'btn btn-ghost' },
      ),
      { type: 'button' },
    ),
  ...
  /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ __VLS_asFunctionalElement1(
    ...
    __assign(
      __assign(
        { onClick: __VLS_ctx.openGeneratedExpenseReviewEntryFromVisibleYear },
        { class: 'btn btn-primary' },
      ),
      {
        type: 'button',
        disabled: !__VLS_ctx.annualExpenseEntries.some(function (entry) {
          var _a;
          return (
            entry.sourceLiabilityId ===
              ((_a = __VLS_ctx.generatedLiabilityExpenseReview) === null || _a === void 0
                ? void 0
                : _a.liabilityId) && entry.isSystemGenerated
          );
        }),
      },
    ),
...
ui_1.BaseModal;
// @ts-ignore
var __VLS_51 = __VLS_asFunctionalComponent1(
  __VLS_50,
  new __VLS_50(
    __assign({ onClose: {} }, { open: __VLS_ctx.showEditModal, title: __VLS_ctx.editTitle }),
  ),
);
var __VLS_52 = __VLS_51.apply(
  void 0,
  __spreadArray(
    [__assign({ onClose: {} }, { open: __VLS_ctx.showEditModal, title: __VLS_ctx.editTitle })],
...
var __VLS_55;
var __VLS_56 = ({ close: {} }, { onClose: __VLS_ctx.closeEdit });
  ...
  var __VLS_59 = __VLS_asFunctionalComponent1(
    ...
    new __VLS_58(
      __assign(
        __assign(
          {
            title: __VLS_ctx.editTitle,
            categories: __VLS_ctx.editCategories,
            subcategories:
              __VLS_ctx.editKind === 'asset' ? __VLS_ctx.assetSubcategories : undefined,
          },
          __VLS_ctx.itemFormProps,
        ),
        {
          assets: __VLS_ctx.editKind === 'liability' ? __VLS_ctx.activeAssets : [],
          showFinancedAsset: __VLS_ctx.editKind === 'liability',
          allowNegative: __VLS_ctx.editKind === 'asset',
          mode: 'edit',
          initial: __VLS_ctx.editInitial,
...
// @ts-ignore
var __VLS_64 = __VLS_asFunctionalComponent1(
  __VLS_63,
  new __VLS_63(
    __assign(__assign(__assign({ onPatch: {} }, { onClose: {} }), { onSubmit: {} }), {
      open: __VLS_ctx.showIncomeModal,
      title: __VLS_ctx.incomeModalTitle,
      form: __VLS_ctx.annualIncomeForm,
      loading: __VLS_ctx.annualIncomeLoading,
      submitLabel: __VLS_ctx.incomeSubmitLabel,
      categoryOptions: __VLS_ctx.incomeCategories,
      subcategoryOptions: __VLS_ctx.annualSubcategoryOptions,
      showOwnerField: __VLS_ctx.showOwnerField,
      ownerOptions: __VLS_ctx.ownerOptions,
      timeProfileOptions: __VLS_ctx.incomeTimeProfileOptions,
      cashflowRoleOptions: __VLS_ctx.incomeCashflowRoleOptions,
      showCashflowRoleField: false,
      eventGroupOptions: __VLS_ctx.annualEventGroupOptions,
      eventGroupDatalistId: 'income-event-groups',
      namePlaceholder: 'Concepto (ej: CTN, Regalos Pablo)',
      amountPlaceholder: __VLS_ctx.incomeAmountInputPlaceholder,
    }),
  ),
);
var __VLS_65 = __VLS_64.apply(
  void 0,
  __spreadArray(
    [
      __assign(__assign(__assign({ onPatch: {} }, { onClose: {} }), { onSubmit: {} }), {
...
var __VLS_68;
var __VLS_69 = ({ patch: {} }, { onPatch: __VLS_ctx.patchAnnualIncomeForm });
var __VLS_70 = ({ close: {} }, { onClose: __VLS_ctx.closeIncomeModal });
var __VLS_71 = ({ submit: {} }, { onSubmit: __VLS_ctx.submitAnnualIncome });
var __VLS_66;
var __VLS_67;
var __VLS_72;
/** @ts-ignore @type {typeof __VLS_components.AnnualEntryModalForm} */
data_input_1.AnnualEntryModalForm;
// @ts-ignore
var __VLS_73 = __VLS_asFunctionalComponent1(
  __VLS_72,
  new __VLS_72(
    __assign(__assign(__assign({ onPatch: {} }, { onClose: {} }), { onSubmit: {} }), {
      open: __VLS_ctx.showExpenseModal,
      title: __VLS_ctx.expenseModalTitle,
      form: __VLS_ctx.annualExpenseForm,
      loading: __VLS_ctx.annualExpenseLoading,
      submitLabel: __VLS_ctx.expenseSubmitLabel,
      categoryOptions: __VLS_ctx.expenseCategories,
      subcategoryOptions: __VLS_ctx.annualExpenseSubcategoryOptions,
      showOwnerField: __VLS_ctx.showOwnerField,
      ownerOptions: __VLS_ctx.ownerOptions,
      timeProfileOptions: __VLS_ctx.expenseTimeProfileOptions,
      timeProfileFieldLabel: 'Tipo de salida',
      cashflowRoleOptions: __VLS_ctx.filteredExpenseCashflowRoleOptions,
      showCashflowRoleField: __VLS_ctx.showExpenseCashflowRoleField,
      showEventGroupField: !__VLS_ctx.editingSystemGeneratedLiabilityExpense,
      showTermEndYearField: !__VLS_ctx.editingSystemGeneratedLiabilityExpense,
      eventGroupOptions: __VLS_ctx.annualEventGroupOptions,
      eventGroupDatalistId: 'expense-event-groups',
      namePlaceholder: 'Concepto (ej: Alimentacion, Hipoteca)',
      amountPlaceholder: __VLS_ctx.expenseAmountInputPlaceholder,
      notesPlaceholder: __VLS_ctx.expenseBulkEditHint,
    }),
  ),
);
var __VLS_74 = __VLS_73.apply(
  void 0,
  __spreadArray(
    [
      __assign(__assign(__assign({ onPatch: {} }, { onClose: {} }), { onSubmit: {} }), {
...
var __VLS_77;
var __VLS_78 = ({ patch: {} }, { onPatch: __VLS_ctx.patchAnnualExpenseForm });
var __VLS_79 = ({ close: {} }, { onClose: __VLS_ctx.closeExpenseModal });
var __VLS_80 = ({ submit: {} }, { onSubmit: __VLS_ctx.submitAnnualExpense });
var __VLS_75;
var __VLS_76;
// @ts-ignore
[
  ...
  annualIncomeForm,
  incomeSubmitLabel,
  data_input_1.incomeCategories,
  annualSubcategoryOptions,
  showOwnerField,
  showOwnerField,
  ownerOptions,
  ownerOptions,
  incomeTimeProfileOptions,
  incomeCashflowRoleOptions,
  annualEventGroupOptions,
  annualEventGroupOptions,
  incomeAmountInputPlaceholder,
  ...
  annualExpenseForm,
  expenseSubmitLabel,
  data_input_1.expenseCategories,
  annualExpenseSubcategoryOptions,
  expenseTimeProfileOptions,
  filteredExpenseCashflowRoleOptions,
  showExpenseCashflowRoleField,
  editingSystemGeneratedLiabilityExpense,
  editingSystemGeneratedLiabilityExpense,
  expenseAmountInputPlaceholder,
  expenseBulkEditHint,
