...
var _s = (0, net_worth_1.useNetWorthViewState)(),
  store = _s.store,
  valueMode = _s.valueMode,
  currencies = _s.currencies,
  assetCategories = _s.assetCategories,
  liabilityCategories = _s.liabilityCategories,
  prettyError = _s.prettyError,
  canShowReal = _s.canShowReal,
  confirmDeleteSnapshot = _s.confirmDeleteSnapshot,
  showAssetModal = _s.showAssetModal,
  showLiabilityModal = _s.showLiabilityModal,
  showEditModal = _s.showEditModal,
  editKind = _s.editKind,
  formatMoney = _s.formatMoney,
  unitLabel = _s.unitLabel,
  modeLabel = _s.modeLabel,
  realBaseLabel = _s.realBaseLabel,
  assetSubcategories = _s.assetSubcategories,
  summaryAssets = _s.summaryAssets,
  summaryLiabilities = _s.summaryLiabilities,
  summaryNetWorth = _s.summaryNetWorth,
  byCategoryKeys = _s.byCategoryKeys,
  byCategoryAssets = _s.byCategoryAssets,
  byCategoryLiabilities = _s.byCategoryLiabilities,
  summaryAssetBackedLiabilities = _s.summaryAssetBackedLiabilities,
  summaryUnbackedLiabilities = _s.summaryUnbackedLiabilities,
  submitAsset = _s.submitAsset,
  submitLiability = _s.submitLiability,
  openEdit = _s.openEdit,
  closeEdit = _s.closeEdit,
  editTitle = _s.editTitle,
  editCategories = _s.editCategories,
  editInitial = _s.editInitial,
...
function displayCurrencyUnit(currency) {
  return currency === 'EUR'
    ? '€'
    : String(currency !== null && currency !== void 0 ? currency : '').trim();
}
var _t = (0, useNetWorthOwnership_1.useNetWorthOwnership)({
    ownerships: (0, vue_1.computed)(function () {
      return store.ownerships;
    }),
    valueMode: valueMode,
  }),
  ownershipFilter = _t.ownershipFilter,
  ownershipOptions = _t.ownershipOptions,
  selectedOwnershipFilterLabel = _t.selectedOwnershipFilterLabel,
  ownershipFilterDisabled = _t.ownershipFilterDisabled,
  allocationFractionForNetWorthOwner = _t.allocationFractionForNetWorthOwner,
  matchesOwnershipFilter = _t.matchesOwnershipFilter,
  ownershipBadge = _t.ownershipBadge,
  setOwnershipFilter = _t.setOwnershipFilter,
  setValueMode = _t.setValueMode;
var heroUnitLabel = (0, vue_1.computed)(function () {
  return displayCurrencyUnit(unitLabel());
});
(0, vue_1.watch)(ownershipFilter, function () {
...
var timelineRows = (0, vue_1.computed)(function () {
  var _a, _b;
  return (
    (_b = (_a = store.timeline) === null || _a === void 0 ? void 0 : _a.rows) !== null &&
    _b !== void 0
      ? _b
      : []
  ).map(function (row) {
...
var _u = (0, useNetWorthPageMetrics_1.useNetWorthPageMetrics)({
    assets: (0, vue_1.computed)(function () {
      return store.assets;
    }),
    liabilities: (0, vue_1.computed)(function () {
      return store.liabilities;
    }),
    baseCurrency: (0, vue_1.computed)(function () {
      return store.baseCurrency;
    }),
    summary: (0, vue_1.computed)(function () {
      return store.summary;
    }),
    positionTimelineRowsSource: (0, vue_1.computed)(function () {
      var _a, _b;
      return (_b = (_a = store.positionTimeline) === null || _a === void 0 ? void 0 : _a.rows) !==
        null && _b !== void 0
        ? _b
        : [];
    }),
  ...
  selectedCategoryLabel = _u.selectedCategoryLabel,
  allAssetPositionRows = _u.allAssetPositionRows,
  allLiabilityPositionRows = _u.allLiabilityPositionRows,
  effectiveCategoryKeys = _u.effectiveCategoryKeys,
  effectiveCategoryLabels = _u.effectiveCategoryLabels,
  effectiveCategoryAssets = _u.effectiveCategoryAssets,
  effectiveCategoryLiabilities = _u.effectiveCategoryLiabilities,
  effectiveCategoryAssetCounts = _u.effectiveCategoryAssetCounts,
  effectiveCategoryLiabilityCounts = _u.effectiveCategoryLiabilityCounts,
  analysis = _u.analysis,
  availablePositionRows = _u.availablePositionRows,
  activeAssets = _u.activeAssets,
  categoryWorkspaceRows = _u.categoryWorkspaceRows,
  categoryWorkspaceCount = _u.categoryWorkspaceCount,
  categoryWorkspaceTotal = _u.categoryWorkspaceTotal,
  showCategoryWorkspace = _u.showCategoryWorkspace,
  sourceItemForRow = _u.sourceItemForRow,
  selectedPosition = _u.selectedPosition,
  selectedPositionSource = _u.selectedPositionSource,
  positionTimelineRows = _u.positionTimelineRows;
function ownershipBadgeForRow(row) {
  var _a;
  return ownershipBadge(
    (_a = sourceItemForRow(row)) === null || _a === void 0 ? void 0 : _a.ownership_ref,
  );
}
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [3 /*break*/, 4];
        case 2:
          return [4 /*yield*/, store.deleteLiability(row.id)];
        case 3:
          _a.sent();
          _a.label = 4;
        case 4:
...
var categoryWorkspaceMeta = (0, vue_1.computed)(function () {
  if (!selectedTimelineCategory.value) return '';
  return ''
    .concat(categoryWorkspaceCount.value, ' posiciones - ')
    .concat(formatNumber(categoryWorkspaceTotal.value, 2), ' ')
    .concat(heroUnitLabel.value);
});
var showPositionSelector = (0, vue_1.computed)(function () {
  return !!selectedTimelineCategory.value && availablePositionRows.value.length > 0;
});
...
var _v = (0, useNetWorthAccountingActivity_1.useNetWorthAccountingActivity)({
  ...
  accountingActivityLoading = _v.accountingActivityLoading,
  accountingActivityError = _v.accountingActivityError,
  accountingActivityRows = _v.accountingActivityRows,
  accountingActivityYear = _v.accountingActivityYear,
  showAccountingActivitySetupGap = _v.showAccountingActivitySetupGap,
  showAccountingActivityNeedsReview = _v.showAccountingActivityNeedsReview,
  showAccountingActivityBlock = _v.showAccountingActivityBlock,
  resetAccountingActivity = _v.resetAccountingActivity,
  loadAccountingActivity = _v.loadAccountingActivity;
var positionActivityRows = (0, useNetWorthPositionActivity_1.useNetWorthPositionActivity)({
  selectedPositionType: selectedPositionType,
  assetValuations: (0, vue_1.computed)(function () {
    return store.assetValuations;
  }),
  investmentEvents: (0, vue_1.computed)(function () {
    return store.investmentEvents;
  }),
  liquidityEvents: (0, vue_1.computed)(function () {
    return store.liquidityEvents;
  }),
  liabilityValuations: (0, vue_1.computed)(function () {
    return store.liabilityValuations;
  }),
  liabilityEvents: (0, vue_1.computed)(function () {
    return store.liabilityEvents;
  }),
  toNumber: toNumber,
...
var _w = (0, useNetWorthTimeline_1.useNetWorthTimeline)({
    ...
    storeTimelineLoading: (0, vue_1.computed)(function () {
      return store.timelineLoading;
    }),
    storePositionTimelineLoading: (0, vue_1.computed)(function () {
      return store.positionTimelineLoading;
    }),
  ...
  displayedTimelineLoading = _w.displayedTimelineLoading,
  visibleTimelineRows = _w.visibleTimelineRows,
  timelineWindow = _w.timelineWindow,
  timelineChartRows = _w.timelineChartRows,
  timelineChartPoints = _w.timelineChartPoints,
  timelineRangeCaption = _w.timelineRangeCaption,
  latestTimelineChartPoint = _w.latestTimelineChartPoint,
  timelineSummaryLabel = _w.timelineSummaryLabel,
  displayedTimelineSeriesColor = _w.displayedTimelineSeriesColor;
...
var _x = (0, useNetWorthPageActions_1.useNetWorthPageActions)({
  ...
  openCreateModal = _x.openCreateModal,
  submitAssetFromView = _x.submitAssetFromView,
  submitLiabilityFromView = _x.submitLiabilityFromView,
  resetTimelineSelection = _x.resetTimelineSelection,
  applyCompositionCategoryFilter = _x.applyCompositionCategoryFilter,
  handleCompositionAddType = _x.handleCompositionAddType,
  selectPosition = _x.selectPosition,
  setTimelinePreset = _x.setTimelinePreset,
  updateTimelineWindowStart = _x.updateTimelineWindowStart,
  updateTimelineWindowEnd = _x.updateTimelineWindowEnd,
  onPositionSelection = _x.onPositionSelection,
  assetCreateInitial = _x.assetCreateInitial,
  liabilityCreateInitial = _x.liabilityCreateInitial;
...
/** @type {__VLS_StyleScopedClasses['container']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-page']} */ /** @type {__VLS_StyleScopedClasses['relative']} */ var __VLS_0 =
  NetWorthHeroSection_vue_1.default;
// @ts-ignore
...
__VLS_asFunctionalElement1(
  ...
  __VLS_intrinsics.section,
)(__assign({ class: 'card ui-pro-panel ui-nw-hero-shell grid gap-2.5 mb-2' }));
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-nw-hero-shell']} */ /** @type {__VLS_StyleScopedClasses['grid']} */ /** @type {__VLS_StyleScopedClasses['gap-2.5']} */ /** @type {__VLS_StyleScopedClasses['mb-2']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-hero-timeline' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-hero-timeline']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-layout' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-layout']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ ref: 'timelineColumnRef' }, { class: 'ui-nw-timeline-column' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-column']} */ var __VLS_5 =
  NetWorthTimelineMain_vue_1.default;
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(
  ...
  new __VLS_5({
    ...
    setTimelineExpanded: function (value) {
      return (__VLS_ctx.timelineExpanded = value);
    },
    timelineChartPoints: __VLS_ctx.timelineChartPoints,
    displayedTimelineUnit: __VLS_ctx.displayCurrencyUnit(
      (_b =
        (_a = __VLS_ctx.store.timeline) === null || _a === void 0 ? void 0 : _a.base_currency) !==
        null && _b !== void 0
        ? _b
        : __VLS_ctx.unitLabel(),
    ),
    ...
    [
      {
        ...
        displayedTimelineUnit: __VLS_ctx.displayCurrencyUnit(
          (_d =
            (_c = __VLS_ctx.store.timeline) === null || _c === void 0
              ? void 0
...
var __VLS_11 = __VLS_asFunctionalComponent1(
  ...
  new __VLS_10(
    __assign(
      { onClose: {} },
      {
        open: __VLS_ctx.timelineExpanded,
        title: 'Evolucion temporal',
        panelClass: 'max-w-[1080px]',
      },
    ),
  ),
);
...
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal-head' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal-head']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)({});
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal-title' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal-title']} */ __VLS_ctx.timelineSummaryLabel;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal-copy' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal-copy']} */ __VLS_ctx.timelineRangeCaption;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal-value' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal-value']} */ __VLS_ctx.formatNumber(
  (_f = (_e = __VLS_ctx.latestTimelineChartPoint) === null || _e === void 0 ? void 0 : _e.value) !==
    null && _f !== void 0
    ? _f
    : 0,
  2,
);
__VLS_ctx.displayCurrencyUnit(
  (_h = (_g = __VLS_ctx.store.timeline) === null || _g === void 0 ? void 0 : _g.base_currency) !==
    null && _h !== void 0
    ? _h
    : __VLS_ctx.unitLabel(),
);
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-nw-timeline-modal-ranges' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-modal-ranges']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.label,
  __VLS_intrinsics.label,
)(__assign({ class: 'ui-nw-timeline-slider-group' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-slider-group']} */ __VLS_asFunctionalElement1(
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(
  __assign(
    ...
    ),
    {
      type: 'range',
      min: '0',
      max: Math.max(0, __VLS_ctx.visibleTimelineRows.length - 1),
      value: __VLS_ctx.timelineWindow.start,
    },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-slider']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.strong,
  __VLS_intrinsics.strong,
)({});
(_k = (_j = __VLS_ctx.timelineChartPoints[0]) === null || _j === void 0 ? void 0 : _j.fullLabel) !==
  null && _k !== void 0
  ? _k
  : '-';
__VLS_asFunctionalElement1(
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(
  __assign(
    ...
    ),
    {
      ...
      min: '0',
      max: Math.max(0, __VLS_ctx.visibleTimelineRows.length - 1),
      value: __VLS_ctx.timelineWindow.end,
    },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-slider']} */ __VLS_asFunctionalElement1(
...
(_m =
  (_l = __VLS_ctx.latestTimelineChartPoint) === null || _l === void 0 ? void 0 : _l.fullLabel) !==
  null && _m !== void 0
  ? _m
  : '-';
var __VLS_18;
...
var __VLS_19 = __VLS_asFunctionalComponent1(
  ...
  new __VLS_18({
    ...
    unit: __VLS_ctx.displayCurrencyUnit(
      (_p =
        (_o = __VLS_ctx.store.timeline) === null || _o === void 0 ? void 0 : _o.base_currency) !==
        null && _p !== void 0
        ? _p
        : __VLS_ctx.unitLabel(),
    ),
    ...
    [
      {
        ...
        unit: __VLS_ctx.displayCurrencyUnit(
          (_r =
            (_q = __VLS_ctx.store.timeline) === null || _q === void 0
              ? void 0
              : _q.base_currency) !== null && _r !== void 0
            ? _r
            : __VLS_ctx.unitLabel(),
        ),
        seriesLabel: __VLS_ctx.timelineSummaryLabel,
...
var __VLS_14;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.aside,
  __VLS_intrinsics.aside,
)(__assign({ class: 'ui-nw-timeline-sidebar' }));
/** @type {__VLS_StyleScopedClasses['ui-nw-timeline-sidebar']} */ var __VLS_23 =
  NetWorthCategoryWorkspace_vue_1.default;
// @ts-ignore
