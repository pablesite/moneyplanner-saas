...
<template>
  <div class="container ui-pro-page">
    <div class="ui-page-header">
      <h1 class="h1 ui-page-title">Settings | Tasas de reconversion</h1>
    ...
    <section class="card ui-pro-panel">
      <div class="ui-section-header">
        <h2 class="h2">Modulo: tasas de reconversion</h2>
      </div>
    ...
    <div v-if="loading" class="ui-status-line">Cargando modulo de tasas...</div>
  </div>
</template>
