...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-page-header" }));
/** @type {__VLS_StyleScopedClasses['ui-page-header']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.h1, __VLS_intrinsics.h1)(__assign({ class: "h1 ui-page-title" }));
/** @type {__VLS_StyleScopedClasses['h1']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-page-title']} */ ;
...
/** @type {__VLS_StyleScopedClasses['btn']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "card ui-pro-panel mt-1" }));
/** @type {__VLS_StyleScopedClasses['card']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['mt-1']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "mb-3.5 flex gap-2.5" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign(__assign({ onClick: function () {
        ...
        // @ts-ignore
        [tab,];
    } }, { class: "btn opacity-60" }), { type: "button" }), { class: ({ '!opacity-100': __VLS_ctx.tab === 'members' }) }));
/** @type {__VLS_StyleScopedClasses['btn']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign(__assign({ onClick: function () {
        ...
        // @ts-ignore
        [tab, tab,];
    } }, { class: "btn opacity-60" }), { type: "button" }), { class: ({ '!opacity-100': __VLS_ctx.tab === 'ownerships' }) }));
/** @type {__VLS_StyleScopedClasses['btn']} */ ;
/** @type {__VLS_StyleScopedClasses['opacity-60']} */ ;
/** @type {__VLS_StyleScopedClasses['!opacity-100']} */ ;
