...
var guideFiscalYear = (0, vue_1.computed)(function () {
...
var phase = (0, vue_1.computed)(function () {
  return phaseId.value == null ? null : (0, phases_1.findGuidePhaseById)(phaseId.value);
});
var isDebtPhase = (0, vue_1.computed)(function () {
  var _a;
  return ((_a = phase.value) === null || _a === void 0 ? void 0 : _a.id) === 1;
});
var isCashFlowPhase = (0, vue_1.computed)(function () {
  var _a;
  return ((_a = phase.value) === null || _a === void 0 ? void 0 : _a.id) === 2;
});
var isEmergencyFundPhase = (0, vue_1.computed)(function () {
  var _a;
  return ((_a = phase.value) === null || _a === void 0 ? void 0 : _a.id) === 3;
});
var isNetWorthHealthPhase = (0, vue_1.computed)(function () {
  var _a;
  return ((_a = phase.value) === null || _a === void 0 ? void 0 : _a.id) === 4;
});
...
var phaseQuickActions = (0, vue_1.computed)(function () {
  ...
  return (_a = actionsById[phaseValue.id]) !== null && _a !== void 0
    ? _a
    : [
        {
          id: 'data-input',
...
var netWorthValue = (0, vue_1.computed)(function () {
  var _a;
  return toNumber((_a = store.summary) === null || _a === void 0 ? void 0 : _a.net_worth);
});
...
var totalAnnualIncomeValue = (0, vue_1.computed)(function () {
  return recurrentAnnualIncomeValue.value + oneOffAnnualIncomeValue.value;
});
...
var recurrentSavingsAllocationValue = (0, vue_1.computed)(function () {
  return annualExpenseStore.entries.value.reduce(function (acc, entry) {
    ...
    return entry.category === 'savings_allocation'
      ? acc + Number((_a = entry.amountAnnual) !== null && _a !== void 0 ? _a : 0)
      : acc;
  }, 0);
});
...
var recurrentRealEstateAllocationValue = (0, vue_1.computed)(function () {
  return annualExpenseStore.entries.value.reduce(function (acc, entry) {
    var _a;
    if (resolveExpenseTimeProfile(entry) === 'one_off') return acc;
    return entry.category === 'real_estate_assets'
      ? acc + Number((_a = entry.amountAnnual) !== null && _a !== void 0 ? _a : 0)
      : acc;
  }, 0);
});
var recurrentTangibleAllocationValue = (0, vue_1.computed)(function () {
  return annualExpenseStore.entries.value.reduce(function (acc, entry) {
    var _a;
    if (resolveExpenseTimeProfile(entry) === 'one_off') return acc;
    return entry.category === 'tangible_assets'
      ? acc + Number((_a = entry.amountAnnual) !== null && _a !== void 0 ? _a : 0)
      : acc;
  }, 0);
});
var oneOffAnnualExpenseValue = (0, vue_1.computed)(function () {
  return annualExpenseStore.entries.value.reduce(function (acc, entry) {
    var _a;
    return resolveExpenseTimeProfile(entry) === 'one_off'
      ? acc + Number((_a = entry.amountAnnual) !== null && _a !== void 0 ? _a : 0)
      : acc;
  }, 0);
});
var totalAnnualExpenseValue = (0, vue_1.computed)(function () {
  return recurrentAnnualExpenseValue.value + oneOffAnnualExpenseValue.value;
});
var totalAnnualCashFlowValue = (0, vue_1.computed)(function () {
  return totalAnnualIncomeValue.value - totalAnnualExpenseValue.value;
});
...
var recurrentTotalCashFlowValue = (0, vue_1.computed)(function () {
...
var extraordinaryEventGroupOptions = (0, vue_1.computed)(function () {
  ...
  for (var _i = 0, _e = annualIncomeStore.entries.value; _i < _e.length; _i++) {
    var entry = _e[_i];
    var profile =
      (_a = entry.timeProfile) !== null && _a !== void 0
        ? _a
        : entry.incomeType === 'one_off'
          ? 'one_off'
          : 'structural_recurrent';
  ...
  for (var _f = 0, _g = annualExpenseStore.entries.value; _f < _g.length; _f++) {
    var entry = _g[_f];
    var profile =
      (_c = entry.timeProfile) !== null && _c !== void 0
        ? _c
        : entry.expenseType === 'one_off'
          ? 'one_off'
          : 'structural_recurrent';
...
var structuralOperatingMonthlyExpenseValue = (0, vue_1.computed)(function () {
  return recurrentOperationalExpenseValue.value > 0
    ? recurrentOperationalExpenseValue.value / 12
    : null;
});
...
var emergencyCoverageMonthsCommittedValue = (0, vue_1.computed)(function () {
  return currentCommittedMonthlyExpenseValue.value != null &&
...
var filteredOneOffAnnualIncomeValue = (0, vue_1.computed)(function () {
  ...
  return annualIncomeStore.entries.value.reduce(function (acc, entry) {
    ...
    return String((_b = entry.eventGroup) !== null && _b !== void 0 ? _b : '').trim() ===
      selectedExtraordinaryEventGroup.value
...
var filteredExtraordinaryNetCashFlowValue = (0, vue_1.computed)(function () {
  return filteredOneOffAnnualIncomeValue.value - filteredOneOffAnnualExpenseValue.value;
});
...
var phase4GlobalScoreValue = (0, vue_1.computed)(function () {
  return sharedPhaseDiagnostics.value.phase4GlobalScore;
});
...
var phase1GlobalScoreValue = (0, vue_1.computed)(function () {
  return sharedPhaseDiagnostics.value.phase1GlobalScore;
});
...
var phase2GlobalScoreValue = (0, vue_1.computed)(function () {
  return sharedPhaseDiagnostics.value.phase2GlobalScore;
});
...
var phase3GlobalScoreValue = (0, vue_1.computed)(function () {
  return sharedPhaseDiagnostics.value.phase3GlobalScore;
});
...
var globalToneValue = (0, vue_1.computed)(function () {
  return toneFromScore(globalScoreValue.value);
});
...
var phase4ScoreCards = (0, vue_1.computed)(function () {
  return [
    {
      id: 'support',
...
var phase1ScoreCards = (0, vue_1.computed)(function () {
  return [
    {
      id: 'debt-cost',
...
var phase2ScoreCards = (0, vue_1.computed)(function () {
  return [
    {
        ...
        },
        {
          ...
          detailText:
            recurrentAfterCommitmentsMonthlyValue.value == null
              ? undefined
              : 'Colchon mensual tras cargas temporales: '.concat(
                  formatNumber(recurrentAfterCommitmentsMonthlyValue.value, 2),
                ),
        },
      ],
    },
    {
      ...
      kpis: [
        ...
        },
        {
          ...
          detailText: 'Ingresos anuales totales '
            .concat(
              formatNumber(totalAnnualIncomeValue.value, 2),
              ' \u00B7 Gastos anuales totales ',
            )
            .concat(formatNumber(totalAnnualExpenseValue.value, 2), ' \u00B7 Flujo anual total ')
            .concat(formatNumber(totalAnnualCashFlowValue.value, 2)),
        },
      ],
    },
  ];
});
var phase2DistributionInfoCards = (0, vue_1.computed)(function () {
  return [
    {
...
var phase3ScoreCards = (0, vue_1.computed)(function () {
  return [
    {
        ...
        },
        {
          ...
          detailText:
            currentCommittedMonthlyExpenseValue.value == null
              ? undefined
              : 'Carga mensual actual estimada: '.concat(
                  formatNumber(currentCommittedMonthlyExpenseValue.value, 2),
                ),
        },
      ],
    },
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          valueTone: 'positive',
          metaText: 'Mobiliarios '
            .concat(
              formatNumber(recurrentTangibleAllocationValue.value, 2),
              ' \u00B7 Inmobiliarios ',
            )
            .concat(formatNumber(recurrentRealEstateAllocationValue.value, 2)),
        },
      ],
    },
    {
...
var cashFlowHeroSummaryCards = (0, vue_1.computed)(function () {
  ...
  if (!isCashFlowPhase.value) return [];
  return (_b =
    (_a = cashFlowSummarySections.value[0]) === null || _a === void 0 ? void 0 : _a.cards) !==
    null && _b !== void 0
    ? _b
    : [];
});
...
var cashFlowDistortionWarning = (0, vue_1.computed)(function () {
  ...
  return 'Ano con eventos extraordinarios ('.concat(
    formatPct(extraordinaryVolumeRatioValue.value, 0),
    ' del ingreso total). El score prioriza tension recurrente estructural y cargas temporales de caja.',
  );
});
var phaseDiagnosticCopy = (0, vue_1.computed)(function () {
  ...
  return (_b = (_a = phase.value) === null || _a === void 0 ? void 0 : _a.objective) !== null &&
    _b !== void 0
    ? _b
    : '';
});
...
/** @type {__VLS_StyleScopedClasses['ui-guide-back-link']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-inline-action-link']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-context-summary']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-context-details']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-context-summary']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-score-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid-cols-4']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-score-top']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid-cols-2']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid-cols-4']} */ __VLS_asFunctionalElement1(
...
/** @type {__VLS_StyleScopedClasses['container']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-page']} */ __VLS_asFunctionalElement1(
  ...
  __VLS_intrinsics.section,
)(__assign({ class: 'card ui-pro-panel ui-guide-phase-head' }));
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-head']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-guide-phase-nav-row' }));
/** @type {__VLS_StyleScopedClasses['ui-guide-phase-nav-row']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-guide-phase-nav-links' }));
/** @type {__VLS_StyleScopedClasses['ui-guide-phase-nav-links']} */ var __VLS_0;
/** @ts-ignore @type {typeof __VLS_components.RouterLink | typeof __VLS_components.RouterLink} */
vue_router_1.RouterLink;
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent1(
  __VLS_0,
  new __VLS_0(__assign({ class: 'ui-guide-back-link' }, { to: '/' })),
);
var __VLS_2 = __VLS_1.apply(
  void 0,
  __spreadArray(
    [__assign({ class: 'ui-guide-back-link' }, { to: '/' })],
    __VLS_functionalComponentArgsRest(__VLS_1),
    false,
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-guide-back-link']} */ var __VLS_5 = __VLS_3.slots.default;
var __VLS_3;
if (__VLS_ctx.phaseQuickActions.length) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-guide-phase-inline-actions' }));
  /** @type {__VLS_StyleScopedClasses['ui-guide-phase-inline-actions']} */ for (
    var _i = 0, _c = __VLS_vFor(__VLS_ctx.phaseQuickActions);
    _i < _c.length;
    _i++
  ) {
    var action = _c[_i][0];
    ...
    var __VLS_7 = __VLS_asFunctionalComponent1(
      __VLS_6,
      new __VLS_6(
        __assign(__assign({ key: action.id }, { class: 'ui-guide-phase-inline-action-link' }), {
          to: action.to,
        }),
      ),
    );
    ...
    /** @type {__VLS_StyleScopedClasses['ui-guide-phase-inline-action-link']} */ var __VLS_11 =
...
__VLS_asFunctionalElement1(
  __VLS_intrinsics.div,
  __VLS_intrinsics.div,
)(__assign({ class: 'ui-guide-phase-switch' }));
/** @type {__VLS_StyleScopedClasses['ui-guide-phase-switch']} */ for (
  var _d = 0, _e = __VLS_vFor(__VLS_ctx.guidePhases);
  _d < _e.length;
  _d++
) {
  ...
  var __VLS_13 = __VLS_asFunctionalComponent1(
    ...
    new __VLS_12(
      __assign(
        __assign(__assign({ key: phaseItem.id }, { class: 'ui-guide-phase-switch-link' }), {
          class: {
            'ui-guide-phase-switch-link-active':
              phaseItem.id === ((_a = __VLS_ctx.phase) === null || _a === void 0 ? void 0 : _a.id),
          },
        }),
        { to: __VLS_ctx.phaseDetailTo(phaseItem.id) },
      ),
    ),
  );
        ...
        __assign(
          __assign(__assign({ key: phaseItem.id }, { class: 'ui-guide-phase-switch-link' }), {
            class: {
              'ui-guide-phase-switch-link-active':
                phaseItem.id ===
                ((_b = __VLS_ctx.phase) === null || _b === void 0 ? void 0 : _b.id),
            },
          }),
          { to: __VLS_ctx.phaseDetailTo(phaseItem.id) },
        ),
  ...
  /** @type {__VLS_StyleScopedClasses['ui-guide-phase-switch-link']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-switch-link-active']} */ var __VLS_17 =
...
if (__VLS_ctx.phase) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.h1,
    __VLS_intrinsics.h1,
  )(__assign({ class: 'h1 ui-guide-phase-title ui-guide-phase-title-inline' }));
  /** @type {__VLS_StyleScopedClasses['h1']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-title']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-title-inline']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )(__assign({ class: 'ui-pro-kicker ui-guide-phase-title-inline-kicker' }));
  /** @type {__VLS_StyleScopedClasses['ui-pro-kicker']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-title-inline-kicker']} */ __VLS_ctx
    .phase.id;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.span,
    __VLS_intrinsics.span,
  )(__assign({ class: 'ui-pro-kicker ui-guide-phase-title-inline-name' }));
  /** @type {__VLS_StyleScopedClasses['ui-pro-kicker']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-title-inline-name']} */ __VLS_ctx
    .phase.title;
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.p,
    __VLS_intrinsics.p,
  )(__assign({ class: 'subtle ui-guide-phase-copy' }));
  /** @type {__VLS_StyleScopedClasses['subtle']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-phase-copy']} */ __VLS_ctx.phaseDiagnosticCopy;
} else {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.h1,
    __VLS_intrinsics.h1,
  )(__assign({ class: 'h1 ui-guide-phase-title' }));
...
if (!__VLS_ctx.phase) {
  ...
  /** @type {__VLS_StyleScopedClasses['list']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.li,
    __VLS_intrinsics.li,
  )({});
  ...
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.section,
    __VLS_intrinsics.section,
  )(__assign({ class: 'card ui-pro-panel ui-guide-score-panel' }));
  /** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-score-panel']} */ if (
    __VLS_ctx.isCashFlowPhase
  ) {
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-summary-grid ui-guide-summary-grid-cols-4' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid-cols-4']} */ for (
      var _f = 0, _g = __VLS_vFor(__VLS_ctx.cashFlowHeroSummaryCards);
      _f < _g.length;
      _f++
    ) {
      ...
      __VLS_asFunctionalElement1(
        ...
        __VLS_intrinsics.article,
      )(__assign({ key: summaryCard.id }, { class: 'ui-guide-summary-card' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-summary-card']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-guide-summary-label' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-summary-label']} */ summaryCard.label;
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(
        __assign(
          ...
          {
            class: summaryCard.valueTone
              ? 'ui-guide-summary-value-'.concat(summaryCard.valueTone)
              : '',
          },
        ),
      );
      /** @type {__VLS_StyleScopedClasses['ui-guide-summary-value']} */ summaryCard.valueText;
      if (summaryCard.metaText) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-guide-summary-meta' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-summary-meta']} */ summaryCard.metaText;
      }
      // @ts-ignore
      [
        phase,
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-summary-grid' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid']} */ for (
      var _h = 0, _j = __VLS_vFor(__VLS_ctx.summaryCards);
      _h < _j.length;
      _h++
    ) {
      ...
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-guide-summary-value' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-summary-value']} */ summaryCard.valueText;
      // @ts-ignore
      [summaryCards];
    }
  ...
  if (__VLS_ctx.cashFlowDistortionWarning) {
    ...
    /** @type {__VLS_StyleScopedClasses['ui-status-line']} */ __VLS_ctx.cashFlowDistortionWarning;
  }
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-guide-score-top' }));
  /** @type {__VLS_StyleScopedClasses['ui-guide-score-top']} */ var __VLS_18 =
    ScoreHealthBadge_vue_1.default;
  // @ts-ignore
  var __VLS_19 = __VLS_asFunctionalComponent1(
    __VLS_18,
    new __VLS_18({
  ...
  // @ts-ignore
  var __VLS_24 = __VLS_asFunctionalComponent1(
    __VLS_23,
    new __VLS_23({
      score: __VLS_ctx.globalScoreValue,
      largeGrade: true,
  ...
  __VLS_asFunctionalElement1(
    ...
    __assign(
      { class: 'ui-guide-score-grid' },
      { class: 'ui-guide-score-grid-cols-'.concat(__VLS_ctx.scoreCards.length) },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['ui-guide-score-grid']} */ for (
    var _k = 0, _l = __VLS_vFor(__VLS_ctx.scoreCards);
    _k < _l.length;
    _k++
  ) {
    var card = _l[_k][0];
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.article,
      __VLS_intrinsics.article,
    )(__assign({ key: card.id }, { class: 'ui-guide-score-card' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-score-card-head' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-head']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.h3,
      __VLS_intrinsics.h3,
    )(__assign({ class: 'ui-guide-score-card-title' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-title']} */ card.title;
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-score-card-value-wrap' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-value-wrap']} */ var __VLS_28 =
      ScoreGradeLabel_vue_1.default;
    // @ts-ignore
    var __VLS_29 = __VLS_asFunctionalComponent1(
      __VLS_28,
      new __VLS_28(__assign({ score: card.score }, { class: 'ui-guide-score-card-grade' })),
    );
    var __VLS_30 = __VLS_29.apply(
      void 0,
      __spreadArray(
        [__assign({ score: card.score }, { class: 'ui-guide-score-card-grade' })],
        __VLS_functionalComponentArgsRest(__VLS_29),
        false,
      ),
    );
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-grade']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-score-card-value' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-value']} */ __VLS_ctx.formatNumber(
      card.score,
      0,
    );
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.p,
      __VLS_intrinsics.p,
    )(__assign({ class: 'ui-guide-score-card-copy' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-card-copy']} */ card.description;
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-score-kpi-list' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-list']} */ for (
      var _m = 0, _o = __VLS_vFor(card.kpis);
      _m < _o.length;
      _m++
    ) {
      var kpi = _o[_m][0];
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ key: kpi.id }, { class: 'ui-guide-score-kpi' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-guide-score-kpi-head' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-head']} */ __VLS_asFunctionalElement1(
        __VLS_intrinsics.span,
        __VLS_intrinsics.span,
      )({});
      kpi.label;
      __VLS_asFunctionalElement1(
        ...
        __VLS_intrinsics.strong,
      )(__assign({ class: 'ui-guide-score-kpi-value' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-value']} */ kpi.valueText;
      if (kpi.incomplete) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.span,
          __VLS_intrinsics.span,
          ...
          __assign(
            ...
            { title: 'Faltan cuotas por completar', 'aria-label': 'Faltan cuotas por completar' },
          ),
        );
      ...
      if (kpi.score != null) {
        ...
        // @ts-ignore
        var __VLS_34 = __VLS_asFunctionalComponent1(
          __VLS_33,
          new __VLS_33({
            score: kpi.score,
        ...
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-guide-score-kpi-pending' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-pending']} */
      }
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-guide-score-kpi-hint' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-hint']} */ kpi.hint;
      if (kpi.detailText) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-guide-score-kpi-hint' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-hint']} */ kpi.detailText;
      }
      // @ts-ignore
      [
  ...
  if (__VLS_ctx.isCashFlowPhase) {
    __VLS_asFunctionalElement1(
      ...
      __VLS_intrinsics.details,
    )(__assign({ class: 'ui-guide-context-details' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-context-details']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.summary,
      __VLS_intrinsics.summary,
    )(__assign({ class: 'ui-guide-context-summary' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-context-summary']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-guide-context-summary-title' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-context-summary-title']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.span,
      __VLS_intrinsics.span,
    )(__assign({ class: 'ui-guide-context-summary-copy' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-context-summary-copy']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-guide-context-details-content' }));
    /** @type {__VLS_StyleScopedClasses['ui-guide-context-details-content']} */ if (
      __VLS_ctx.cashFlowContextSummarySections.length
    ) {
      __VLS_asFunctionalElement1(
        __VLS_intrinsics.div,
        __VLS_intrinsics.div,
      )(__assign({ class: 'ui-guide-summary-sections' }));
      /** @type {__VLS_StyleScopedClasses['ui-guide-summary-sections']} */ var _loop_1 = function (
        section,
      ) {
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.section,
          __VLS_intrinsics.section,
        )(__assign({ key: section.id }, { class: 'ui-guide-summary-section' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-summary-section']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )(__assign({ class: 'ui-guide-summary-section-head' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-summary-section-head']} */ __VLS_asFunctionalElement1(
          __VLS_intrinsics.div,
          __VLS_intrinsics.div,
        )({});
        __VLS_asFunctionalElement1(
          __VLS_intrinsics.h3,
          __VLS_intrinsics.h3,
        )(__assign({ class: 'ui-guide-summary-section-title' }));
        /** @type {__VLS_StyleScopedClasses['ui-guide-summary-section-title']} */ section.title;
        if (section.description) {
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.p,
            __VLS_intrinsics.p,
          )(__assign({ class: 'ui-guide-summary-section-copy' }));
          /** @type {__VLS_StyleScopedClasses['ui-guide-summary-section-copy']} */ section.description;
        }
        if (
          section.id === 'cashflow-extraordinary' &&
          __VLS_ctx.extraordinaryEventGroupOptions.length
        ) {
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(__assign({ class: 'ui-guide-section-filter' }));
          /** @type {__VLS_StyleScopedClasses['ui-guide-section-filter']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.span,
            __VLS_intrinsics.span,
          )(__assign({ class: 'ui-guide-section-filter-label' }));
          /** @type {__VLS_StyleScopedClasses['ui-guide-section-filter-label']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.details,
            __VLS_intrinsics.details,
          )(__assign({ class: 'ui-select-popover ui-guide-event-filter' }));
          /** @type {__VLS_StyleScopedClasses['ui-select-popover']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.summary,
            __VLS_intrinsics.summary,
          )(__assign({ class: 'ui-select-popover-trigger ui-guide-event-filter-summary' }));
          /** @type {__VLS_StyleScopedClasses['ui-select-popover-trigger']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-summary']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.span,
            __VLS_intrinsics.span,
          )(__assign({ class: 'ui-select-popover-text ui-guide-event-filter-summary-text' }));
          /** @type {__VLS_StyleScopedClasses['ui-select-popover-text']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-summary-text']} */ __VLS_ctx.selectedExtraordinaryEventGroupLabel;
          __VLS_asFunctionalElement1(
            __VLS_intrinsics.span,
            __VLS_intrinsics.span,
          )(
          ...
          /** @type {__VLS_StyleScopedClasses['ui-select-popover-caret']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-summary-caret']} */ __VLS_asFunctionalElement1(
            __VLS_intrinsics.div,
            __VLS_intrinsics.div,
          )(
            __assign(
              { class: 'ui-select-popover-menu ui-guide-event-filter-menu' },
              { role: 'listbox', 'aria-label': 'Evento' },
            ),
          );
          /** @type {__VLS_StyleScopedClasses['ui-select-popover-menu']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-menu']} */ __VLS_asFunctionalElement1(
                ...
                __assign(
                  {
                    onClick: function () {
                      ...
                      var $event = _a[0];
                      if (!!!__VLS_ctx.phase) return;
                      if (!!!__VLS_ctx.hasDiagnosticPhase) return;
                      if (!__VLS_ctx.isCashFlowPhase) return;
                      if (!__VLS_ctx.cashFlowContextSummarySections.length) return;
                      if (
                        !(
                          section.id === 'cashflow-extraordinary' &&
                          __VLS_ctx.extraordinaryEventGroupOptions.length
              ...
              ),
              {
                class: {
                  'ui-select-popover-option-active ui-guide-event-filter-option-active':
                    __VLS_ctx.selectedExtraordinaryEventGroup === 'all',
                },
              },
            ),
          );
          /** @type {__VLS_StyleScopedClasses['ui-select-popover-option']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-option']} */ /** @type {__VLS_StyleScopedClasses['ui-select-popover-option-active']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-option-active']} */ var _loop_2 =
            function (eventGroup) {
              __VLS_asFunctionalElement1(
                __VLS_intrinsics.button,
                __VLS_intrinsics.button,
                ...
                __assign(
                  ...
                  ),
                  {
                    class: {
                      'ui-select-popover-option-active ui-guide-event-filter-option-active':
                        __VLS_ctx.selectedExtraordinaryEventGroup === eventGroup,
                    },
                  },
                ),
              );
              /** @type {__VLS_StyleScopedClasses['ui-select-popover-option']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-option']} */ /** @type {__VLS_StyleScopedClasses['ui-select-popover-option-active']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-event-filter-option-active']} */ eventGroup;
              // @ts-ignore
              [selectedExtraordinaryEventGroup];
            };
          for (
            var _v = 0, _w = __VLS_vFor(__VLS_ctx.extraordinaryEventGroupOptions);
            _v < _w.length;
            _v++
          ) {
        ...
        __VLS_asFunctionalElement1(
          ...
          __assign(
            ...
            { class: 'ui-guide-summary-grid-cols-'.concat(section.columns) },
          ),
        );
        /** @type {__VLS_StyleScopedClasses['ui-guide-summary-grid']} */ for (
          var _x = 0, _y = __VLS_vFor(section.cards);
          _x < _y.length;
          _x++
        ) {
      ...
      for (
        var _p = 0, _q = __VLS_vFor(__VLS_ctx.cashFlowContextSummarySections);
        _p < _q.length;
        _p++
      ) {
        var section = _q[_p][0];
    ...
    if (__VLS_ctx.phase2DistributionInfoCards.length) {
      ...
      /** @type {__VLS_StyleScopedClasses['ui-guide-score-grid']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-score-grid-cols-1']} */ /** @type {__VLS_StyleScopedClasses['ui-guide-context-score-grid']} */ for (
        var _r = 0, _s = __VLS_vFor(__VLS_ctx.phase2DistributionInfoCards);
        _r < _s.length;
        _r++
      ) {
        var card = _s[_r][0];
        ...
        /** @type {__VLS_StyleScopedClasses['ui-guide-score-kpi-list']} */ for (
          var _t = 0, _u = __VLS_vFor(card.kpis);
          _t < _u.length;
          _t++
        ) {
          var kpi = _u[_t][0];
  ...
  if (__VLS_ctx.store.loading) {
    ...
    __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'alert' }));
    /** @type {__VLS_StyleScopedClasses['alert']} */ __VLS_ctx.store.error;
  }
}
// @ts-ignore
[store, store, store];
