...
var _g = (0, aux_data_1.useAuxDataPage)(),
  loading = _g.loading,
  error = _g.error,
  fxRates = _g.fxRates,
  inflation = _g.inflation,
  fxStates = _g.fxStates,
  inflationStates = _g.inflationStates,
  supportedInflationRegions = _g.supportedInflationRegions,
  formatInflationIndex = _g.formatInflationIndex,
  formatFxRate = _g.formatFxRate;
var regionLabelMap = (0, vue_1.computed)(function () {
  return new Map(
    supportedInflationRegions.value.map(function (region) {
...
/** @type {__VLS_StyleScopedClasses['container']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-page']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.h1,
  __VLS_intrinsics.h1,
)(__assign({ class: 'h1 ui-settings-page-title' }));
/** @type {__VLS_StyleScopedClasses['h1']} */ /** @type {__VLS_StyleScopedClasses['ui-settings-page-title']} */ if (
  __VLS_ctx.error
) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
  ...
  /** @type {__VLS_StyleScopedClasses['alert']} */ /** @type {__VLS_StyleScopedClasses['mt-3']} */ __VLS_ctx.error;
}
__VLS_asFunctionalElement1(
  __VLS_intrinsics.section,
  __VLS_intrinsics.section,
)(__assign({ class: 'card ui-pro-panel ui-settings-accordion-item' }));
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-settings-accordion-item']} */ __VLS_asFunctionalElement1(
  ...
  __assign(
    ...
    { type: 'button', 'aria-expanded': __VLS_ctx.sections.family },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
  __VLS_intrinsics.span,
)(__assign({ class: 'ui-settings-toggle-title' }));
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle-title']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
  __VLS_intrinsics.span,
)(__assign({ class: 'ui-settings-toggle-icon' }, { 'aria-hidden': 'true' }));
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle-icon']} */ __VLS_ctx.sections.family
  ? '-'
  : '+';
if (__VLS_ctx.sections.family) {
  __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-settings-content' }));
  /** @type {__VLS_StyleScopedClasses['ui-settings-content']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-settings-family-tabs' }));
  /** @type {__VLS_StyleScopedClasses['ui-settings-family-tabs']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.button,
    __VLS_intrinsics.button,
  )(
    __assign(
        ...
        __assign(
          {
            onClick: function () {
              ...
              var $event = _a[0];
              if (!__VLS_ctx.sections.family) return;
      ...
      { class: { '!opacity-100': __VLS_ctx.familyTab === 'members' } },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['opacity-60']} */ /** @type {__VLS_StyleScopedClasses['!opacity-100']} */ __VLS_asFunctionalElement1(
    ...
    __assign(
      ...
      { class: { '!opacity-100': __VLS_ctx.familyTab === 'ownerships' } },
    ),
  );
  /** @type {__VLS_StyleScopedClasses['btn']} */ /** @type {__VLS_StyleScopedClasses['opacity-60']} */ /** @type {__VLS_StyleScopedClasses['!opacity-100']} */ if (
    __VLS_ctx.familyTab === 'members'
  ) {
    var __VLS_0 = void 0;
...
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-settings-accordion-item']} */ __VLS_asFunctionalElement1(
  ...
  __assign(
    ...
    { type: 'button', 'aria-expanded': __VLS_ctx.sections.ipc },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
...
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle-icon']} */ __VLS_ctx.sections.ipc
  ? '-'
  : '+';
if (__VLS_ctx.sections.ipc) {
  ...
  /** @type {__VLS_StyleScopedClasses['ui-settings-content']} */ __VLS_asFunctionalElement1(
    __VLS_intrinsics.div,
    __VLS_intrinsics.div,
  )(__assign({ class: 'ui-data-status-grid' }));
  /** @type {__VLS_StyleScopedClasses['ui-data-status-grid']} */ for (
    var _i = 0, _h = __VLS_vFor(__VLS_ctx.inflationStates);
    _i < _h.length;
    _i++
  ) {
    var state = _h[_i][0];
    __VLS_asFunctionalElement1(
      ...
      __VLS_intrinsics.article,
    )(__assign({ key: state.scope }, { class: 'ui-data-status-card' }));
    /** @type {__VLS_StyleScopedClasses['ui-data-status-card']} */ __VLS_asFunctionalElement1(
      __VLS_intrinsics.div,
      __VLS_intrinsics.div,
    )(__assign({ class: 'ui-data-status-card-head' }));
    /** @type {__VLS_StyleScopedClasses['ui-data-status-card-head']} */ __VLS_asFunctionalElement1(
    ...
    if (state.last_error) {
      ...
      /** @type {__VLS_StyleScopedClasses['ui-form-help']} */ /** @type {__VLS_StyleScopedClasses['ui-form-help-error']} */ state.last_error;
    }
    // @ts-ignore
...
/** @type {__VLS_StyleScopedClasses['card']} */ /** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ /** @type {__VLS_StyleScopedClasses['ui-settings-accordion-item']} */ __VLS_asFunctionalElement1(
  ...
  __assign(
    ...
    { type: 'button', 'aria-expanded': __VLS_ctx.sections.fx },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
...
/** @type {__VLS_StyleScopedClasses['ui-settings-toggle-icon']} */ __VLS_ctx.sections.fx
  ? '-'
  : '+';
if (__VLS_ctx.sections.fx) {
  ...
  /** @type {__VLS_StyleScopedClasses['ui-data-status-grid']} */ for (
    var _l = 0, _m = __VLS_vFor(__VLS_ctx.fxStates);
    _l < _m.length;
    _l++
  ) {
    var state = _m[_l][0];
