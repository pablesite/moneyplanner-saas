...
var activePhase = (0, vue_1.computed)(function () { return (0, phases_1.getActiveGuidePhase)(); });
function phaseState(phase) {
    if (phase.progress >= 100)
        return 'done';
    if (phase.id === activePhase.value.id)
        return 'active';
    return 'next';
}
...
var recurrentAnnualIncomeValue = (0, vue_1.computed)(function () {
    return annualIncomeStore.entries.value.reduce(function (acc, entry) { var _a; return entry.incomeType === 'recurrent' ? acc + Number((_a = entry.amountAnnual) !== null && _a !== void 0 ? _a : 0) : acc; }, 0);
});
...
var mostTensePhase = (0, vue_1.computed)(function () { var _a; return (_a = phaseSnapshots.value.slice().sort(function (a, b) { return a.score - b.score; })[0]) !== null && _a !== void 0 ? _a : null; });
var strongestPhase = (0, vue_1.computed)(function () { var _a; return (_a = phaseSnapshots.value.slice().sort(function (a, b) { return b.score - a.score; })[0]) !== null && _a !== void 0 ? _a : null; });
...
function phaseCardStyle(phase) {
    ...
    var tintColor = grade === 'A' || grade === 'B' ? (0, scoreVisuals_1.scoreColor)(score).replace(')', ' / 0.08)') : 'transparent';
    return {
...
__VLS_asFunctionalElement1(__VLS_intrinsics.section, __VLS_intrinsics.section)(__assign({ class: "card ui-pro-panel ui-home-intro" }));
/** @type {__VLS_StyleScopedClasses['card']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-home-intro']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-intro-text" }));
/** @type {__VLS_StyleScopedClasses['ui-home-intro-text']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.h1, __VLS_intrinsics.h1)(__assign({ class: "h1 ui-home-title" }));
/** @type {__VLS_StyleScopedClasses['h1']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-home-title']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "subtle ui-home-copy" }));
/** @type {__VLS_StyleScopedClasses['subtle']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-home-copy']} */ ;
if (__VLS_ctx.mostTensePhase) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "ui-home-focus-line" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-focus-line']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ui-home-focus-label" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-focus-label']} */ ;
    (__VLS_ctx.mostTensePhase.phase.id);
    (__VLS_ctx.mostTensePhase.phase.title);
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ui-home-focus-meta" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-focus-meta']} */ ;
    (__VLS_ctx.mostTensePhase.grade);
    (__VLS_ctx.mostTensePhase.score);
}
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-intro-kpis" }));
/** @type {__VLS_StyleScopedClasses['ui-home-intro-kpis']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-intro-kpi" }, { style: (__VLS_ctx.phaseSummaryStyle(__VLS_ctx.mostTensePhase)) }));
/** @type {__VLS_StyleScopedClasses['ui-home-intro-kpi']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-intro-kpi" }, { style: (__VLS_ctx.phaseSummaryStyle(__VLS_ctx.strongestPhase)) }));
/** @type {__VLS_StyleScopedClasses['ui-home-intro-kpi']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.article, __VLS_intrinsics.article)(__assign({ class: "section card ui-pro-panel" }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)(__assign({ class: "subtle ui-home-block-copy" }));
/** @type {__VLS_StyleScopedClasses['subtle']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-home-block-copy']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.ol, __VLS_intrinsics.ol)(__assign({ class: "ui-home-phase-row" }));
/** @type {__VLS_StyleScopedClasses['ui-home-phase-row']} */ ;
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.phases)); _i < _a.length; _i++) {
    var phase = _a[_i][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.li, __VLS_intrinsics.li)(__assign(__assign(__assign({ key: (phase.id) }, { class: "ui-home-phase-card" }), { style: (__VLS_ctx.phaseCardStyle(phase)) }), { class: ({
            'ui-home-phase-done': __VLS_ctx.phaseState(phase) === 'done',
            'ui-home-phase-active': __VLS_ctx.phaseState(phase) === 'active',
        }) }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-card']} */ ;
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-done']} */ ;
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-active']} */ ;
    var __VLS_0 = void 0;
    /** @ts-ignore @type {typeof __VLS_components.RouterLink | typeof __VLS_components.RouterLink} */
    vue_router_1.RouterLink;
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0(__assign({ class: "ui-home-phase-link" }, { to: (__VLS_ctx.phaseDetailTo(phase.id)) })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ class: "ui-home-phase-link" }, { to: (__VLS_ctx.phaseDetailTo(phase.id)) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-link']} */ ;
    var __VLS_5 = __VLS_3.slots.default;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-head" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-head']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ui-home-phase-id" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-id']} */ ;
    (phase.id);
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-title" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-title']} */ ;
    (phase.title);
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-focus" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-focus']} */ ;
    (phase.focus);
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-donut" }, { style: (__VLS_ctx.phaseDonutStyle(phase)) }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-donut']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-donut-inner" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-donut-inner']} */ ;
    (__VLS_ctx.phaseDisplayProgress(phase));
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-home-phase-cta" }));
    /** @type {__VLS_StyleScopedClasses['ui-home-phase-cta']} */ ;
    // @ts-ignore
    [mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, mostTensePhase, phaseSummaryStyle, phaseSummaryStyle, strongestPhase, strongestPhase, strongestPhase, strongestPhase, strongestPhase, phases, phaseCardStyle, phaseState, phaseState, phaseDetailTo, phaseDisplayProgress, phaseDisplayProgress, phaseDonutStyle,];
    var __VLS_3;
    // @ts-ignore
    [];
}
