        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 3:
              ...
              links = linksRes.data;
              ((_c = (0, ownership_1.buildOwnershipMaps)(links)),
                (assetOwnership = _c.assetOwnership),
                (liabilityOwnership = _c.liabilityOwnership));
              ...
              this.liabilities = (0, ownership_1.attachOwnershipRef)(
                liabilitiesRes.data,
                liabilityOwnership,
              );
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                api_1.coreNetWorthApi.getTimeline({
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              return [3 /*break*/, 5];
            case 3:
              return [4 /*yield*/, api_1.coreNetWorthApi.getLiabilityTimeline(id)];
            case 4:
              _a = _b.sent();
              _b.label = 5;
            case 5:
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 1:
              ...
              if (shouldLoadInvestment) requests.push(api_1.coreNetWorthApi.getInvestmentEvents());
              if (shouldLoadLiquidity) requests.push(api_1.coreNetWorthApi.getLiquidityEvents());
              return [4 /*yield*/, Promise.all(requests)];
            case 2:
              ((_a = _c.sent()),
                (valuationsRes = _a[0]),
                (maybeInvestmentRes = _a[1]),
                (maybeLiquidityRes = _a[2]));
              valuations = valuationsRes.data;
              this.assetValuations = valuations.filter(function (row) {
                return row.asset_ref === id;
              });
              this.investmentEvents = shouldLoadInvestment
                ? maybeInvestmentRes.data.filter(function (row) {
                    return row.asset_ref === id;
                  })
                : [];
              this.liquidityEvents = shouldLoadLiquidity
                ? (shouldLoadInvestment ? maybeLiquidityRes : maybeInvestmentRes).data.filter(
                    function (row) {
                      return row.asset_ref === id;
                    },
                  )
            ...
            case 4:
              ...
              this.liabilityValuations = valuationsRes.data.filter(function (row) {
                return row.liability_ref === id;
              });
              this.liabilityEvents = eventsRes.data.filter(function (row) {
                return row.liability_ref === id;
              });
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 1:
              ...
              ((_a = payload.ownership_id),
                (ownership_id = _a === void 0 ? null : _a),
                (corePayload = __rest(payload, ['ownership_id'])));
              return [4 /*yield*/, api_1.coreNetWorthApi.createAsset(corePayload)];
            case 2:
              res = _e.sent();
              createdAsset =
                (_c = res === null || res === void 0 ? void 0 : res.data) !== null && _c !== void 0
                  ? _c
                  : null;
              if (
                !((_d = res === null || res === void 0 ? void 0 : res.data) === null ||
                _d === void 0
                  ? void 0
                  : _d.id)
              )
              ...
              return [
                4 /*yield*/,
                api_1.premiumOwnershipApi.syncOwnershipLink({
                  target_type: 'asset',
            ...
            case 1:
              ...
              return [
                ...
                api_1.coreNetWorthApi.updateSettings({
                  base_currency:
                    (_b =
                      (_a = payload.base_currency) !== null && _a !== void 0
                        ? _a
                        : this.baseCurrency) !== null && _b !== void 0
                      ? _b
                      : 'EUR',
                  inflation_region:
                    (_d =
                      (_c = payload.inflation_region) !== null && _c !== void 0
                        ? _c
                        : this.inflationRegion) !== null && _d !== void 0
                      ? _d
                      : 'ES',
                }),
              ];
    ...
    updateBaseCurrency: function (currency) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.updateSettings({ base_currency: currency })];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
    ...
    updateInflationRegion: function (region) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.updateSettings({ inflation_region: region })];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
