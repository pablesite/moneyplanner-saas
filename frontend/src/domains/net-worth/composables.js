...
function formatEditAmount(raw, currency) {
    ...
    var _b = s.split('.'), _c = _b[0], i = _c === void 0 ? '' : _c, _d = _b[1], d = _d === void 0 ? '' : _d;
...
function buildEditScheduleFields(item) {
    ...
    return {
        ...
        expense_subcategory_override: (_h = item.expense_subcategory_override) !== null && _h !== void 0 ? _h : '',
        ...
        early_repayment_fee_percent: (_l = item.early_repayment_fee_percent) !== null && _l !== void 0 ? _l : '',
        novation_subrogation_fee_amount: (_m = item.novation_subrogation_fee_amount) !== null && _m !== void 0 ? _m : '',
        linked_products_monthly_cost: (_o = item.linked_products_monthly_cost) !== null && _o !== void 0 ? _o : '',
        cancellation_forecast_enabled: (_p = item.cancellation_forecast_enabled) !== null && _p !== void 0 ? _p : false,
        cancellation_date: (_q = item.cancellation_date) !== null && _q !== void 0 ? _q : '',
        cancellation_fee_amount: (_r = item.cancellation_fee_amount) !== null && _r !== void 0 ? _r : '',
    };
}
function buildEditInvestmentFields(item) {
    var _a, _b, _c, _d, _e, _f, _g;
    return {
        investment_contribution_mode: (_a = item.investment_contribution_mode) !== null && _a !== void 0 ? _a : 'one_time',
        investment_contribution_frequency: (_b = item.investment_contribution_frequency) !== null && _b !== void 0 ? _b : 'monthly',
        investment_contribution_currency: (_c = item.investment_contribution_currency) !== null && _c !== void 0 ? _c : '',
        monthly_contribution_amount: (_d = item.monthly_contribution_amount) !== null && _d !== void 0 ? _d : '',
        market_value_override: (_e = item.market_value_override) !== null && _e !== void 0 ? _e : '',
        market_value_override_date: (_f = item.market_value_override_date) !== null && _f !== void 0 ? _f : '',
...
function buildEditValuationFields(item) {
    ...
    return {
        ...
        amortization_term_years: (_b = item.amortization_term_years) !== null && _b !== void 0 ? _b : '',
        valuation_model: (_c = item.valuation_model) !== null && _c !== void 0 ? _c : 'manual',
        land_value_share_percent: (_d = item.land_value_share_percent) !== null && _d !== void 0 ? _d : '',
        land_annual_appreciation_percent: (_e = item.land_annual_appreciation_percent) !== null && _e !== void 0 ? _e : '',
        building_annual_depreciation_percent: (_f = item.building_annual_depreciation_percent) !== null && _f !== void 0 ? _f : '',
        improvements: (_g = item.improvements) !== null && _g !== void 0 ? _g : [],
    };
}
function buildEditInitialPayload(item) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
    return __assign(__assign(__assign(__assign({ name: (_a = item.name) !== null && _a !== void 0 ? _a : '', category: (_b = item.category) !== null && _b !== void 0 ? _b : '', subcategory: (_c = item.subcategory) !== null && _c !== void 0 ? _c : '', amount: formatEditAmount(item.amount, (_d = item.currency) !== null && _d !== void 0 ? _d : 'EUR'), annual_interest_tae: (_e = item.annual_interest_tae) !== null && _e !== void 0 ? _e : '', estimated_average_balance_for_interest: (_f = item.estimated_average_balance_for_interest) !== null && _f !== void 0 ? _f : '' }, buildEditScheduleFields(item)), buildEditInvestmentFields(item)), buildEditValuationFields(item)), { notes: (_g = item.notes) !== null && _g !== void 0 ? _g : '', currency: (_h = item.currency) !== null && _h !== void 0 ? _h : '', tracking_mode: (_j = item.tracking_mode) !== null && _j !== void 0 ? _j : 'manual', is_active: (_k = item.is_active) !== null && _k !== void 0 ? _k : true, ownership_id: (_l = item.ownership_ref) !== null && _l !== void 0 ? _l : null, financed_asset_id: (_m = item.financed_asset_ref) !== null && _m !== void 0 ? _m : null });
}
...
function useNetWorthViewState() {
    ...
    (0, vue_1.watch)(function () { return store.baseCurrency; }, function (c) {
        if (c !== 'EUR' && valueMode.value === 'real')
            valueMode.value = 'nominal';
    });
    (0, vue_1.watch)(function () { var _a; return (_a = store.summary) === null || _a === void 0 ? void 0 : _a.inflation_base_period; }, function () {
    ...
    function submitAsset(payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, store.createAsset(payload)];
                    case 1:
                        _a.sent();
    ...
    function submitEdit(payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!editItem.value || !editKind.value)
                            return [2 /*return*/];
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, store.updateLiability(id, payload)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    var modeLabel = function () {
        var _a;
        if (valueMode.value === 'nominal')
            return 'Nominal (euros de hoy)';
    ...
    var realBaseLabel = (0, vue_1.computed)(function () { var _a; return ((_a = store.summary) === null || _a === void 0 ? void 0 : _a.inflation_base_period) ? "Base: ".concat(store.summary.inflation_base_period) : ''; });
    var summaryAssets = (0, vue_1.computed)(function () { var _a, _b; return valueMode.value === 'real' ? (_a = store.summary) === null || _a === void 0 ? void 0 : _a.total_assets_real : (_b = store.summary) === null || _b === void 0 ? void 0 : _b.total_assets; });
    var summaryLiabilities = (0, vue_1.computed)(function () {
        var _a, _b;
        return valueMode.value === 'real'
            ? (_a = store.summary) === null || _a === void 0 ? void 0 : _a.total_liabilities_real
            : (_b = store.summary) === null || _b === void 0 ? void 0 : _b.total_liabilities;
    });
    var summaryNetWorth = (0, vue_1.computed)(function () { var _a, _b; return valueMode.value === 'real' ? (_a = store.summary) === null || _a === void 0 ? void 0 : _a.net_worth_real : (_b = store.summary) === null || _b === void 0 ? void 0 : _b.net_worth; });
    var byCategoryChart = (0, vue_1.computed)(function () {
        var _a, _b, _c, _d;
        return (0, charts_1.buildByCategoryChart)(valueMode.value === 'real'
            ? __assign(__assign({}, store.summary), { assets_by_category: (_b = (_a = store.summary) === null || _a === void 0 ? void 0 : _a.assets_by_category_real) !== null && _b !== void 0 ? _b : {}, liabilities_by_category: (_d = (_c = store.summary) === null || _c === void 0 ? void 0 : _c.liabilities_by_category_real) !== null && _d !== void 0 ? _d : {} }) : store.summary, store.baseCurrency);
    });
    var categoryLabelMap = (0, vue_1.computed)(function () {
        var m = new Map();
        assetCategories.forEach(function (c) { return m.set(c.value, c.label); });
        liabilityCategories.forEach(function (c) { return m.set(c.value, c.label); });
        return m;
    });
    ...
    var byCategoryLabels = (0, vue_1.computed)(function () {
        return byCategoryFiltered.value.map(function (r) { var _a; return (_a = categoryLabelMap.value.get(r.key)) !== null && _a !== void 0 ? _a : r.key; });
    });
    var byCategoryKeys = (0, vue_1.computed)(function () { return byCategoryFiltered.value.map(function (r) { return r.key; }); });
    var byCategoryAssets = (0, vue_1.computed)(function () { return byCategoryFiltered.value.map(function (r) { return r.a; }); });
    var byCategoryLiabilities = (0, vue_1.computed)(function () { return byCategoryFiltered.value.map(function (r) { return r.l; }); });
    var byCategoryUnit = (0, vue_1.computed)(function () { return byCategoryChart.value.unit; });
    ...
    var summaryAssetBackedLiabilities = (0, vue_1.computed)(function () {
        var _a, _b;
        return valueMode.value === 'real'
            ? (_a = summaryExtended.value) === null || _a === void 0 ? void 0 : _a.liabilities_asset_backed_real
            : (_b = summaryExtended.value) === null || _b === void 0 ? void 0 : _b.liabilities_asset_backed;
    });
    var summaryUnbackedLiabilities = (0, vue_1.computed)(function () {
        var _a, _b;
        return valueMode.value === 'real'
            ? (_a = summaryExtended.value) === null || _a === void 0 ? void 0 : _a.liabilities_unbacked_real
            : (_b = summaryExtended.value) === null || _b === void 0 ? void 0 : _b.liabilities_unbacked;
    });
    (0, vue_1.onMounted)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.fetchSettings()];
                case 1:
                    _a.sent();
