...
vitest_1.vi.mock('@/stores/netWorth', function () {
  return {
...
(0, vitest_1.describe)('useNetWorthViewState (core)', function () {
  (0, vitest_1.beforeEach)(function () {
    ...
    vitest_1.vi.stubGlobal(
      'confirm',
      vitest_1.vi.fn(function () {
        return true;
      }),
    );
  });
  (0, vitest_1.it)('loads store on mount and maps submit/delete flows', function () {
        ...
        switch (_a.label) {
          case 0:
            store = (0, vue_1.reactive)({
              ...
              fetchSettings: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
              ...
              refreshAll: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              createAsset: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              createLiability: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              deleteSnapshot: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              updateAsset: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              updateLiability: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
  ...
  (0, vitest_1.it)(
    'reacts to mode changes, computes labels, edit payloads and error messages',
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
          ...
          switch (_g.label) {
            case 0:
              store = (0, vue_1.reactive)({
                ...
                error: '{"detail":"boom"}',
                baseCurrency: 'EUR',
                summary: __assign(__assign({}, makeSummary()), {
                  assets_by_category_real: {
                    cash: '9',
                    mortgage: '0',
                  },
              ...
              (0, vitest_1.expect)(
                (_a = state.editInitial.value) === null || _a === void 0 ? void 0 : _a.amount,
              ).toBe('1000.5');
              (0, vitest_1.expect)(
                (_b = state.editInitial.value) === null || _b === void 0
                  ? void 0
                  : _b.financed_asset_id,
              ).toBe(33);
              (0, vitest_1.expect)(
                (_c = state.editInitial.value) === null || _c === void 0
                  ? void 0
                  : _c.valuation_model,
              ).toBe('real_estate_auto');
              (0, vitest_1.expect)(
                (_d = state.editInitial.value) === null || _d === void 0
                  ? void 0
                  : _d.land_value_share_percent,
              ).toBe('42.3');
              (0, vitest_1.expect)(
                (_e = state.editInitial.value) === null || _e === void 0
                  ? void 0
                  : _e.land_annual_appreciation_percent,
              ).toBe('3');
              (0, vitest_1.expect)(
                (_f = state.editInitial.value) === null || _f === void 0
                  ? void 0
                  : _f.building_annual_depreciation_percent,
              ).toBe('1');
            ...
            case 2:
              _g.sent();
              (0, vitest_1.expect)(store.updateLiability).toHaveBeenCalledWith(2, {
                name: 'L2',
                financed_asset_id: 88,
              });
