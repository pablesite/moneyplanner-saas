...
(0, vitest_1.describe)('net-worth page refactor composables', function () {
  ...
  (0, vitest_1.it)(
    'computes ownership options, fractions and resets filter in real mode',
    function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              ownership = (0, useNetWorthOwnership_1.useNetWorthOwnership)({
                ownerships: ownerships,
                valueMode: valueMode,
              });
              (0, vitest_1.expect)(
                ownership.ownershipOptions.value.map(function (row) {
                  return row.label;
                }),
              ).toEqual(['Ana', 'Luis']);
  ...
  (0, vitest_1.it)(
    'derives page metrics and workspace rows from ownership-filtered data',
    function () {
      ...
      var metrics = (0, useNetWorthPageMetrics_1.useNetWorthPageMetrics)({
        ...
        matchesOwnershipFilter: function (ownershipRef) {
          return ownershipRef === 1 || ownershipRef === 2;
        },
  ...
  (0, vitest_1.it)('builds ownership-scoped timeline rows and chart metadata', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var ownershipFilter,
        ...
        switch (_b.label) {
          case 0:
            ...
            timeline = (0, useNetWorthTimeline_1.useNetWorthTimeline)({
              ownershipFilter: ownershipFilter,
              selectedPosition: (0, vue_1.computed)(function () {
                return null;
              }),
              selectedPositionType: selectedPositionType,
              selectedPositionId: selectedPositionId,
              ...
              timelineRows: (0, vue_1.computed)(function () {
                return [
                  {
                    date: '2025-01-01',
                    label: 'ene 25',
              ...
              availablePositionRows: (0, vue_1.computed)(function () {
                return [];
              }),
              allAssetPositionRows: (0, vue_1.computed)(function () {
                return [
                  {
                    id: 1,
                    type: 'asset',
              ...
              allLiabilityPositionRows: (0, vue_1.computed)(function () {
                return [
                  {
                    id: 3,
                    type: 'liability',
              ...
              positionTimelineRows: (0, vue_1.computed)(function () {
                return [];
              }),
              ...
              getTimelineMetricValue: function (row) {
                return row.netWorth;
              },
            });
            return [4 /*yield*/, (0, vue_1.nextTick)()];
          ...
          case 3:
            ...
            (0, vitest_1.expect)(
              timeline.visibleTimelineRows.value.map(function (row) {
                return row.value;
              }),
            ).toEqual([45, 67.5]);
            (0, vitest_1.expect)(
              (_a =
                timeline.timelineChartPoints.value[
                  timeline.timelineChartPoints.value.length - 1
                ]) === null || _a === void 0
                ? void 0
                : _a.fullLabel,
            ).toBe('febrero de 2025');
            (0, vitest_1.expect)(timeline.timelineRangeCaption.value).toBe(
              'enero de 2025 - febrero de 2025',
            );
            (0, vitest_1.expect)(timeline.timelineSummaryLabel.value).toBe(
              'Ultimo patrimonio neto',
            );
