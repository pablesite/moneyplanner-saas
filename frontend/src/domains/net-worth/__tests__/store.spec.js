...
var mocks = vitest_1.vi.hoisted(function () { return ({
    ...
    buildByCategoryChart: vitest_1.vi.fn(function () { return ({ labels: [], assets: [], liabilities: [] }); }),
    toApiErrorMessage: vitest_1.vi.fn(function () { return 'mapped-error'; }),
}); });
vitest_1.vi.mock('@/domains/net-worth/api', function () { return ({
    coreNetWorthApi: mocks.coreNetWorthApi,
    premiumOwnershipApi: mocks.premiumOwnershipApi,
}); });
vitest_1.vi.mock('@/domains/net-worth/charts', function () { return ({
    buildByCategoryChart: mocks.buildByCategoryChart,
}); });
vitest_1.vi.mock('@/lib/errors', function () { return ({
...
(0, vitest_1.describe)('net worth store (core)', function () {
    ...
    (0, vitest_1.it)('refreshes summary datasets', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
    ...
    (0, vitest_1.it)('handles snapshot creation errors and resets loading', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('maps refresh errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('creates and updates assets and liabilities', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.createAsset).toHaveBeenCalledWith({ name: 'Cash' });
                    return [4 /*yield*/, store.updateAsset(11, { name: 'Cash 2' })];
                case 2:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.updateAsset).toHaveBeenCalledWith(11, { name: 'Cash 2' });
                    return [4 /*yield*/, store.archiveAsset(11)];
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.updateAsset).toHaveBeenCalledWith(11, { is_active: false });
                ...
                case 5:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.createLiability).toHaveBeenCalledWith({ name: 'Debt' });
                    return [4 /*yield*/, store.updateLiability(22, { name: 'Debt 2' })];
                case 6:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.updateLiability).toHaveBeenCalledWith(22, { name: 'Debt 2' });
                    return [4 /*yield*/, store.archiveLiability(22)];
                case 7:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.updateLiability).toHaveBeenCalledWith(22, { is_active: false });
    ...
    (0, vitest_1.it)('deletes snapshots and maps delete errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('fetches settings and updates base currency', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('fetches timeline with category filter', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)((_a = store.timeline) === null || _a === void 0 ? void 0 : _a.filters.asset_category).toBe('investments');
                    (0, vitest_1.expect)(store.timelineLoading).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('fetches position timeline for assets and liabilities', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)((_a = store.positionTimeline) === null || _a === void 0 ? void 0 : _a.position_id).toBe(4);
                    return [4 /*yield*/, store.fetchPositionTimeline('liability', 7)];
                case 2:
                    _c.sent();
                    (0, vitest_1.expect)(mocks.coreNetWorthApi.getLiabilityTimeline).toHaveBeenCalledWith(7);
                    (0, vitest_1.expect)((_b = store.positionTimeline) === null || _b === void 0 ? void 0 : _b.position_type).toBe('liability');
                    (0, vitest_1.expect)(store.positionTimelineLoading).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('fetches position activity for asset and liability modes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('maps settings and update errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
