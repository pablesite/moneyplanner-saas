...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "section card ui-pro-panel" }));
/** @type {__VLS_StyleScopedClasses['section']} */ ;
/** @type {__VLS_StyleScopedClasses['card']} */ ;
/** @type {__VLS_StyleScopedClasses['ui-pro-panel']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.h2, __VLS_intrinsics.h2)(__assign({ class: "mt-0 text-base" }));
/** @type {__VLS_StyleScopedClasses['mt-0']} */ ;
/** @type {__VLS_StyleScopedClasses['text-base']} */ ;
if (__VLS_ctx.snapshots.length) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.ul, __VLS_intrinsics.ul)(__assign({ class: "m-0 grid list-none gap-2 pl-0" }));
    ...
    var _loop_1 = function (snapshot) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.li, __VLS_intrinsics.li)(__assign({ key: (snapshot.id) }, { class: "ui-nw-snapshot-row" }));
        /** @type {__VLS_StyleScopedClasses['ui-nw-snapshot-row']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "min-w-0" }));
        ...
        (__VLS_ctx.formatMoney(snapshot.total_assets, 2));
        (__VLS_ctx.displayCurrencyUnit(snapshot.base_currency));
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
                ...
                // @ts-ignore
                [snapshots, snapshots, formatMoney, formatMoney, formatMoney, displayCurrencyUnit, displayCurrencyUnit, displayCurrencyUnit, confirmDeleteSnapshot,];
            } }, { class: "icon-btn disabled:cursor-not-allowed disabled:opacity-50" }), { type: "button", disabled: (__VLS_ctx.loading), 'aria-label': "Eliminar snapshot", title: "Eliminar snapshot" }));
