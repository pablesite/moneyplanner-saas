...
(0, vitest_1.describe)('ItemDisplayRow', function () {
    ...
    (0, vitest_1.it)('emits edit, archive and delete events with item id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    _d.sent();
                    (0, vitest_1.expect)((_a = wrapper.emitted('edit')) === null || _a === void 0 ? void 0 : _a[0]).toEqual([11]);
                    (0, vitest_1.expect)((_b = wrapper.emitted('archive')) === null || _b === void 0 ? void 0 : _b[0]).toEqual([11]);
                    (0, vitest_1.expect)((_c = wrapper.emitted('delete')) === null || _c === void 0 ? void 0 : _c[0]).toEqual([11]);
