...
(0, vitest_1.describe)('ItemForm (saas)', function () {
    (0, vitest_1.it)('submits normalized payload including ownership and financed asset', function () { return __awaiter(void 0, void 0, void 0, function () {
        var onSubmit, wrapper, selects, categorySelect, currencySelect, ownershipSelect, financedAssetSelect;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    ownershipSelect = selects.find(function (s) { return s.text().includes('Selecciona titularidad'); });
                    financedAssetSelect = selects.find(function (s) { return s.text().includes('No financia'); });
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, wrapper.find('input[placeholder="Importe"]').setValue('1.234,56')];
                case 4:
                    _a.sent();
                ...
                case 9:
                    _a.sent();
                    (0, vitest_1.expect)(onSubmit).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                        name: 'Caja',
                        category: 'other',
                        currency: 'EUR',
                        amount: '1234.56',
    ...
    (0, vitest_1.it)('links term months and expected end date for liabilities', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('shows amount validation errors', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('shows required field message and blocks submit when name is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    currencySelect = selects.find(function (s) { return s.text().includes('Selecciona moneda'); });
                    return [4 /*yield*/, currencySelect.setValue('EUR')];
                case 3:
                    _a.sent();
    ...
    (0, vitest_1.it)('allows straight-line amortization without initial purchase value when amount is provided', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Portatil')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                    return [4 /*yield*/, selects[0].setValue('furnishings')];
                ...
                case 5:
                    _a.sent();
                    amortizationMethodSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Sin amortizacion') && s.text().includes('Lineal'); });
    ...
    (0, vitest_1.it)('shows degressive residual hint for sports equipment furnishings', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper, selects;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(wrapper.text()).toContain('decreciente + residual por subcategoria');
                    (0, vitest_1.expect)(wrapper.text()).toContain('suelo residual del 20%');
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('does not render initial purchase value field for furnishings amortization', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper, selects;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('forces non-amortized method for jewelry furnishings', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    amortizationMethodSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Sin amortizacion (joyeria)'); });
                    ...
                    (0, vitest_1.expect)(wrapper.text()).toContain("En 'Joyeria' no se aplica amortizacion automatica.");
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('submits sports equipment without manual term years', function () { return __awaiter(void 0, void 0, void 0, function () {
        var onSubmit, wrapper, selects, currencySelect, amortizationMethodSelect, payload;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 5:
                    ...
                    amortizationMethodSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('decreciente + residual por subcategoria'); });
                    return [4 /*yield*/, amortizationMethodSelect.setValue('straight_line')];
                case 6:
                    _a.sent();
                    (0, vitest_1.expect)(wrapper.text()).not.toContain('Plazo de amortizacion (anos) obligatorio');
                    return [4 /*yield*/, wrapper.find('button.btn-primary').trigger('click')];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, (0, test_utils_1.flushPromises)()];
    ...
    (0, vitest_1.it)('requires deposit duration for short-term deposits', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Deposito Facto')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                ...
                case 8:
                    ...
                    depositTermSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Selecciona duración'); });
    ...
    (0, vitest_1.it)('updates estimated average balance label with selected currency', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Earn Binance')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                    return [4 /*yield*/, selects[0].setValue('cash')];
    ...
    (0, vitest_1.it)('submits primary home auto valuation parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    modelSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Automatica (suelo + construccion)'); });
    ...
    (0, vitest_1.it)('submits primary home improvements along with auto valuation', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent();
                    return [4 /*yield*/, wrapper.find('input[placeholder="Ej: Reforma cocina"]').setValue('Reforma cocina')];
                case 8:
                    _a.sent();
                    dateInputs = wrapper.findAll('input[type="date"]');
    ...
    (0, vitest_1.it)('uses default term years, disables capitalized interest with TAE 0, and shows discard label for new improvements', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    _a.sent();
                    reformAmortizationSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Sin amortizacion') && s.text().includes('Lineal'); });
                ...
                case 8:
                    ...
                    (0, vitest_1.expect)(wrapper.text()).toContain('Disponible solo cuando la TAE de financiacion es mayor que 0.');
                    (0, vitest_1.expect)(wrapper.text()).toContain('Descartar reforma');
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('autofills valuation parameters when selecting a profile and allows custom edits', function () { return __awaiter(void 0, void 0, void 0, function () {
        var wrapper, selects, currencySelect, modelSelect, profileSelect, landInput, growthInput, depreciationInput;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wrapper = (0, test_utils_1.mount)(ItemForm_vue_1.default, {
                ...
                case 7:
                    ...
                    profileSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Conservador') && s.text().includes('Personalizado'); });
    ...
    (0, vitest_1.it)('detects conservative profile in edit mode when backend returns trailing zeros', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('limits land share and land appreciation to one decimal', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('allows typing intermediate decimal values in land appreciation input', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, vitest_1.it)('does not require schedule fields for credit card liabilities', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Tarjeta ECI')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, wrapper.find('input[placeholder="TAE anual (%)"]').setValue('19.5')];
                case 5:
                    _a.sent();
    ...
    (0, vitest_1.it)('submits mortgage cancellation forecast fields', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Hipoteca casa')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                ...
                case 6:
                    _a.sent();
                    cancellationToggle = wrapper
                        .findAll('input[type="checkbox"]')
                        .find(function (input) { var _a, _b; return (_b = (_a = input.element.closest('label')) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.includes('prevision de cancelacion'); });
                ...
                case 8:
                    _a.sent();
                    cancellationDetails = wrapper
                        .findAll('details')
                        .find(function (details) { return details.find('summary').text().includes('Prevision de cancelacion'); });
                    return [4 /*yield*/, cancellationDetails.find('input[placeholder="Opcional"]').setValue('450')];
                case 9:
                    _a.sent();
                    return [4 /*yield*/, wrapper.find('button.btn-primary').trigger('click')];
                case 10:
    ...
    (0, vitest_1.it)('maps non-habitual real estate usage to rental subcategory on submit', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Apartamento playa')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                    return [4 /*yield*/, selects[0].setValue('real_estate')];
                ...
                case 3:
                    ...
                    usageSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Propio') && s.text().includes('Alquiler'); });
    ...
    (0, vitest_1.it)('allows auto valuation fields for non-habitual real estate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var onSubmit, wrapper, selects, currencySelect, modelSelect;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('defaults auto valuation profile to dynamic values', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    profileSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Dinamico') && s.text().includes('Personalizado'); });
                    (0, vitest_1.expect)(profileSelect.element.value).toBe('dynamic');
                    (0, vitest_1.expect)(wrapper.find('input[placeholder="Ej: 3"]').element.value).toBe('8');
                    (0, vitest_1.expect)(wrapper.find('input[placeholder="Ej: 1"]').element.value).toBe('0.2');
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('submits periodic contribution fields for investment assets', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('Reserva vivienda')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                ...
                case 3:
                    ...
                    modeSelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Aportacion unica') && s.text().includes('Aportacion periodica'); });
    ...
    (0, vitest_1.it)('allows indefinite periodic investment with weekly contribution', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wrapper.find('input[placeholder="Nombre"]').setValue('ETF Physical Gold')];
                case 1:
                    _a.sent();
                    selects = wrapper.findAll('select');
                    return [4 /*yield*/, selects[0].setValue('investments')];
                ...
                case 4:
                    _a.sent();
                    frequencySelect = wrapper
                        .findAll('select')
                        .find(function (s) { return s.text().includes('Mensual') && s.text().includes('Semanal'); });
