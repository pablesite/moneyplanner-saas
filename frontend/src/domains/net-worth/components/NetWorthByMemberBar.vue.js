...
var data = (0, vue_1.computed)(function () { return ({
    ...
    datasets: [
        ...
        {
            label: 'Pasivos',
            data: props.liabilities.map(function (v) { return -Math.abs(v); }),
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "nw-bar-chart-member" }));
/** @type {__VLS_StyleScopedClasses['nw-bar-chart-member']} */ ;
var __VLS_0;
