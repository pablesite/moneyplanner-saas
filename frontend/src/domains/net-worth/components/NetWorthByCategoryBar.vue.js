...
function assetColorFor(label) {
    var _a;
    return (_a = ASSET_COLOR_BY_LABEL[labelKey(label)]) !== null && _a !== void 0 ? _a : 'rgba(92, 192, 255, 0.9)';
}
function liabilityColorFor(label) {
    var _a;
    return (_a = LIAB_COLOR_BY_LABEL[labelKey(label)]) !== null && _a !== void 0 ? _a : 'rgba(255, 99, 132, 0.85)';
}
...
function formatTickCompact(value) {
    ...
    if (v >= 1000000)
        return "".concat(formatMoney(v / 1000000, 1), "M");
    if (v >= 1000)
        return "".concat(formatMoney(v / 1000, 1), "k");
    ...
    datasets: [
        {
            ...
            backgroundColor: orderedLabels.value.map(function (l) { return assetColorFor(l); }),
            borderRadius: 8,
            barThickness: 18,
        },
        {
            label: 'Pasivos',
            data: orderedLiabilities.value.map(function (v) { return -Math.abs(v); }),
            backgroundColor: orderedLabels.value.map(function (l) { return liabilityColorFor(l); }),
            borderRadius: 8,
            barThickness: 18,
        },
    ],
...
var assetRank = new Map(ASSET_ORDER.map(function (k, i) { return [k, i]; }));
var liabRank = new Map(LIAB_ORDER.map(function (k, i) { return [k, i]; }));
var orderedIndex = (0, vue_1.computed)(function () {
    var indexed = props.labels.map(function (label, i) { return ({ label: label, i: i }); });
...
var orderedLabels = (0, vue_1.computed)(function () { return orderedIndex.value.map(function (x) { return x.label; }); });
var orderedAssets = (0, vue_1.computed)(function () { return orderedIndex.value.map(function (x) { var _a; return (_a = props.assets[x.i]) !== null && _a !== void 0 ? _a : 0; }); });
var orderedLiabilities = (0, vue_1.computed)(function () {
    return orderedIndex.value.map(function (x) { var _a; return (_a = props.liabilities[x.i]) !== null && _a !== void 0 ? _a : 0; });
});
var options = (0, vue_1.computed)(function () { return ({
    ...
    plugins: {
        ...
        tooltip: {
            callbacks: {
                title: function (items) { var _a, _b; return (_b = (_a = items === null || items === void 0 ? void 0 : items[0]) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : ''; },
                label: function (ctx) {
                    var _a;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "nw-bar-wrap" }));
/** @type {__VLS_StyleScopedClasses['nw-bar-wrap']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "nw-bar-chart-category" }));
/** @type {__VLS_StyleScopedClasses['nw-bar-chart-category']} */ ;
var __VLS_0;
