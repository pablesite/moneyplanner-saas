...
function summarizeCounterparts(transaction, selectedAccountId, selectedEntryId) {
  var counterparts = transaction.entries.filter(function (entry) {
    return entry.account_id !== selectedAccountId && entry.id !== selectedEntryId;
  });
...
function useNetWorthAccountingActivity(params) {
  ...
  var selectedPositionUsesAccounting = (0, vue_1.computed)(function () {
    var _a;
    return (
      ((_a = params.selectedPositionSource.value) === null || _a === void 0
        ? void 0
        : _a.tracking_mode) === 'accounting'
    );
  });
  var selectedPositionAccountingIntegrationState = (0, vue_1.computed)(function () {
    var _a, _b;
    return (_b =
      (_a = params.selectedPositionSource.value) === null || _a === void 0
        ? void 0
        : _a.accounting_integration_state) !== null && _b !== void 0
      ? _b
      : null;
  });
  var selectedPositionAccountingAccountId = (0, vue_1.computed)(function () {
    var _a, _b;
    return (_b =
      (_a = params.selectedPositionSource.value) === null || _a === void 0
        ? void 0
        : _a.accounting_account_id) !== null && _b !== void 0
      ? _b
      : null;
  });
  ...
  var showAccountingActivityBlock = (0, vue_1.computed)(function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            accountingActivityYear.value = new Date().getFullYear();
            if (
              source.accounting_integration_state === 'needs_review' ||
              ...
              .flatMap(function (transaction) {
                return transaction.entries
                  .filter(function (entry) {
                    return entry.account_id === source.accounting_account_id;
                  })
                  .map(function (entry) {
                    var _a;
                    return {
                      ...
                      counterpartLabel: summarizeCounterparts(
                        transaction,
                        (_a = source.accounting_account_id) !== null && _a !== void 0 ? _a : 0,
                        entry.id,
                      ),
