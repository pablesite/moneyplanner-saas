...
function useNetWorthPageActions(params) {
  ...
  function submitAssetFromView(payload) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, params.submitAsset(payload)];
          case 1:
            _a.sent();
  ...
  function submitLiabilityFromView(payload) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, params.submitLiability(payload)];
          case 1:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [2 /*return*/];
          case 2:
            return [4 /*yield*/, applyTimelineCategoryFilter(payload.key, payload.type)];
          case 3:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  function onPositionSelection(event) {
    ...
    var rawValue =
      (_a = target === null || target === void 0 ? void 0 : target.value) !== null && _a !== void 0
        ? _a
        : '';
    if (!rawValue) {
      resetPositionSelection();
    ...
    var row = params.availablePositionRows.value.find(function (item) {
  ...
  var assetCreateInitial = (0, vue_1.computed)(function () {
    return params.createAssetCategory.value
      ? { category: params.createAssetCategory.value }
      : undefined;
  });
