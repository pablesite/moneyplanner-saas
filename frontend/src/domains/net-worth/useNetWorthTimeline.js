...
function useNetWorthTimeline(params) {
  ...
  var ownershipScopedRows = (0, vue_1.computed)(function () {
    ...
    return __spreadArray(
      __spreadArray([], params.allAssetPositionRows.value, true),
      params.allLiabilityPositionRows.value,
      true,
    );
  });
  function ensureOwnershipTimelineCache(rows) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            missingRows = rows.filter(function (row) {
              return !ownershipTimelineCache.value[positionCacheKey(row.type, row.id)];
            });
            if (!missingRows.length) return [2 /*return*/];
                    ...
                    return __generator(this, function (_b) {
                      switch (_b.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            net_worth_1.coreNetWorthApi.getAssetTimeline(row.id),
                          ];
                        case 1:
                          _a = _b.sent();
                          return [3 /*break*/, 4];
                        case 2:
                          return [
                            4 /*yield*/,
                            net_worth_1.coreNetWorthApi.getLiabilityTimeline(row.id),
                          ];
                        case 3:
                          _a = _b.sent();
                          _b.label = 4;
          ...
          case 3:
            ...
            params.setStoreError(
              error_1 instanceof Error ? error_1.message : 'No se pudo cargar la timeline filtrada',
            );
            return [3 /*break*/, 5];
          case 4:
  ...
  (0, vue_1.watch)(
    function () {
      return ownershipScopedRows.value
        .map(function (row) {
          return positionCacheKey(row.type, row.id);
        })
        .join('|');
    },
    function () {
  ...
  var ownershipTimelineRows = (0, vue_1.computed)(function () {
    ...
    for (var _i = 0, _b = ownershipScopedRows.value; _i < _b.length; _i++) {
      ...
      for (var _c = 0, _d = cached.rows; _c < _d.length; _c++) {
        var point = _d[_c];
        var current =
          (_a = byDate.get(point.date)) !== null && _a !== void 0
            ? _a
            : {
                date: point.date,
                label: point.label,
  ...
  var displayedTimelineRows = (0, vue_1.computed)(function () {
    if (params.selectedPosition.value) {
      return params.positionTimelineRows.value.map(function (row) {
        return {
          date: row.date,
          label: row.label,
          value: row.value,
    ...
    return activeTimelineRows.value.map(function (row) {
      return {
        date: row.date,
        label: row.label,
  ...
  var currentTimelineSeriesColor = (0, vue_1.computed)(function () {
    var _a, _b;
    if (
      ((_a = params.selectedPosition.value) === null || _a === void 0 ? void 0 : _a.type) ===
      'liability'
    )
      return '#ff4d73';
    if (params.selectedTimelineCategoryType.value === 'liability') return '#ff4d73';
    if (
      ((_b = params.selectedPosition.value) === null || _b === void 0 ? void 0 : _b.type) ===
      'asset'
    )
      return '#2dd4bf';
    return '#4cc3ff';
  ...
  var timelineDefaultWindow = (0, vue_1.computed)(function () {
    ...
    if (!Number.isFinite(count)) return { start: 0, end: end };
  ...
  var timelineWindow = (0, vue_1.computed)(function () {
    ...
    var source =
      (_a = params.customTimelineWindow.value) !== null && _a !== void 0
        ? _a
        : timelineDefaultWindow.value;
  ...
  var timelineChartRows = (0, vue_1.computed)(function () {
    return visibleTimelineRows.value.slice(
      timelineWindow.value.start,
      timelineWindow.value.end + 1,
    );
  });
  var timelineChartPoints = (0, vue_1.computed)(function () {
    return timelineChartRows.value.map(function (row) {
      return {
        date: row.date,
  ...
  var latestTimelineChartPoint = (0, vue_1.computed)(function () {
    var _a;
    return (_a = timelineChartPoints.value[timelineChartPoints.value.length - 1]) !== null &&
      _a !== void 0
      ? _a
      : null;
  });
