...
function resolvePositionValue(item, baseCurrency) {
  ...
  if (item.effective_amount != null && String(item.effective_amount).trim() !== '') {
    return {
      value: toNumber(item.effective_amount),
      currency: (_a = item.currency) !== null && _a !== void 0 ? _a : baseCurrency,
    };
  }
  if (
  ...
  return {
    ...
    currency: (_c = item.currency) !== null && _c !== void 0 ? _c : baseCurrency,
  };
}
function buildCategoryTotals(rows) {
  ...
  for (var _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
    ...
    totals.set(
      row.category,
      ((_a = totals.get(row.category)) !== null && _a !== void 0 ? _a : 0) + row.value,
    );
  }
  return totals;
}
function buildCategoryCounts(rows) {
  ...
  for (var _i = 0, rows_2 = rows; _i < rows_2.length; _i++) {
    ...
    counts.set(
      row.category,
      ((_a = counts.get(row.category)) !== null && _a !== void 0 ? _a : 0) + 1,
    );
  }
  return counts;
}
function useNetWorthPageMetrics(params) {
  var categoryLabelMap = (0, vue_1.computed)(function () {
    var entries = new Map();
    params.assetCategories.forEach(function (category) {
      return entries.set('asset:'.concat(category.value), category.label);
    });
  ...
  var selectedCategoryLabel = (0, vue_1.computed)(function () {
    ...
    return (_a = categoryLabelMap.value.get(
      ''
        .concat(params.selectedTimelineCategoryType.value, ':')
        .concat(params.selectedTimelineCategory.value),
    )) !== null && _a !== void 0
      ? _a
  ...
  var ownershipFilteredAssets = (0, vue_1.computed)(function () {
    return params.assets.value
      ...
      .filter(function (asset) {
        return params.matchesOwnershipFilter(asset.ownership_ref);
      });
  });
  var ownershipFilteredLiabilities = (0, vue_1.computed)(function () {
    return params.liabilities.value
      .filter(function (liability) {
        return liability.is_active !== false;
      })
      .filter(function (liability) {
        return params.matchesOwnershipFilter(liability.ownership_ref);
      });
  });
  var allAssetPositionRows = (0, vue_1.computed)(function () {
    return ownershipFilteredAssets.value
      .map(function (asset) {
        var _a, _b, _c;
        var resolved = resolvePositionValue(
          asset,
          (_c =
            (_a = params.baseCurrency.value) !== null && _a !== void 0
              ? _a
              : (_b = params.summary.value) === null || _b === void 0
                ? void 0
                : _b.base_currency) !== null && _c !== void 0
            ? _c
            : 'EUR',
        );
        var ownershipFraction = params.allocationFractionForNetWorthOwner(
          asset.ownership_ref,
      ...
      .filter(function (asset) {
        return asset.ownershipFraction > 0;
      })
      .sort(function (a, b) {
  ...
  var allLiabilityPositionRows = (0, vue_1.computed)(function () {
    return ownershipFilteredLiabilities.value
      ...
      .filter(function (liability) {
        return liability.ownershipFraction > 0;
      })
      .sort(function (a, b) {
        return b.value - a.value;
      });
  ...
  var filteredAssetCategoryTotals = (0, vue_1.computed)(function () {
    return buildCategoryTotals(allAssetPositionRows.value);
  });
  ...
  var effectiveCategoryKeys = (0, vue_1.computed)(function () {
    ...
    return Array.from(
      new Set(
        __spreadArray(
          __spreadArray([], filteredAssetCategoryTotals.value.keys(), true),
  ...
  var effectiveCategoryLabels = (0, vue_1.computed)(function () {
    return effectiveCategoryKeys.value.map(function (key) {
      var _a;
      return (_a = categoryLabelMap.value.get('asset:'.concat(key))) !== null && _a !== void 0
        ? _a
        : key;
    });
  });
  var effectiveCategoryAssets = (0, vue_1.computed)(function () {
    ...
    return effectiveCategoryKeys.value.map(function (key) {
      var _a;
      return (_a = filteredAssetCategoryTotals.value.get(key)) !== null && _a !== void 0 ? _a : 0;
    });
  });
  var effectiveCategoryLiabilities = (0, vue_1.computed)(function () {
    ...
    return effectiveCategoryKeys.value.map(function (key) {
      var _a;
      return (_a = filteredLiabilityCategoryTotals.value.get(key)) !== null && _a !== void 0
        ? _a
        : 0;
    });
  });
  var filteredAssetCategoryCounts = (0, vue_1.computed)(function () {
    return buildCategoryCounts(allAssetPositionRows.value);
  });
  ...
  var effectiveCategoryAssetCounts = (0, vue_1.computed)(function () {
    return effectiveCategoryKeys.value.map(function (key) {
      var _a;
      return (_a = filteredAssetCategoryCounts.value.get(key)) !== null && _a !== void 0 ? _a : 0;
    });
  });
  var effectiveCategoryLiabilityCounts = (0, vue_1.computed)(function () {
    return effectiveCategoryKeys.value.map(function (key) {
      var _a;
      return (_a = filteredLiabilityCategoryCounts.value.get(key)) !== null && _a !== void 0
        ? _a
        : 0;
    });
  });
  var filteredAssetsValue = (0, vue_1.computed)(function () {
    return allAssetPositionRows.value.reduce(function (total, row) {
      return total + row.value;
    }, 0);
  });
  var filteredLiabilitiesValue = (0, vue_1.computed)(function () {
    return allLiabilityPositionRows.value.reduce(function (total, row) {
      return total + row.value;
    }, 0);
  });
  var filteredBackedDebtValue = (0, vue_1.computed)(function () {
    return ownershipFilteredLiabilities.value.reduce(function (total, liability) {
      ...
      var fraction = params.allocationFractionForNetWorthOwner(
        liability.ownership_ref,
        params.ownershipFilter.value,
      );
  ...
  var liquidityAssetsValue = (0, vue_1.computed)(function () {
    var _a;
    var liquidityCategoryIndex = effectiveCategoryLabels.value.findIndex(function (label) {
      return label.toLowerCase() === 'liquidez';
    });
    if (liquidityCategoryIndex < 0) return 0;
    return Math.max(
      0,
      (_a = effectiveCategoryAssets.value[liquidityCategoryIndex]) !== null && _a !== void 0
        ? _a
        : 0,
    );
  });
  ...
  var analysis = (0, vue_1.computed)(function () {
    return {
  ...
  var activeAssets = (0, vue_1.computed)(function () {
    return ownershipFilteredAssets.value.map(function (asset) {
      return {
        id: asset.id,
        name: asset.name,
        category: asset.category,
  ...
  var categoryWorkspaceCount = (0, vue_1.computed)(function () {
    return categoryWorkspaceRows.value.length;
  });
  var categoryWorkspaceTotal = (0, vue_1.computed)(function () {
    return categoryWorkspaceRows.value.reduce(function (total, row) {
      return total + row.value;
    }, 0);
  });
  var showCategoryWorkspace = (0, vue_1.computed)(function () {
    return !!params.selectedTimelineCategory.value;
  });
  function sourceItemForRow(row) {
    var _a, _b;
    return row.type === 'asset'
      ? (_a = ownershipFilteredAssets.value.find(function (item) {
          return item.id === row.id;
        })) !== null && _a !== void 0
        ? _a
        : null
      : (_b = ownershipFilteredLiabilities.value.find(function (item) {
            return item.id === row.id;
          })) !== null && _b !== void 0
        ? _b
        : null;
  ...
  var selectedPosition = (0, vue_1.computed)(function () {
    ...
    var rows =
      params.selectedPositionType.value === 'liability'
        ? liabilityPositionRows.value
        : assetPositionRows.value;
    return (_a = rows.find(function (row) {
  ...
  var positionTimelineRows = (0, vue_1.computed)(function () {
    return params.positionTimelineRowsSource.value.map(function (row) {
      ...
      return {
        ...
        value:
          toNumber(row.value_base || row.value) *
          ((_b =
            (_a = selectedPosition.value) === null || _a === void 0
              ? void 0
              : _a.ownershipFraction) !== null && _b !== void 0
            ? _b
            : 1),
      };
    });
