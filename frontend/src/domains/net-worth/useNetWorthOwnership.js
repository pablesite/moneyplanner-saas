...
function useNetWorthOwnership(params) {
    ...
    var ownershipById = (0, vue_1.computed)(function () {
        var _a;
        var map = new Map();
        for (var _i = 0, _b = (_a = params.ownerships.value) !== null && _a !== void 0 ? _a : []; _i < _b.length; _i++) {
            var ownership = _b[_i];
    ...
    var ownershipOptions = (0, vue_1.computed)(function () {
        ...
        var options = new Map();
        for (var _i = 0, _g = (_a = params.ownerships.value) !== null && _a !== void 0 ? _a : []; _i < _g.length; _i++) {
            var ownership = _g[_i];
            if (ownership.kind === 'individual' && ((_b = ownership.member) === null || _b === void 0 ? void 0 : _b.id) && ((_c = ownership.member.name) === null || _c === void 0 ? void 0 : _c.trim())) {
            ...
            for (var _h = 0, _j = (_d = ownership.splits) !== null && _d !== void 0 ? _d : []; _h < _j.length; _h++) {
                var split = _j[_h];
                if (!((_e = split.member) === null || _e === void 0 ? void 0 : _e.id) || !((_f = split.member.name) === null || _f === void 0 ? void 0 : _f.trim()))
                    continue;
        ...
        return Array.from(options.values()).sort(function (a, b) { return a.label.localeCompare(b.label, 'es'); });
    });
    var selectedOwnershipFilterLabel = (0, vue_1.computed)(function () {
        var _a, _b;
        if (ownershipFilter.value === 'all')
            return 'Todos';
        return ((_b = (_a = ownershipOptions.value.find(function (option) { return option.value === ownershipFilter.value; })) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : 'Todos');
    });
    var ownershipFilterDisabled = (0, vue_1.computed)(function () { return params.valueMode.value !== 'nominal'; });
    ...
    function ownershipBadge(ownershipRef) {
        ...
        if (!ownership)
            return null;
        if (ownership.kind === 'individual')
            return (_c = (_b = (_a = ownership.member) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : null;
        var names = ((_d = ownership.splits) !== null && _d !== void 0 ? _d : [])
            .map(function (split) { var _a, _b; return (_b = (_a = split.member) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.trim(); })
