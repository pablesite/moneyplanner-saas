...
function usePeopleMembers() {
  ...
  var prettyError = (0, vue_1.computed)(function () {
    return store.error;
  });
  ...
  function withRowBusy(id, fn) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (rowBusy.value[id]) return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              withRowBusy(id, function () {
                return __awaiter(_this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/, store.updateMember(id, { is_active: next })];
                      case 1:
                        _a.sent();
  ...
  function saveEdit() {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (editForm.id == null) return [2 /*return*/];
            name = editForm.name.trim();
            if (!name) return [2 /*return*/];
            return [
              4 /*yield*/,
              withRowBusy(editForm.id, function () {
                return __awaiter(_this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [
                          4 /*yield*/,
                          store.updateMember(editForm.id, { name: name, role: editForm.role }),
                        ];
                      case 1:
                        _a.sent();
                        editOpen.value = false;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!ok) return [2 /*return*/];
            return [
              4 /*yield*/,
              withRowBusy(member.id, function () {
                return __awaiter(_this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4 /*yield*/, store.deleteMember(member.id)];
                      case 1:
                        _a.sent();
...
function usePeopleOwnerships() {
  ...
  var adults = (0, vue_1.computed)(function () {
    return store.activeAdults;
  });
  var canCreate = (0, vue_1.computed)(function () {
    ...
    for (var _i = 0, _b = form.memberIds; _i < _b.length; _i++) {
      var id = _b[_i];
      var p = Number(
        String((_a = form.percents[id]) !== null && _a !== void 0 ? _a : '').replace(',', '.'),
      );
    ...
    var total = form.memberIds.reduce(function (acc, id) {
      var _a;
      var p = Number(
        String((_a = form.percents[id]) !== null && _a !== void 0 ? _a : '0').replace(',', '.'),
      );
  ...
  var ownershipsSorted = (0, vue_1.computed)(function () {
    var arr = __spreadArray([], store.ownerships, true).filter(function (ownership) {
  ...
  function openEdit(ownership) {
    ...
    form.memberIds = ((_a = ownership.splits) !== null && _a !== void 0 ? _a : [])
      .map(function (split) {
        var _a;
        return (_a = split.member) === null || _a === void 0 ? void 0 : _a.id;
      })
      .filter(function (id) {
        return id != null;
      });
    ...
    ((_b = ownership.splits) !== null && _b !== void 0 ? _b : []).forEach(function (split) {
      ...
      if (((_a = split.member) === null || _a === void 0 ? void 0 : _a.id) != null)
        form.percents[split.member.id] = String(
          (_b = split.percent) !== null && _b !== void 0 ? _b : '',
        );
    });
    showModal.value = true;
  }
  ...
  function submit() {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!canCreate.value) return [2 /*return*/];
            successMessage.value = null;
            splits = form.memberIds.map(function (id) {
              return {
                member_id: id,
          ...
          case 1:
            ...
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, store.createSharedOwnership({ splits: splits })];
          case 3:
            _a.sent();
