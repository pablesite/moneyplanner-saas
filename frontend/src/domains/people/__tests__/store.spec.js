...
var mocks = vitest_1.vi.hoisted(function () { return ({
    ...
    toPeopleErrorMessage: vitest_1.vi.fn(function () { return 'people-error'; }),
}); });
vitest_1.vi.mock('@/domains/people/api', function () { return ({
    peopleApi: mocks.peopleApi,
}); });
vitest_1.vi.mock('@/domains/people/errors', function () { return ({
...
(0, vitest_1.describe)('people store (saas)', function () {
    ...
    (0, vitest_1.it)('fetches members and computes active adults', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(store.activeAdults).toEqual([{ id: 1, name: 'Ana', role: 'adult', is_active: true }]);
                    (0, vitest_1.expect)(store.loading).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('maps fetch errors and clears explicit error state', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.it)('creates, updates and deletes members', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(store.members.map(function (m) { return m.name; })).toEqual(['Ada', 'Zoe', 'Pepe']);
                    return [4 /*yield*/, store.updateMember(3, { name: 'Ada Lovelace', is_active: false })];
                case 2:
                    _c.sent();
                    (0, vitest_1.expect)((_a = store.members.find(function (m) { return m.id === 3; })) === null || _a === void 0 ? void 0 : _a.name).toBe('Ada Lovelace');
                    (0, vitest_1.expect)((_b = store.members.find(function (m) { return m.id === 3; })) === null || _b === void 0 ? void 0 : _b.is_active).toBe(false);
                    return [4 /*yield*/, store.deleteMember(2)];
                case 3:
                    _c.sent();
                    (0, vitest_1.expect)(mocks.peopleApi.deleteMember).toHaveBeenCalledWith(2);
                    (0, vitest_1.expect)(store.members.some(function (m) { return m.id === 2; })).toBe(false);
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('rethrows member write errors with mapped message', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    store = (0, store_1.usePeopleStore)();
                    return [4 /*yield*/, (0, vitest_1.expect)(store.createMember({ name: 'Ada', role: 'adult' })).rejects.toThrow('boom')];
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(store.error).toBe('people-error');
                    (0, vitest_1.expect)(store.loading).toBe(false);
    ...
    (0, vitest_1.it)('handles ownership list/create/update/delete flows', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, store.createSharedOwnership({ splits: [{ member_id: 1, percent: '100' }] })];
                case 2:
                    _a.sent();
                    ...
                    return [4 /*yield*/, store.updateSharedOwnership(5, { splits: [{ member_id: 1, percent: '60' }] })];
                case 3:
                    _a.sent();
