...
vitest_1.vi.mock('@/domains/people/store', function () {
  return {
...
(0, vitest_1.describe)('people composables (saas)', function () {
  ...
  (0, vitest_1.it)('handles member flows and success messages', function () {
        ...
        switch (_a.label) {
          case 0:
            store = (0, vue_1.reactive)({
              ...
              fetchMembers: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
              ...
              createMember: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              updateMember: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              deleteMember: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              fetchOwnerships: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              updateSharedOwnership: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              createSharedOwnership: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
              ...
              deleteOwnership: vitest_1.vi.fn(function () {
                return __awaiter(void 0, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    return [2 /*return*/, undefined];
                  });
          ...
          case 2:
            _a.sent();
            (0, vitest_1.expect)(store.createMember).toHaveBeenCalledWith({
              name: 'Ada',
              role: 'adult',
            });
          ...
          case 3:
            _a.sent();
            (0, vitest_1.expect)(store.updateMember).toHaveBeenCalledWith(1, {
              name: 'Ada Lovelace',
              role: 'adult',
            });
  ...
  (0, vitest_1.it)('sorts and validates ownership flows', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            store = (0, vue_1.reactive)({
              ...
              ownerships: [
                ...
                makeOwnership({
                  id: 1,
                  kind: 'individual',
                  member: { id: 1, name: 'Ada', role: 'adult' },
                }),
              ],
              activeAdults: [makeMember(), makeMember({ id: 2, name: 'Bob' })],
              clearError: vitest_1.vi.fn(),
          ...
          case 1:
            ...
            (0, vitest_1.expect)(
              ownerships.ownershipsSorted.value.map(function (item) {
                return item.id;
              }),
            ).toEqual([2]);
            (0, vitest_1.expect)(
              (_a = ownerships.ownershipsSorted.value[0]) === null || _a === void 0
                ? void 0
                : _a.kind,
            ).toBe('shared');
