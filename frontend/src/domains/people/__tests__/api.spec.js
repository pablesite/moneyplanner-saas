...
(0, vitest_1.describe)('people api (saas)', function () {
    ...
    (0, vitest_1.it)('maps premium endpoints and payload shape', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    ...
                    (0, vitest_1.expect)(mocks.api.post).toHaveBeenCalledWith('/api/family-members/', memberPayload);
                    (0, vitest_1.expect)(mocks.api.patch).toHaveBeenCalledWith('/api/family-members/1/', patchPayload);
    ...
    (0, vitest_1.it)('keeps core adapter mapped to transitional premium contract', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.corePeopleApi.getMembers()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, api_1.corePeopleApi.createMember({ name: 'Ada', role: 'adult', is_active: true })];
                case 2:
                    _a.sent();
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, api_1.corePeopleApi.createSharedOwnership({ splits: [{ member_id: 1, percent: '100' }] })];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, api_1.corePeopleApi.updateSharedOwnership(1, { splits: [{ member_id: 1, percent: '100' }] })];
                case 7:
                    _a.sent();
                ...
                case 8:
                    ...
                    (0, vitest_1.expect)(mocks.api.patch).toHaveBeenCalledWith('/api/family-members/1/', { name: 'Ada' });
                    (0, vitest_1.expect)(mocks.api.delete).toHaveBeenCalledWith('/api/family-members/1/');
                    (0, vitest_1.expect)(mocks.api.get).toHaveBeenCalledWith('/api/ownerships/');
                    (0, vitest_1.expect)(mocks.api.post).toHaveBeenCalledWith('/api/ownerships/', {
                        kind: 'shared',
