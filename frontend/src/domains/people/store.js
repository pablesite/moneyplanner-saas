...
exports.usePeopleStore = (0, pinia_1.defineStore)('people', {
    ...
    getters: {
        activeAdults: function (state) {
            return state.members.filter(function (m) { return m.is_active && m.role === 'adult'; });
        },
    },
    actions: {
        clearError: function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, 4, 5]);
                            return [4 /*yield*/, api_1.peopleApi.createMember(__assign(__assign({}, payload), { is_active: true }))];
                        case 2:
                            data = (_a.sent()).data;
                            this.members = __spreadArray(__spreadArray([], this.members, true), [data], false).sort(function (a, b) {
                                if (a.role !== b.role)
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            data_1 = (_a.sent()).data;
                            this.members = this.members.map(function (m) { return (m.id === id ? data_1 : m); });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            this.ownerships = this.ownerships.filter(function (o) { return o.id !== id; });
                            return [3 /*break*/, 5];
                        case 3:
                            e_8 = _a.sent();
