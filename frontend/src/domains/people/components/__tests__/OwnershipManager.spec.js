...
vitest_1.vi.mock('@/domains/people/composables', function () { return ({
    usePeopleOwnerships: function () { return mockUsePeopleOwnerships(); },
}); });
function makeState(overrides) {
    var _this = this;
    if (overrides === void 0) { overrides = {}; }
    return __assign({ store: { loading: false, error: null }, showModal: (0, vue_1.ref)(false), editId: (0, vue_1.ref)(null), successMessage: (0, vue_1.ref)(null), form: (0, vue_1.reactive)({ memberIds: [], percents: {} }), adults: (0, vue_1.computed)(function () { return []; }), canCreate: (0, vue_1.computed)(function () { return false; }), ownershipsSorted: (0, vue_1.computed)(function () { return []; }), ensureLoaded: vitest_1.vi.fn(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); }), refreshOwnerships: vitest_1.vi.fn(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); }), resetModal: vitest_1.vi.fn(), openCreate: vitest_1.vi.fn(), openEdit: vitest_1.vi.fn(), toggleMember: vitest_1.vi.fn(), setEqualSplit: vitest_1.vi.fn(), submit: vitest_1.vi.fn(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); }), removeOwnership: vitest_1.vi.fn(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); }); }) }, overrides);
}
(0, vitest_1.describe)('OwnershipManager', function () {
    ...
    (0, vitest_1.it)('shows success and empty states', function () {
        mockUsePeopleOwnerships.mockReturnValue(makeState({
    ...
    (0, vitest_1.it)('calls create action from header button', function () { return __awaiter(void 0, void 0, void 0, function () {
        var state, wrapper;
