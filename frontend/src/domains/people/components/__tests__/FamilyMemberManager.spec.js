...
vitest_1.vi.mock('@/domains/people/composables', function () {
  return {
    usePeopleMembers: function () {
      return mockUsePeopleMembers();
    },
  };
});
function makeState(overrides) {
  ...
  return __assign(
    {
      store: { loading: false },
      form: (0, vue_1.reactive)({ name: '', role: 'adult' }),
      saving: (0, vue_1.ref)(false),
      rowBusy: (0, vue_1.ref)({}),
      createOpen: (0, vue_1.ref)(false),
      successMessage: (0, vue_1.ref)(null),
      editOpen: (0, vue_1.ref)(false),
      editForm: (0, vue_1.reactive)({ id: null, name: '', role: 'adult' }),
      prettyError: (0, vue_1.computed)(function () {
        return null;
      }),
      membersSorted: (0, vue_1.computed)(function () {
        return [];
      }),
      ...
      refreshMembers: vitest_1.vi.fn(function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            return [2 /*return*/];
          });
      ...
      toggleActive: vitest_1.vi.fn(function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            return [2 /*return*/];
          });
      ...
      saveEdit: vitest_1.vi.fn(function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            return [2 /*return*/];
          });
      ...
      removeMember: vitest_1.vi.fn(function () {
        return __awaiter(_this, void 0, void 0, function () {
          return __generator(this, function (_a) {
            return [2 /*return*/];
          });
...
(0, vitest_1.describe)('FamilyMemberManager', function () {
  ...
  (0, vitest_1.it)('calls refresh action from header button', function () {
