...
if (props.kind === 'individual') {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ui-inline-offset-sm" }));
    /** @type {__VLS_StyleScopedClasses['ui-inline-offset-sm']} */ ;
    ((_b = (_a = props.member) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : '-');
}
else {
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "subtle" }));
    /** @type {__VLS_StyleScopedClasses['subtle']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "ui-inline-offset-sm" }));
    /** @type {__VLS_StyleScopedClasses['ui-inline-offset-sm']} */ ;
    for (var _i = 0, _c = __VLS_vFor((props.splits)); _i < _c.length; _i++) {
        var _d = _c[_i], s = _d[0], i = _d[1];
