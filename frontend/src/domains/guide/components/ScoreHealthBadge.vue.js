...
var badgeStyle = (0, vue_1.computed)(function () {
  return (0, scoreVisuals_1.scoreBadgeStyle)(props.score);
});
...
__VLS_asFunctionalElement1(
  ...
  __assign(
    __assign(
      ...
      { class: 'ui-guide-health-'.concat(__VLS_ctx.tone) },
    ),
    { style: __VLS_ctx.badgeStyle },
  ),
);
/** @type {__VLS_StyleScopedClasses['ui-guide-health-score-badge']} */ __VLS_asFunctionalElement1(
  __VLS_intrinsics.span,
  __VLS_intrinsics.span,
)(__assign({ class: 'ui-guide-health-score-text' }));
/** @type {__VLS_StyleScopedClasses['ui-guide-health-score-text']} */ __VLS_ctx.label;
__VLS_asFunctionalElement1(
  __VLS_intrinsics.strong,
  __VLS_intrinsics.strong,
)(__assign({ class: 'ui-guide-health-score-value' }));
/** @type {__VLS_StyleScopedClasses['ui-guide-health-score-value']} */ (
  _a = __VLS_ctx.formattedScore
) !== null && _a !== void 0
  ? _a
  : ''.concat(Math.round(__VLS_ctx.score), '%');
// @ts-ignore
