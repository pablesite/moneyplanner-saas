...
(0, vitest_1.describe)('computeGuidePhaseDiagnostics', function () {
    (0, vitest_1.it)('scores phase 2 from recurring operating flow and ignores extraordinary distortion in the main score', function () {
    ...
    (0, vitest_1.it)('modestly penalizes recurring patrimonial allocations via total annual cash flow component', function () {
        ...
        (0, vitest_1.expect)(base.phase2GlobalScore - withAllocations.phase2GlobalScore).toBeLessThan(15);
        (0, vitest_1.expect)(base.phase2GlobalScore).toBeGreaterThan(70);
    });
    (0, vitest_1.it)('includes total annual cash flow as a fourth score component (penalizes net annual deficits)', function () {
        ...
        (0, vitest_1.expect)(withoutOneOffDeficit.phase2GlobalScore).toBeGreaterThan(withOneOffDeficit.phase2GlobalScore);
    });
    (0, vitest_1.it)('rewards low structural operating load and penalizes full operating load in phase 2', function () {
    ...
    (0, vitest_1.it)('penalizes temporary recurring commitments in phase 2 tension score', function () {
        ...
        (0, vitest_1.expect)(withTemporaryCommitments.phase2GlobalScore).toBeLessThan(noCommitments.phase2GlobalScore);
    });
    (0, vitest_1.it)('keeps diagnostics finite when liabilities exist but there is no recurrent income', function () {
    ...
    (0, vitest_1.it)('improves phase 3 score when emergency liquidity covers more months of essential expense', function () {
        ...
        (0, vitest_1.expect)(highCoverage.phase3GlobalScore).toBeGreaterThan(lowCoverage.phase3GlobalScore);
        (0, vitest_1.expect)(Number.isFinite(highCoverage.phase3GlobalScore)).toBe(true);
    });
    (0, vitest_1.it)('penalizes phase 3 when assets are mostly illiquid even with similar total assets', function () {
        ...
        (0, vitest_1.expect)(liquidMix.phase3GlobalScore).toBeGreaterThan(mostlyIlliquid.phase3GlobalScore);
    });
    (0, vitest_1.it)('handles liabilities without monthly payment inputs without penalizing debt-cost payment subscore path', function () {
        var diagnostics = (0, phaseDiagnostics_1.computeGuidePhaseDiagnostics)({
            summary: {
                total_assets: '20000',
