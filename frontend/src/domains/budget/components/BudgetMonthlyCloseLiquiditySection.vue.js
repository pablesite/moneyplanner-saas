...
if (__VLS_ctx.isMonthlyCloseView && __VLS_ctx.activeMonthlyCloseStep === 'liq') {
    ...
    if (__VLS_ctx.isMonthlyCloseView) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign(__assign({ onClick: function () {
                ...
                // @ts-ignore
                [isMonthlyCloseView, isMonthlyCloseView, activeMonthlyCloseStep, goToPreviousMonthlyCloseStep,];
            } }, { type: "button" }), { class: "btn ui-monthly-close-step-nav-btn" }), { disabled: (!__VLS_ctx.previousMonthlyCloseStep) }));
    ...
    if (!__VLS_ctx.isMonthlyCloseView) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign(__assign({ onChange: function () {
                var _a = [];
                for (var _i = 0; _i < arguments.length; _i++) {
                    _a[_i] = arguments[_i];
                }
            ...
            } }, { value: (__VLS_ctx.selectedExecutionMonth) }), { class: "select ui-data-field" }), { disabled: (__VLS_ctx.liquidityExecutionLoading) }));
        /** @type {__VLS_StyleScopedClasses['select']} */ ;
        /** @type {__VLS_StyleScopedClasses['ui-data-field']} */ ;
        for (var _i = 0, _d = __VLS_vFor((__VLS_ctx.monthLabels)); _i < _d.length; _i++) {
            var _e = _d[_i], label = _e[0], index = _e[1];
    ...
    if (__VLS_ctx.liquidityMonthlySummary) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.strong, __VLS_intrinsics.strong)({});
        (__VLS_ctx.formatPercent((_a = __VLS_ctx.liquidityMonthlySummary.completion_ratio) !== null && _a !== void 0 ? _a : null, 0));
    }
    ...
    if (__VLS_ctx.liquidityExecutionLoading) {
        ...
        (__VLS_ctx.monthlyLiquidityExecutionRows.length);
        (__VLS_ctx.formatPercent((_c = (_b = __VLS_ctx.liquidityMonthlySummary) === null || _b === void 0 ? void 0 : _b.completion_ratio) !== null && _c !== void 0 ? _c : null, 0));
        ...
        var _loop_1 = function (row) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.article, __VLS_intrinsics.article)(__assign({ key: ("liquidity-checkin-".concat(row.asset_id)) }, { class: "ui-budget-checkin-row" }));
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "ui-budget-checkin-row-title" }, { title: (__VLS_ctx.liquidityCheckinRowSummary(row)) }));
            /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-row-title']} */ ;
            (__VLS_ctx.liquidityCheckinRowSummary(row));
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign(__assign({ onClick: function () {
                    ...
                    if (!!(__VLS_ctx.liquidityExecutionLoading))
                        return;
                    if (!!(!__VLS_ctx.monthlyLiquidityExecutionRows.length))
                        return;
                    __VLS_ctx.resetLiquidityCheckinDraftValue(row, 'zero');
                    // @ts-ignore
                    [liquidityExecutionLoading, liquidityMonthlySummary, liquidityMonthlySummary, liquidityMonthlySummary, formatMoney, formatMoney, formatMoney, formatMoney, formatMoney, formatMoney, formatMoney, formatMoney, selectedLiquidityMonthPlanned, selectedLiquidityMonthPlanned, selectedLiquidityMonthExecuted, selectedLiquidityMonthExecuted, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, selectedLiquidityMonthDeviation, formatPercent, formatPercent, monthlyLiquidityExecutionRows, monthlyLiquidityExecutionRows, monthlyLiquidityExecutionRows, liquidityCheckinRowSummary, liquidityCheckinRowSummary, checkinStatusLabel, resetLiquidityCheckinDraftValue,];
                } }, { type: "button" }), { class: "btn ui-budget-checkin-mini-btn" }), { disabled: (__VLS_ctx.liquidityExecutionBusyAssetId === row.asset_id), title: "Poner saldo real a 0" }));
            /** @type {__VLS_StyleScopedClasses['btn']} */ ;
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign(__assign({ onClick: function () {
                ...
                } }, { type: "button" }), { class: "btn ui-budget-checkin-mini-btn" }), { disabled: (__VLS_ctx.liquidityExecutionBusyAssetId === row.asset_id), title: "Restaurar saldo de referencia" }));
            /** @type {__VLS_StyleScopedClasses['btn']} */ ;
            /** @type {__VLS_StyleScopedClasses['ui-budget-checkin-mini-btn']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign(__assign(__assign(__assign({ onFocus: function () {
                ...
                } }), { inputmode: "decimal" }), { class: "input ui-data-field" }), { placeholder: "Saldo real" }));
            (__VLS_ctx.liquidityAdjustAmounts[row.asset_id]);
            /** @type {__VLS_StyleScopedClasses['input']} */ ;
            /** @type {__VLS_StyleScopedClasses['ui-data-field']} */ ;
            __VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "ui-budget-checkin-confirm" }, { title: "Confirmar cierre de liquidez" }));
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign({ onChange: function () {
                ...
                } }, { type: "checkbox", checked: (!!row.checkin), disabled: (__VLS_ctx.liquidityExecutionBusyAssetId === row.asset_id), 'aria-label': "Confirmar cierre de liquidez" }));
            // @ts-ignore
            [liquidityExecutionBusyAssetId,];
        };
        for (var _f = 0, _g = __VLS_vFor((__VLS_ctx.monthlyLiquidityExecutionRows)); _f < _g.length; _f++) {
            var row = _g[_f][0];
            _loop_1(row);
        }
    }
