...
<template>
  ...
  <div class="bdg-sections">
    <section
      v-for="section in sections"
      :key="section.id"
      class="sect bdg-section"
    ...
    >
      ...
      <div v-if="section.groups.length && isSectionExpanded(section.id)">
        ...
        <div class="bdg-row bdg-row-cat bdg-row-total">
          ...
          <div class="bdg-spark-cell">
            <ASparkline
              :data="sectionExecutedSeries(section.id)"
              :active-idx="sparklineActiveIdx"
            />
          </div>
          <div class="bdg-num bdg-num-strong">
            {{ formatMoney(sectionYtdTotals(section.id).executedTotal) }} €
  ...
  <AnnualEntryModalForm
    ...
    :show-settlement-fields="annualEntriesPage.showSettlementFields.value"
    :ownership-options="annualEntriesPage.settlementOwnershipOptions.value"
  ...
  <AnnualEntryModalForm
    ...
    :show-settlement-fields="annualEntriesPage.showSettlementFields.value"
    :ownership-options="annualEntriesPage.settlementOwnershipOptions.value"
    :settlement-account-options="annualEntriesPage.settlementAccountOptions.value"
    :show-settlement-destination="annualEntriesPage.annualExpenseForm.timeProfile !== 'one_off'"
