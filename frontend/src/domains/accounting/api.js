    ...
    return api_1.coreApi.get('/api/accounting/accounts/', {
      params:
        params && (params.account_type || typeof params.is_active === 'boolean')
          ? __assign(
              __assign({}, params.account_type ? { account_type: params.account_type } : {}),
              typeof params.is_active === 'boolean' ? { is_active: String(params.is_active) } : {},
            )
          : undefined,
    });
  },
    ...
    return api_1.coreApi.get('/api/accounting/transactions/', {
      params:
        params && (params.year || params.month || params.status)
          ? __assign(
              __assign(
                __assign({}, params.year ? { year: params.year } : {}),
      ...
      params:
        params && (params.account_id || params.transaction_id || params.year || params.month)
          ? __assign(
              __assign(
                __assign(
                  __assign({}, params.account_id ? { account_id: params.account_id } : {}),
