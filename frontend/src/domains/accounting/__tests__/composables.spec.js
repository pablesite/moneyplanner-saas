...
(0, vitest_1.describe)('useAccountingPage', function () {
    ...
    (0, vitest_1.it)('omits annual plan ids from quick-entry payload when the movement is not linked', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    (0, vitest_1.expect)(api_1.coreAccountingApi.createQuickEntry).toHaveBeenCalledWith(vitest_1.expect.not.objectContaining({
    ...
    (0, vitest_1.it)('requires a file before generating MoneyWiz preview', function () { return __awaiter(void 0, void 0, void 0, function () {
        var Harness, wrapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    _a.sent();
                    (0, vitest_1.expect)(wrapper.vm.error).toBe('Selecciona antes un CSV exportado desde MoneyWiz.');
                    return [2 /*return*/];
            }
        });
    }); });
