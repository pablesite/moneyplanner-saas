...
(0, vitest_1.describe)('useAccountingStore', function () {
  ...
  (0, vitest_1.it)('refreshes accounts, transactions and monthly summary together', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            _c.sent();
            (0, vitest_1.expect)(api_1.coreAccountingApi.getTransactions).toHaveBeenCalledWith({
              year: 2026,
              month: 3,
            });
            ...
            (0, vitest_1.expect)(
              (_a = store.monthlySummary) === null || _a === void 0 ? void 0 : _a.fiscal_year,
            ).toBe(2026);
            (0, vitest_1.expect)(
              (_b = store.accountBalancesSummary) === null || _b === void 0
                ? void 0
                : _b.totals_by_account_type.asset,
            ).toBe('2100.00');
            return [2 /*return*/];
        }
      });
  ...
  (0, vitest_1.it)('creates a transaction and reloads data', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var store;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            vitest_1.vi
              .mocked(api_1.coreAccountingApi.createTransaction)
              .mockResolvedValue({ data: {} });
            vitest_1.vi.mocked(api_1.coreAccountingApi.getAccounts).mockResolvedValue({ data: [] });
            vitest_1.vi
              .mocked(api_1.coreAccountingApi.getTransactions)
              .mockResolvedValue({ data: [] });
            vitest_1.vi.mocked(api_1.coreAccountingApi.getMonthlySummary).mockResolvedValue({
              data: { fiscal_year: 2026, months: [] },
            });
  ...
  (0, vitest_1.it)('creates a quick entry and reloads balances', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var store;
      var _a;
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            (0, vitest_1.expect)(
              (_a = store.accountBalancesSummary) === null || _a === void 0
                ? void 0
                : _a.totals_by_account_type.asset,
            ).toBe('500.00');
            return [2 /*return*/];
        }
      });
  ...
  (0, vitest_1.it)('stores MoneyWiz preview and commit results', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var store, file;
      var _a, _b;
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 2:
            _c.sent();
            (0, vitest_1.expect)(
              (_a = store.moneyWizImportPreview) === null || _a === void 0 ? void 0 : _a.row_count,
            ).toBe(2);
            (0, vitest_1.expect)(
              (_b = store.moneyWizImportCommitResult) === null || _b === void 0
                ? void 0
                : _b.created_count,
            ).toBe(2);
            (0, vitest_1.expect)(api_1.coreAccountingApi.commitMoneyWizImport).toHaveBeenCalledWith(
              file,
            );
            return [2 /*return*/];
        }
