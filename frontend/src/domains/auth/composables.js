...
function useLoginForm() {
  ...
  var sessionNotice = (0, vue_1.ref)(null);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.authApi.login({ username: username.value, password: password.value }),
            ];
          case 2:
            res = _a.sent();
            (0, session_1.setAccessToken)(res.data.access);
            if (res.data.refresh) (0, session_1.setRefreshToken)(res.data.refresh);
