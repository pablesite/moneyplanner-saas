...
function mapApiItem(item) {
    var _a, _b, _c;
    var timeProfile = (_a = item.time_profile) !== null && _a !== void 0 ? _a : (item.expense_type === 'one_off' ? 'one_off' : 'structural_recurrent');
    return {
        id: item.id,
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        validSubcategory = expenseTaxonomy_1.expenseSubcategories.some(function (row) { return row.category === draft.category && row.value === draft.subcategory; });
                        if (!validSubcategory) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, api_1.api.post('/api/budget/annual-expense/', {
                                name: name,
                                ...
                                time_profile: (_b = draft.timeProfile) !== null && _b !== void 0 ? _b : (draft.expenseType === 'one_off' ? 'one_off' : 'structural_recurrent'),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        _h.trys.push([1, 4, 5, 6]);
                        return [4 /*yield*/, api_1.api.patch("/api/budget/annual-expense/".concat(id, "/"), {
                                name: name,
                                category: draft.category,
                                subcategory: draft.subcategory,
                                owner_name: (0, annualEntryUtils_1.normalizeOwnerName)((_a = draft.owner) !== null && _a !== void 0 ? _a : ''),
    ...
    function listBySourceLiability(sourceLiabilityId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, api_1.api.get('/api/budget/annual-expense/', {
                            params: { source_liability_id: sourceLiabilityId },
                        })];
                    case 1:
                        response = _b.sent();
                        return [2 /*return*/, ((_a = response.data) !== null && _a !== void 0 ? _a : []).map(mapApiItem)];
                }
            });
        });
    }
