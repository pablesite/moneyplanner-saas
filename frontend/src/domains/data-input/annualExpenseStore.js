...
exports.useAnnualExpenseStore = useAnnualExpenseStore;
var vue_1 = require('vue');
var api_1 = require('@/lib/api');
var errors_1 = require('@/lib/errors');
var expenseTaxonomy_1 = require('@/domains/data-input/expenseTaxonomy');
var annualEntryUtils_1 = require('@/domains/data-input/annualEntryUtils');
function mapApiItem(item) {
  var _a, _b, _c;
  var timeProfile =
    (_a = item.time_profile) !== null && _a !== void 0
      ? _a
      : item.expense_type === 'one_off'
        ? 'one_off'
...
function useAnnualExpenseStore(_scope) {
  if (_scope === void 0) {
    _scope = 'saas';
  }
        ...
        switch (_e.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              Promise.all([
                api_1.api.get('/api/budget/annual-expense/', {
                  params: year ? { year: year } : undefined,
                }),
                api_1.api.get('/api/budget/annual-expense/totals/', {
                  params: year ? { year: year } : undefined,
                }),
              ]),
            ];
          case 2:
            ...
            entries.value = ((_b = listRes.data) !== null && _b !== void 0 ? _b : []).map(
              mapApiItem,
            );
            totalAnnual.value = Number(
              (_d = (_c = totalsRes.data) === null || _c === void 0 ? void 0 : _c.total_annual) !==
                null && _d !== void 0
                ? _d
                : '0',
            );
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          case 0:
            ...
            if (!name) return [2 /*return*/, { ok: false, error: 'El nombre es obligatorio.' }];
            validSubcategory = expenseTaxonomy_1.expenseSubcategories.some(function (row) {
              return row.category === draft.category && row.value === draft.subcategory;
            });
            if (!validSubcategory) {
              return [
                2 /*return*/,
                { ok: false, error: 'La subcategoria no corresponde con la categoria elegida.' },
              ];
            }
            ...
            if (amount <= 0)
              return [
                2 /*return*/,
                { ok: false, error: 'El importe anual debe ser mayor que cero.' },
              ];
            loading.value = true;
            error.value = null;
            _h.label = 1;
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.api.post('/api/budget/annual-expense/', {
                name: name,
                category: draft.category,
                subcategory: draft.subcategory,
                owner_name: (0, annualEntryUtils_1.normalizeOwnerName)(
                  (_a = draft.owner) !== null && _a !== void 0 ? _a : '',
                ),
                expense_type: draft.expenseType,
                time_profile:
                  (_b = draft.timeProfile) !== null && _b !== void 0
                    ? _b
                    : draft.expenseType === 'one_off'
                      ? 'one_off'
                      : 'structural_recurrent',
                cashflow_role:
                  (_c = draft.cashflowRole) !== null && _c !== void 0 ? _c : 'operating',
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              loadAll(year !== null && year !== void 0 ? year : draft.fiscalYear),
            ];
          case 3:
            _h.sent();
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.api.patch('/api/budget/annual-expense/'.concat(id, '/'), {
                name: name,
                category: draft.category,
                subcategory: draft.subcategory,
                owner_name: (0, annualEntryUtils_1.normalizeOwnerName)(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, api_1.api.delete('/api/budget/annual-expense/'.concat(id, '/'))];
          case 2:
            _a.sent();
  ...
  function listBySourceLiability(sourceLiabilityId) {
    return __awaiter(this, void 0, void 0, function () {
      var response;
      var _a;
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              2 /*return*/,
              ((_a = response.data) !== null && _a !== void 0 ? _a : []).map(mapApiItem),
            ];
        }
      });
    });
  ...
  return {
    ...
    listBySourceLiability: listBySourceLiability,
  };
}
