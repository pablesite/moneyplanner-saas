      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          case 0:
            ...
            validSubcategory = incomeTaxonomy_1.incomeSubcategories.some(function (row) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.api.post('/api/budget/annual-income/', {
                name: name,
      ...
      return __generator(this, function (_h) {
        switch (_h.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.api.patch('/api/budget/annual-income/'.concat(id, '/'), {
                name: name,
                category: draft.category,
                subcategory: draft.subcategory,
                owner_name: (0, annualEntryUtils_1.normalizeOwnerName)(
