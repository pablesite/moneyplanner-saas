        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(mocks.api.post).toHaveBeenCalledWith('/api/budget/annual-expense/', vitest_1.expect.objectContaining({
                        name: 'Alimentacion',
                        category: 'consumption_expenses',
                        subcategory: 'living_expenses',
                        amount_annual: '5500.00',
                ...
                case 2:
                    ...
                    (0, vitest_1.expect)(mocks.api.patch).toHaveBeenCalledWith('/api/budget/annual-expense/1/', vitest_1.expect.objectContaining({
                        name: 'Alimentacion actualizada',
                ...
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.api.delete).toHaveBeenCalledWith('/api/budget/annual-expense/10/');
                    return [2 /*return*/];
            }
        });
    }); });
