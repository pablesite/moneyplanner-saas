...
vitest_1.vi.mock('@/lib/errors', function () { return ({
    toApiErrorMessage: function (error) { return (error instanceof Error ? error.message : 'error'); },
}); });
(0, vitest_1.describe)('annual income store (core)', function () {
    (0, vitest_1.beforeEach)(function () {
        vitest_1.vi.clearAllMocks();
    });
    (0, vitest_1.it)('loads entries and totals from core api', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store;
    ...
    (0, vitest_1.it)('creates, updates and deletes entries via core api', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(mocks.api.post).toHaveBeenCalledWith('/api/budget/annual-income/', vitest_1.expect.objectContaining({
                        name: 'CTN',
                        category: 'salary',
                        subcategory: 'employee_salary',
                        amount_annual: '32460.00',
                    ...
                    return [4 /*yield*/, store.updateEntry(1, {
                ...
                case 2:
                    ...
                    (0, vitest_1.expect)(mocks.api.patch).toHaveBeenCalledWith('/api/budget/annual-income/1/', vitest_1.expect.objectContaining({
                        name: 'CTN actualizado',
                        category: 'salary',
                        subcategory: 'employee_salary',
                ...
                case 3:
                    _a.sent();
                    (0, vitest_1.expect)(mocks.api.delete).toHaveBeenCalledWith('/api/budget/annual-income/10/');
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('rejects invalid subcategory before calling api', function () { return __awaiter(void 0, void 0, void 0, function () {
        var store, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
