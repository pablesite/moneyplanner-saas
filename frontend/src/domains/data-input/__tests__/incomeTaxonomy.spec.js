...
(0, vitest_1.describe)('income taxonomy (core)', function () {
    (0, vitest_1.it)('defines subcategories for every category', function () {
        var categories = incomeTaxonomy_1.incomeCategories.map(function (c) { return c.value; });
        var _loop_1 = function (category) {
            var rows = incomeTaxonomy_1.incomeSubcategories.filter(function (sub) { return sub.category === category; });
