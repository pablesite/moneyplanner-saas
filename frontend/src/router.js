...
var routes = [
    ...
    { path: '/guia/fases/:phaseId', name: 'guide-phase', component: GuidePhaseDetailView_vue_1.default },
    ...
    { path: '/movimientos', name: 'accounting-movements', component: AccountingMovementsView_vue_1.default },
];
