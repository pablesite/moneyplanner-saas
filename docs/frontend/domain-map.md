...
**Origen:** Core-backed
**Cliente:** `coreApi`
**Rutas:** `/plan`, `/plan/mejoras`, `/plan/decisiones`, `/plan/decisiones/nueva`, `/plan/decisiones/:id`, `/plan/decisiones/eventos/:id`, `/plan/decisiones/registrar`, `/plan/setup`, `/plan/activos`. `/plan/escenarios*` permanece como redirect compatible.
