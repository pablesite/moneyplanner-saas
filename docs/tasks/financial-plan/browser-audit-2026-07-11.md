...
**Tercera capa — pendiente de decisión de producto.** Tras el ajuste, el `committed_surplus` sigue negativo (`-7.758,46 €`) porque los compromisos temporales *reales* de 2026 (Atrio, FIV, cuota Palmito, iPhone, óvulos = 27.582,54 €) superan al superávit operativo permanente (+19.824,08 €). Es un **apretón transitorio** (casi todo vence entre sept-2026 y ene-2027) financiado por la venta puntual de Palmito, que el motor excluye de la renta estructural. Cimientos no distingue hoy «apretón temporal cubierto por venta de activo» de «déficit estructural», por lo que el blocker «superávit comprometido negativo» sigue disparándose. Queda documentado como decisión abierta; no se aborda en este ajuste.
