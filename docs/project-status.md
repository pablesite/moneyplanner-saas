...
| Consolidación funcional v1 (módulos espejo Core) | Alta | 🔄 | Repaso manual de Cierre, Presupuesto y Movimientos; Presupuesto integra edición por categorías en flujo único, portable data consolidado en Cuenta y revisión de gasto generado por pasivo en Patrimonio. |
