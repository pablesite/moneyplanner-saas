...
| 7     | Agent | ✅     | Engine correctness complete: one current-FY window, structural-only recurring income, aggregate labour cut-off at the latest adult date, exhaustive shared expense taxonomy and explicit quality factors. Real-data result: committed surplus `-78.834,58 €` → `-31.771,75 €`; projected year disappears after removing perpetual one-off income and applying the 2049 cut-off. | `core/docs/tasks/financial-plan/phase-7-engine-correctness/terminados/backend.md` |
