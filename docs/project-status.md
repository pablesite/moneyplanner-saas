...
| Limpieza legacy residual Core/SaaS | Media | 🔄 | Inventario en `core/docs/roadmap/product-roadmap.md`. Queda: `compat.*` en capabilities (4 ficheros). Retirados: Introducción de Datos, alias `investment_purchase`, campos escalares de aportaciones (migración 0042), import externo de `net_worth.services` (2026-05-20). Fallback Budget/check-ins: diseño intencional. |
