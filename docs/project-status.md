...
| Frontend redesign "Direction A" — Phase 1         | Medium   | ⚪     | Patrimonio pilot: port `NetWorthView` to the new system (header DSL, context bar, flat balance table, recolored Chart.js) preserving 100% of functionality. Spec: `docs/tasks/frontend-redesign-direction-a/phase-1-networth-pilot/frontend.md`                          |
