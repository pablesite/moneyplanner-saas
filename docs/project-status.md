...
| Frontend redesign "Direction A" — Phase 4         | Medium   | ⚪     | Guía: port `HomeView` (phase map) + `GuidePhaseDetailView` (score + diagnostics) with A–E grade phase strip. Closes the redesign module. Spec: `docs/tasks/frontend-redesign-direction-a/phase-4-guide/frontend.md`                                                      |
