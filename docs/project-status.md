...
| Accounting Movements (movimientos) | ✅ Implementado | `/movimientos` | Soporte multimoneda en alta y edición de inversiones desplegado (espejo Core/SaaS). Migración operativa de histórico Bitcoin en curso (manual). |
