...
| Frontend redesign "Direction A" — Phase 3         | Medium   | ✅     | Contabilidad (`AccountingMovementsView`): la antigua fase de Movimientos se considera cerrada y consolidada como vista de Contabilidad dentro del redesign Direction A. Spec: `docs/tasks/frontend-redesign-direction-a/terminados/phase-3-accounting/frontend.md` |
...
| Frontend redesign "Direction A" — Phase 5         | Medium   | 🔄     | Gate visual + consistencia transversal: cierre de happy-path contra handoff y ajuste de los componentes básicos compartidos entre Patrimonio, Presupuesto, Cierre mensual, Contabilidad y Estado financiero (page heads, context bars, tablas, chips, botones, sheets y estados). Spec: `docs/tasks/frontend-redesign-direction-a/phase-5-visual-polish-consistency/frontend.md` |
