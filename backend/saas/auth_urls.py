...
urlpatterns = [
    ...
    path("logout/", SaasLogoutAPIView.as_view(), name="saas_logout"),
    path("register/", SaasRegisterAPIView.as_view(), name="saas_register"),
    path("me/", SaasMeAPIView.as_view(), name="saas_me"),
    path("password/change/", SaasPasswordChangeAPIView.as_view(), name="saas_password_change"),
    path(
        "internal/session/",
        SaasInternalSessionAPIView.as_view(),
        name="saas_internal_session",
    ),
