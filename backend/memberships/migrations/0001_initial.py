    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("adult", "Adulto"), ("child", "Nino")], default="adult", max_length=16)),
            ...
            options={
                "ordering": ["role", "name"],
                "indexes": [
                    models.Index(fields=["user", "is_active"], name="memberships_f_user_id_8b8f60_idx"),
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=Q(("kind", "individual"), ("member__isnull", False), _connector="OR")
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("percent", models.DecimalField(decimal_places=2, max_digits=5, validators=[MinValueValidator(0), MaxValueValidator(100)])),
                (
                    "member",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
